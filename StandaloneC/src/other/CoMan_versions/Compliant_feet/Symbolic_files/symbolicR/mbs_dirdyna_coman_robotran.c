...
//
//	==> Generation Date : Wed Mar  5 10:45:10 2014
//
...
// Forward Kinematics 
  ...
  AlM114_4 = -s->dpt[2][2]*(OpM16_4*S14+C14*S5);
  AlM314_4 = s->dpt[2][2]*(OpM16_4*C14-S14*S5);
  OpM114_5 = C14*S6;
  OpM314_5 = S14*S6;
 ...
 *S22);
  OpM124_22 = S23*C24;
  OpM324_22 = S23*S24;
  AlM124_22 = C23*C24*(s->dpt[3][37]+s->dpt[3][41])+S24*(s->dpt[1][41]*C23-s->dpt[2][41]*S23);
  AlM224_22 = AlM223_22-s->dpt[3][41]*S23;
  AlM324_22 = C23*S24*(s->dpt[3][37]+s->dpt[3][41])-C24*(s->dpt[1][41]*C23-s->dpt[2][41]*S23);
  ...
  AlM225_23 = s->dpt[1][41]*C25-S24*S25*(s->dpt[2][41]+s->dpt[2][44]);
  AlM325_23 = -(s->dpt[1][41]*S25+S24*C25*(s->dpt[2][41]+s->dpt[2][44]));
 ...
 *S22);
  OpM128_22 = S23*C28;
  OpM328_22 = S23*S28;
  AlM128_22 = C23*C28*(s->dpt[3][37]+s->dpt[3][42])+S28*(s->dpt[1][42]*C23-s->dpt[2][42]*S23);
  AlM228_22 = AlM223_22-s->dpt[3][42]*S23;
  AlM328_22 = C23*S28*(s->dpt[3][37]+s->dpt[3][42])-C28*(s->dpt[1][42]*C23-s->dpt[2][42]*S23);
  ...
  AlM229_23 = s->dpt[1][42]*C29-S28*S29*(s->dpt[2][42]+s->dpt[2][52]);
  AlM329_23 = -(s->dpt[1][42]*S29+S28*C29*(s->dpt[2][42]+s->dpt[2][52]));
...
// Backward Dynamics 
 ...
 OpF226)-C27*(AlF126+BeF326*s->dpt[3][48])+S27*(AlF326+BS926*s->dpt[3][48])));
  FA227 = -(s->frc[2][27]-s->m[27]*(AlF226+BeF626*s->dpt[3][48]+s->l[1][27]*(BS227+OpF327)-s->l[2][27]*(OM127*OM127+
 ...
 *OM227)+C27*(AlF326+BS926*s->dpt[3][48])+S27*(AlF126+BeF326*s->dpt[3][48])));
  ...
  FB127_4 = -s->m[27]*(AlM325_4*S27-OpM226_4*s->l[3][27]+OpM327_4*s->l[2][27]-C27*(AlM126_4+OpM226_4*s->dpt[3][48]));
  FB227_4 = s->m[27]*(AlM226_4-OpM126_4*s->dpt[3][48]-OpM127_4*s->l[3][27]+OpM327_4*s->l[1][27]);
  FB327_4 = s->m[27]*(AlM325_4*C27+OpM127_4*s->l[2][27]-OpM226_4*s->l[1][27]+S27*(AlM126_4+OpM226_4*s->dpt[3][48]));
  ...
  FB127_5 = -s->m[27]*(AlM325_5*S27-OpM226_5*s->l[3][27]+OpM327_5*s->l[2][27]-C27*(AlM126_5+OpM226_5*s->dpt[3][48]));
  FB227_5 = s->m[27]*(AlM226_5-OpM126_5*s->dpt[3][48]-OpM127_5*s->l[3][27]+OpM327_5*s->l[1][27]);
  FB327_5 = s->m[27]*(AlM325_5*C27+OpM127_5*s->l[2][27]-OpM226_5*s->l[1][27]+S27*(AlM126_5+OpM226_5*s->dpt[3][48]));
  ...
  FB127_6 = -s->m[27]*(AlM325_6*S27-OpM226_6*s->l[3][27]+OpM327_6*s->l[2][27]-C27*(AlM126_6+OpM226_6*s->dpt[3][48]));
  FB227_6 = s->m[27]*(AlM226_6-OpM126_6*s->dpt[3][48]-OpM127_6*s->l[3][27]+OpM327_6*s->l[1][27]);
  FB327_6 = s->m[27]*(AlM325_6*C27+OpM127_6*s->l[2][27]-OpM226_6*s->l[1][27]+S27*(AlM126_6+OpM226_6*s->dpt[3][48]));
  ...
  FB127_21 = -s->m[27]*(AlM325_21*S27-OpM226_21*s->l[3][27]+OpM327_21*s->l[2][27]-C27*(AlM126_21+OpM226_21*s->dpt[3][48]
 ));
  FB227_21 = s->m[27]*(AlM226_21-OpM126_21*s->dpt[3][48]-OpM127_21*s->l[3][27]+OpM327_21*s->l[1][27]);
  FB327_21 = s->m[27]*(AlM325_21*C27+OpM127_21*s->l[2][27]-OpM226_21*s->l[1][27]+S27*(AlM126_21+OpM226_21*s->dpt[3][48])
 );
  ...
  FB127_22 = -s->m[27]*(AlM325_22*S27-OpM226_22*s->l[3][27]+OpM327_22*s->l[2][27]-C27*(AlM126_22+OpM226_22*s->dpt[3][48]
 ));
  FB227_22 = s->m[27]*(AlM226_22-OpM126_22*s->dpt[3][48]-OpM127_22*s->l[3][27]+OpM327_22*s->l[1][27]);
  FB327_22 = s->m[27]*(AlM325_22*C27+OpM127_22*s->l[2][27]-OpM226_22*s->l[1][27]+S27*(AlM126_22+OpM226_22*s->dpt[3][48])
 );
  ...
  FB127_23 = -s->m[27]*(AlM325_23*S27-OpM226_23*s->l[3][27]+OpM327_23*s->l[2][27]-C27*(AlM126_23+OpM226_23*s->dpt[3][48]
 ));
  FB227_23 = s->m[27]*(AlM226_23-OpM126_23*s->dpt[3][48]-OpM127_23*s->l[3][27]+OpM327_23*s->l[1][27]);
  FB327_23 = s->m[27]*(AlM325_23*C27+OpM127_23*s->l[2][27]-OpM226_23*s->l[1][27]+S27*(AlM126_23+OpM226_23*s->dpt[3][48])
 );
  ...
  FB127_24 = s->m[27]*(OpM226_24*s->l[3][27]-OpM327_24*s->l[2][27]+C27*(AlM126_24+OpM226_24*s->dpt[3][48]));
  FB227_24 = s->m[27]*(AlM226_24-OpM126_24*s->dpt[3][48]-OpM127_24*s->l[3][27]+OpM327_24*s->l[1][27]);
  FB327_24 = s->m[27]*(OpM127_24*s->l[2][27]-OpM226_24*s->l[1][27]+S27*(AlM126_24+OpM226_24*s->dpt[3][48]));
  ...
  FB127_25 = s->m[27]*(C27*(AlM126_25-s->dpt[3][48]*S26)-OpM327_25*s->l[2][27]-s->l[3][27]*S26);
  FB227_25 = s->m[27]*(AlM226_25-OpM127_25*s->l[3][27]+OpM327_25*s->l[1][27]-s->dpt[3][48]*C26);
  FB327_25 = s->m[27]*(OpM127_25*s->l[2][27]+s->l[1][27]*S26+S27*(AlM126_25-s->dpt[3][48]*S26));
 ...
 s->l[3][26]+FA227*s->dpt[3][48]-FA326*s->l[2][26]-OM226*(s->In[3][26]*OM126+s->In[9][26]*OM326)+OM326*(s->In[2][26]*OM126+
 s->In[5][26]*OM226));
  CF226 = -(s->trq[2][26]-CF227-s->In[2][26]*OpF126-s->In[5][26]*OpF226-FA126*s->l[3][26]+FA326*s->l[1][26]+OM126*(
 s->In[3][26]*OM126+s->In[9][26]*OM326)-OM326*(s->In[1][26]*OM126+s->In[2][26]*OM226+s->In[3][26]*OM326)-s->dpt[3][48]*(FA127
 *C27+FA327*S27));
 ...
 s->l[2][25]-OM225*(s->In[3][25]*OM125-s->In[5][25]*OM325+s->In[9][25]*OM325)+s->dpt[3][46]*(FF126*S26+FF226*C26));
  CF225 = -(s->trq[2][25]-s->In[5][25]*OpF225-CF126*S26-CF226*C26-FA125*s->l[3][25]+FA325*s->l[1][25]+OM125*(
 s->In[3][25]*OM125+s->In[9][25]*OM325)-OM325*(s->In[1][25]*OM125+s->In[3][25]*OM325)-s->dpt[3][46]*(FF126*C26-FF226*S26));
 ...
 *C26-FM226_6*S26);
 ...
 FM126_22*C26-FM226_22*S26);
  ...
  CM125_23 = CM126_23*C26-CM226_23*S26-s->dpt[3][46]*(FM126_23*S26+FM226_23*C26)-s->In[1][25]*S24+s->In[3][25]*OpM325_23
 ...
 FM126_23*C26-FM226_23*S26);
  ...
  CM125_24 = CM126_24*C26-CM226_24*S26-s->dpt[3][46]*(FM126_24*S26+FM226_24*C26)-s->In[3][25]*S25-FB225_24*s->l[3][25]+
 FB325_24*s->l[2][25];
  CM125_25 = s->In[1][25]+s->m[25]*s->l[2][25]*s->l[2][25]+s->m[25]*s->l[3][25]*s->l[3][25]-s->dpt[3][46]*(C26*(FB226_25
 +FB227_25)+S26*(FB126_25+FB127_25*C27+FB327_25*S27))+C26*(s->In[1][26]*C26-s->In[2][26]*S26+CM127_25*C27+CM327_25*S27-
 FB226_25*s->l[3][26]-FB227_25*s->dpt[3][48]+FB326_25*s->l[2][26])-S26*(CM227_25+s->In[2][26]*C26-s->In[5][26]*S26+FB126_25*
 s->l[3][26]-FB326_25*s->l[1][26]+s->dpt[3][48]*(FB127_25*C27+FB327_25*S27));
 ...
 s->In[6][24]*OM224+s->In[9][24]*OM324)+OM324*(s->In[2][24]*OM124+s->In[5][24]*OM224+s->In[6][24]*OM324)-s->dpt[2][44]*(FF225
 *S25+FF325*C25));
 ...
 s->l[1][24]+FF125*s->dpt[2][44]-OM124*(s->In[2][24]*OM124+s->In[5][24]*OM224+s->In[6][24]*OM324)+OM224*(s->In[1][24]*OM124+
 s->In[2][24]*OM224));
 ...
 -FM125_22*s->dpt[2][44];
  ...
  FB324_23 = -s->m[24]*S24*(s->dpt[2][41]+s->l[2][24]);
 ...
 CM126_24*S26+CM226_24*C26+FB125_24*s->l[3][25]-FB325_24*s->l[1][25]+s->dpt[3][46]*(FM126_24*C26-FM226_24*S26))-S25*(CM326_24
...
// Backward Dynamics 
 ...
 OpF230)-C31*(AlF130+BeF330*s->dpt[3][56])+S31*(AlF330+BS930*s->dpt[3][56])));
  FA231 = -(s->frc[2][31]-s->m[31]*(AlF230+BeF630*s->dpt[3][56]+s->l[1][31]*(BS231+OpF331)-s->l[2][31]*(OM131*OM131+
 ...
 *OM231)+C31*(AlF330+BS930*s->dpt[3][56])+S31*(AlF130+BeF330*s->dpt[3][56])));
 ...
 s->In[2][31]*OM131+s->In[5][31]*OM231+s->In[6][31]*OM331)+OM231*(s->In[1][31]*OM131+s->In[2][31]*OM231));
  ...
  FB131_4 = -s->m[31]*(AlM329_4*S31-OpM230_4*s->l[3][31]+OpM331_4*s->l[2][31]-C31*(AlM130_4+OpM230_4*s->dpt[3][56]));
  FB231_4 = s->m[31]*(AlM230_4-OpM130_4*s->dpt[3][56]-OpM131_4*s->l[3][31]+OpM331_4*s->l[1][31]);
  FB331_4 = s->m[31]*(AlM329_4*C31+OpM131_4*s->l[2][31]-OpM230_4*s->l[1][31]+S31*(AlM130_4+OpM230_4*s->dpt[3][56]));
  ...
  FB131_5 = -s->m[31]*(AlM329_5*S31-OpM230_5*s->l[3][31]+OpM331_5*s->l[2][31]-C31*(AlM130_5+OpM230_5*s->dpt[3][56]));
  FB231_5 = s->m[31]*(AlM230_5-OpM130_5*s->dpt[3][56]-OpM131_5*s->l[3][31]+OpM331_5*s->l[1][31]);
  FB331_5 = s->m[31]*(AlM329_5*C31+OpM131_5*s->l[2][31]-OpM230_5*s->l[1][31]+S31*(AlM130_5+OpM230_5*s->dpt[3][56]));
  ...
  FB131_6 = -s->m[31]*(AlM329_6*S31-OpM230_6*s->l[3][31]+OpM331_6*s->l[2][31]-C31*(AlM130_6+OpM230_6*s->dpt[3][56]));
  FB231_6 = s->m[31]*(AlM230_6-OpM130_6*s->dpt[3][56]-OpM131_6*s->l[3][31]+OpM331_6*s->l[1][31]);
  FB331_6 = s->m[31]*(AlM329_6*C31+OpM131_6*s->l[2][31]-OpM230_6*s->l[1][31]+S31*(AlM130_6+OpM230_6*s->dpt[3][56]));
  ...
  FB131_21 = -s->m[31]*(AlM329_21*S31-OpM230_21*s->l[3][31]+OpM331_21*s->l[2][31]-C31*(AlM130_21+OpM230_21*s->dpt[3][56]
 ));
  FB231_21 = s->m[31]*(AlM230_21-OpM130_21*s->dpt[3][56]-OpM131_21*s->l[3][31]+OpM331_21*s->l[1][31]);
  FB331_21 = s->m[31]*(AlM329_21*C31+OpM131_21*s->l[2][31]-OpM230_21*s->l[1][31]+S31*(AlM130_21+OpM230_21*s->dpt[3][56])
 );
 ...
 s->l[1][31];
  ...
  FB131_22 = -s->m[31]*(AlM329_22*S31-OpM230_22*s->l[3][31]+OpM331_22*s->l[2][31]-C31*(AlM130_22+OpM230_22*s->dpt[3][56]
 ));
  FB231_22 = s->m[31]*(AlM230_22-OpM130_22*s->dpt[3][56]-OpM131_22*s->l[3][31]+OpM331_22*s->l[1][31]);
  FB331_22 = s->m[31]*(AlM329_22*C31+OpM131_22*s->l[2][31]-OpM230_22*s->l[1][31]+S31*(AlM130_22+OpM230_22*s->dpt[3][56])
 );
 ...
 s->l[1][31];
  ...
  FB131_23 = -s->m[31]*(AlM329_23*S31-OpM230_23*s->l[3][31]+OpM331_23*s->l[2][31]-C31*(AlM130_23+OpM230_23*s->dpt[3][56]
 ));
  FB231_23 = s->m[31]*(AlM230_23-OpM130_23*s->dpt[3][56]-OpM131_23*s->l[3][31]+OpM331_23*s->l[1][31]);
  FB331_23 = s->m[31]*(AlM329_23*C31+OpM131_23*s->l[2][31]-OpM230_23*s->l[1][31]+S31*(AlM130_23+OpM230_23*s->dpt[3][56])
 );
 ...
 s->l[1][31];
  ...
  FB131_28 = s->m[31]*(OpM230_28*s->l[3][31]-OpM331_28*s->l[2][31]+C31*(AlM130_28+OpM230_28*s->dpt[3][56]));
  FB231_28 = s->m[31]*(AlM230_28-OpM130_28*s->dpt[3][56]-OpM131_28*s->l[3][31]+OpM331_28*s->l[1][31]);
  FB331_28 = s->m[31]*(OpM131_28*s->l[2][31]-OpM230_28*s->l[1][31]+S31*(AlM130_28+OpM230_28*s->dpt[3][56]));
 ...
 s->l[1][31];
  ...
  FB131_29 = s->m[31]*(C31*(AlM130_29-s->dpt[3][56]*S30)-OpM331_29*s->l[2][31]-s->l[3][31]*S30);
  FB231_29 = s->m[31]*(AlM230_29-OpM131_29*s->l[3][31]+OpM331_29*s->l[1][31]-s->dpt[3][56]*C30);
  FB331_29 = s->m[31]*(OpM131_29*s->l[2][31]+s->l[1][31]*S30+S31*(AlM130_29-s->dpt[3][56]*S30));
 ...
 s->dpt[3][56]-FA330*s->l[2][30]-OM230*(s->In[3][30]*OM130+s->In[6][30]*OM230+s->In[9][30]*OM330)+OM330*(s->In[5][30]*OM230+
 s->In[6][30]*OM330));
  CF230 = -(s->trq[2][30]-CF231-s->In[5][30]*OpF230-s->In[6][30]*OpF329-FA130*s->l[3][30]+FA330*s->l[1][30]+OM130*(
 s->In[3][30]*OM130+s->In[6][30]*OM230+s->In[9][30]*OM330)-OM330*(s->In[1][30]*OM130+s->In[3][30]*OM330)-s->dpt[3][56]*(FA131
 *C31+FA331*S31));
 ...
 s->In[5][29]*OM229+s->In[6][29]*OM329)+s->dpt[3][54]*(FF130*S30+FF230*C30));
 ...
 s->In[2][29]*OM229+s->In[3][29]*OM329)-s->dpt[3][54]*(FF130*C30-FF230*S30));
 ...
 *s->l[1][29];
  ...
  CM129_23 = CM130_23*C30-CM230_23*S30-s->dpt[3][54]*(FM130_23*S30+FM230_23*C30)-s->In[1][29]*S28+s->In[2][29]*OpM229_23
 +s->In[3][29]*OpM329_23-FB229_23*s->l[3][29]+FB329_23*s->l[2][29];
  CM229_23 = CM130_23*S30+CM230_23*C30+s->dpt[3][54]*(FM130_23*C30-FM230_23*S30)-s->In[2][29]*S28+s->In[5][29]*OpM229_23
 ...
 s->dpt[3][54]*(FM130_28*S30+FM230_28*C30);
  CM129_29 = s->In[1][29]+s->m[29]*s->l[2][29]*s->l[2][29]+s->m[29]*s->l[3][29]*s->l[3][29]-s->dpt[3][54]*(C30*(FB230_29
 +FB231_29)+S30*(FB130_29+FB131_29*C31+FB331_29*S31))+C30*(s->In[1][30]*C30+CM131_29*C31+CM331_29*S31-FB230_29*s->l[3][30]-
 FB231_29*s->dpt[3][56]+FB330_29*s->l[2][30])-S30*(CM231_29-s->In[5][30]*S30+FB130_29*s->l[3][30]-FB330_29*s->l[1][30]+
 s->dpt[3][56]*(FB131_29*C31+FB331_29*S31));
 ...
 s->In[9][28])-s->dpt[2][52]*(FF229*S29+FF329*C29));
 ...
 s->dpt[2][52]+OM128*OM228*(s->In[1][28]-s->In[5][28]));
 ...
 s->dpt[2][52];
  ...
  FB328_23 = -s->m[28]*S28*(s->dpt[2][42]+s->l[2][28]);
 ...
 s->In[6][29]*S29+CM130_28*S30+CM230_28*C30+FB129_28*s->l[3][29]-FB329_28*s->l[1][29]+s->dpt[3][54]*(FM130_28*C30-FM230_28*
...
// Backward Dynamics 
 ...
 s->dpt[1][18]+BeF312*s->dpt[3][18])+S13*(AlF312+BS912*s->dpt[3][18]+BeF712*s->dpt[1][18])));
  FA213 = -(s->frc[2][13]-s->m[13]*(AlF211+BeF412*s->dpt[1][18]+BeF612*s->dpt[3][18]+s->l[1][13]*(OpF313+OM113*OM213)-
 ...
 s->dpt[3][18]+BeF712*s->dpt[1][18])+S13*(AlF112+BS112*s->dpt[1][18]+BeF312*s->dpt[3][18])));
  ...
  FB113_4 = s->m[13]*(OpM211_4*s->l[3][13]+C13*(AlM112_4+OpM211_4*s->dpt[3][18])-S13*(AlM312_4-OpM211_4*s->dpt[1][18]));
  FB213_4 = s->m[13]*(AlM211_4-OpM112_4*s->dpt[3][18]-OpM113_4*s->l[3][13]+OpM312_4*s->dpt[1][18]+OpM313_4*s->l[1][13]);
  FB313_4 = s->m[13]*(C13*(AlM312_4-OpM211_4*s->dpt[1][18])+S13*(AlM112_4+OpM211_4*s->dpt[3][18])-OpM211_4*s->l[1][13]);
  ...
  FB113_5 = s->m[13]*(OpM211_5*s->l[3][13]+C13*(AlM112_5+OpM211_5*s->dpt[3][18])-S13*(AlM312_5-OpM211_5*s->dpt[1][18]));
  FB213_5 = s->m[13]*(AlM211_5-OpM112_5*s->dpt[3][18]-OpM113_5*s->l[3][13]+OpM312_5*s->dpt[1][18]+OpM313_5*s->l[1][13]);
  FB313_5 = s->m[13]*(C13*(AlM312_5-OpM211_5*s->dpt[1][18])+S13*(AlM112_5+OpM211_5*s->dpt[3][18])-OpM211_5*s->l[1][13]);
  ...
  FB113_6 = s->m[13]*(OpM211_6*s->l[3][13]+C13*(AlM112_6+OpM211_6*s->dpt[3][18])-S13*(AlM312_6-OpM211_6*s->dpt[1][18]));
  FB213_6 = s->m[13]*(AlM211_6-OpM112_6*s->dpt[3][18]-OpM113_6*s->l[3][13]+OpM312_6*s->dpt[1][18]+OpM313_6*s->l[1][13]);
  FB313_6 = s->m[13]*(C13*(AlM312_6-OpM211_6*s->dpt[1][18])+S13*(AlM112_6+OpM211_6*s->dpt[3][18])-OpM211_6*s->l[1][13]);
  ...
  FB113_7 = s->m[13]*(OpM211_7*s->l[3][13]+C13*(AlM112_7+OpM211_7*s->dpt[3][18])-S13*(AlM312_7-OpM211_7*s->dpt[1][18]));
  FB213_7 = s->m[13]*(AlM211_7-OpM112_7*s->dpt[3][18]-OpM113_7*s->l[3][13]+OpM312_7*s->dpt[1][18]+OpM313_7*s->l[1][13]);
  FB313_7 = s->m[13]*(C13*(AlM312_7-OpM211_7*s->dpt[1][18])+S13*(AlM112_7+OpM211_7*s->dpt[3][18])-OpM211_7*s->l[1][13]);
  ...
  FB113_8 = s->m[13]*(OpM211_8*s->l[3][13]+C13*(AlM112_8+OpM211_8*s->dpt[3][18])-S13*(AlM312_8-OpM211_8*s->dpt[1][18]));
  FB213_8 = s->m[13]*(AlM211_8-OpM112_8*s->dpt[3][18]-OpM113_8*s->l[3][13]+OpM312_8*s->dpt[1][18]+OpM313_8*s->l[1][13]);
  FB313_8 = s->m[13]*(C13*(AlM312_8-OpM211_8*s->dpt[1][18])+S13*(AlM112_8+OpM211_8*s->dpt[3][18])-OpM211_8*s->l[1][13]);
  ...
  FB113_9 = s->m[13]*(OpM211_9*s->l[3][13]+C13*(AlM112_9+OpM211_9*s->dpt[3][18])-S13*(AlM312_9-OpM211_9*s->dpt[1][18]));
  FB213_9 = s->m[13]*(AlM211_9-OpM112_9*s->dpt[3][18]-OpM113_9*s->l[3][13]+OpM312_9*s->dpt[1][18]+OpM313_9*s->l[1][13]);
  FB313_9 = s->m[13]*(C13*(AlM312_9-OpM211_9*s->dpt[1][18])+S13*(AlM112_9+OpM211_9*s->dpt[3][18])-OpM211_9*s->l[1][13]);
  ...
  FB113_10 = s->m[13]*(s->l[3][13]*C11+C13*(AlM112_10+s->dpt[3][18]*C11)-S13*(AlM312_10-s->dpt[1][18]*C11));
  FB213_10 = -s->m[13]*(OpM112_10*s->dpt[3][18]+OpM113_10*s->l[3][13]-OpM312_10*s->dpt[1][18]-OpM313_10*s->l[1][13]);
  FB313_10 = s->m[13]*(C13*(AlM312_10-s->dpt[1][18]*C11)+S13*(AlM112_10+s->dpt[3][18]*C11)-s->l[1][13]*C11);
  ...
  FB213_11 = s->m[13]*(s->dpt[1][18]*S12-s->dpt[3][18]*C12+s->l[1][13]*S12p13-s->l[3][13]*C12p13);
  CM113_11 = s->In[1][13]*C12p13-FB213_11*s->l[3][13];
  CM313_11 = s->In[9][13]*S12p13+FB213_11*s->l[1][13];
  FB113_12 = s->m[13]*(s->l[3][13]+s->dpt[1][18]*S13+s->dpt[3][18]*C13);
  FB313_12 = -s->m[13]*(s->l[1][13]+s->dpt[1][18]*C13-s->dpt[3][18]*S13);
  ...
  CF112 = -(s->trq[1][12]-s->In[1][12]*OpF112-CF113*C13-CF313*S13+FA212*s->l[3][12]+FA213*s->dpt[3][18]+OM212*OM312*(
 s->In[5][12]-s->In[9][12]));
  CF212 = -(s->trq[2][12]-CF213-s->In[5][12]*OpF211-FA112*s->l[3][12]+FA312*s->l[1][12]-OM112*OM312*(s->In[1][12]-
 s->In[9][12])-s->dpt[1][18]*(FA113*S13-FA313*C13)-s->dpt[3][18]*(FA113*C13+FA313*S13));
  CF312 = -(s->trq[3][12]-s->In[9][12]*OpF312+CF113*S13-CF313*C13-FA212*s->l[1][12]-FA213*s->dpt[1][18]+OM112*OM212*(
 s->In[1][12]-s->In[5][12]));
 ...
 FB113_3*C13+FB313_3*S13);
  ...
  CM212_4 = CM213_4+s->In[5][12]*OpM211_4+FB112_4*s->l[3][12]-FB312_4*s->l[1][12]+s->dpt[1][18]*(FB113_4*S13-FB313_4*C13
 )+s->dpt[3][18]*(FB113_4*C13+FB313_4*S13);
  ...
  CM212_5 = CM213_5+s->In[5][12]*OpM211_5+FB112_5*s->l[3][12]-FB312_5*s->l[1][12]+s->dpt[1][18]*(FB113_5*S13-FB313_5*C13
 )+s->dpt[3][18]*(FB113_5*C13+FB313_5*S13);
  ...
  CM212_6 = CM213_6+s->In[5][12]*OpM211_6+FB112_6*s->l[3][12]-FB312_6*s->l[1][12]+s->dpt[1][18]*(FB113_6*S13-FB313_6*C13
 )+s->dpt[3][18]*(FB113_6*C13+FB313_6*S13);
  ...
  CM212_7 = CM213_7+s->In[5][12]*OpM211_7+FB112_7*s->l[3][12]-FB312_7*s->l[1][12]+s->dpt[1][18]*(FB113_7*S13-FB313_7*C13
 )+s->dpt[3][18]*(FB113_7*C13+FB313_7*S13);
  ...
  CM212_8 = CM213_8+s->In[5][12]*OpM211_8+FB112_8*s->l[3][12]-FB312_8*s->l[1][12]+s->dpt[1][18]*(FB113_8*S13-FB313_8*C13
 )+s->dpt[3][18]*(FB113_8*C13+FB313_8*S13);
  ...
  CM212_9 = CM213_9+s->In[5][12]*OpM211_9+FB112_9*s->l[3][12]-FB312_9*s->l[1][12]+s->dpt[1][18]*(FB113_9*S13-FB313_9*C13
 )+s->dpt[3][18]*(FB113_9*C13+FB313_9*S13);
 ...
 C13)+s->dpt[3][18]*(FB113_10*C13+FB313_10*S13);
  ...
  CM212_12 = s->In[5][12]+CM213_12+s->m[12]*s->l[1][12]*s->l[1][12]+s->m[12]*s->l[3][12]*s->l[3][12]+s->dpt[1][18]*(
 FB113_12*S13-FB313_12*C13)+s->dpt[3][18]*(FB113_12*C13+FB313_12*S13);
 ...
 CM113_11*C13+CM313_11*S13-FB212_11*s->l[3][12]-FB213_11*s->dpt[3][18])+S12*(s->In[9][12]*S12-CM113_11*S13+CM313_11*C13+
 FB212_11*s->l[1][12]+FB213_11*s->dpt[1][18]);
 ...
 FB210_8*s->l[1][10];
  ...
  CM210_9 = CM211_9*C11-CM311_9*S11+s->dpt[3][12]*(FB111_9+FM112_9*C12+FM312_9*S12)-s->In[2][10]*S10+s->In[6][10]*C10+
 FB110_9*s->l[3][10]-FB310_9*s->l[1][10];
  CM210_10 = s->In[5][10]+s->m[10]*s->l[1][10]*s->l[1][10]+s->m[10]*s->l[3][10]*s->l[3][10]+s->dpt[3][12]*(FB111_10+C12*
 ...
 *(s->In[3][9]*OM19+s->In[6][9]*OM29+s->In[9][9]*OM39)-OM39*(s->In[1][9]*OM19+s->In[2][9]*OM29+s->In[3][9]*OM39)-
 ...
 s->l[3][10]+FB310_9*s->l[2][10]-s->dpt[3][12]*(C11*(FB211_9+FB212_9+FB213_9)-S11*(FB311_9-FM112_9*S12+FM312_9*C12)));
...
// Backward Dynamics 
 ...
 s->dpt[1][32]+BeF319*s->dpt[3][32])+S20*(AlF319+BS919*s->dpt[3][32]+BeF719*s->dpt[1][32])));
  FA220 = -(s->frc[2][20]-s->m[20]*(AlF218+BeF419*s->dpt[1][32]+BeF619*s->dpt[3][32]+s->l[1][20]*(OpF320+OM120*OM220)-
 ...
 s->dpt[3][32]+BeF719*s->dpt[1][32])+S20*(AlF119+BS119*s->dpt[1][32]+BeF319*s->dpt[3][32])));
  ...
  FB120_4 = s->m[20]*(OpM218_4*s->l[3][20]+C20*(AlM119_4+OpM218_4*s->dpt[3][32])-S20*(AlM319_4-OpM218_4*s->dpt[1][32]));
  FB220_4 = s->m[20]*(AlM218_4-OpM119_4*s->dpt[3][32]-OpM120_4*s->l[3][20]+OpM319_4*s->dpt[1][32]+OpM320_4*s->l[1][20]);
  FB320_4 = s->m[20]*(C20*(AlM319_4-OpM218_4*s->dpt[1][32])+S20*(AlM119_4+OpM218_4*s->dpt[3][32])-OpM218_4*s->l[1][20]);
  ...
  FB120_5 = s->m[20]*(OpM218_5*s->l[3][20]+C20*(AlM119_5+OpM218_5*s->dpt[3][32])-S20*(AlM319_5-OpM218_5*s->dpt[1][32]));
  FB220_5 = s->m[20]*(AlM218_5-OpM119_5*s->dpt[3][32]-OpM120_5*s->l[3][20]+OpM319_5*s->dpt[1][32]+OpM320_5*s->l[1][20]);
  FB320_5 = s->m[20]*(C20*(AlM319_5-OpM218_5*s->dpt[1][32])+S20*(AlM119_5+OpM218_5*s->dpt[3][32])-OpM218_5*s->l[1][20]);
  ...
  FB120_6 = s->m[20]*(OpM218_6*s->l[3][20]+C20*(AlM119_6+OpM218_6*s->dpt[3][32])-S20*(AlM319_6-OpM218_6*s->dpt[1][32]));
  FB220_6 = s->m[20]*(AlM218_6-OpM119_6*s->dpt[3][32]-OpM120_6*s->l[3][20]+OpM319_6*s->dpt[1][32]+OpM320_6*s->l[1][20]);
  FB320_6 = s->m[20]*(C20*(AlM319_6-OpM218_6*s->dpt[1][32])+S20*(AlM119_6+OpM218_6*s->dpt[3][32])-OpM218_6*s->l[1][20]);
  ...
  FB120_14 = s->m[20]*(OpM218_14*s->l[3][20]+C20*(AlM119_14+OpM218_14*s->dpt[3][32])-S20*(AlM319_14-OpM218_14*
 s->dpt[1][32]));
  FB220_14 = s->m[20]*(AlM218_14-OpM119_14*s->dpt[3][32]-OpM120_14*s->l[3][20]+OpM319_14*s->dpt[1][32]+OpM320_14*
 s->l[1][20]);
  FB320_14 = s->m[20]*(C20*(AlM319_14-OpM218_14*s->dpt[1][32])+S20*(AlM119_14+OpM218_14*s->dpt[3][32])-OpM218_14*
 s->l[1][20]);
  ...
  FB120_15 = s->m[20]*(OpM218_15*s->l[3][20]+C20*(AlM119_15+OpM218_15*s->dpt[3][32])-S20*(AlM319_15-OpM218_15*
 s->dpt[1][32]));
  FB220_15 = s->m[20]*(AlM218_15-OpM119_15*s->dpt[3][32]-OpM120_15*s->l[3][20]+OpM319_15*s->dpt[1][32]+OpM320_15*
 s->l[1][20]);
  FB320_15 = s->m[20]*(C20*(AlM319_15-OpM218_15*s->dpt[1][32])+S20*(AlM119_15+OpM218_15*s->dpt[3][32])-OpM218_15*
 s->l[1][20]);
  ...
  FB120_16 = s->m[20]*(OpM218_16*s->l[3][20]+C20*(AlM119_16+OpM218_16*s->dpt[3][32])-S20*(AlM319_16-OpM218_16*
 s->dpt[1][32]));
  FB220_16 = s->m[20]*(AlM218_16-OpM119_16*s->dpt[3][32]-OpM120_16*s->l[3][20]+OpM319_16*s->dpt[1][32]+OpM320_16*
 s->l[1][20]);
  FB320_16 = s->m[20]*(C20*(AlM319_16-OpM218_16*s->dpt[1][32])+S20*(AlM119_16+OpM218_16*s->dpt[3][32])-OpM218_16*
 s->l[1][20]);
  ...
  FB120_17 = s->m[20]*(s->l[3][20]*C18+C20*(AlM119_17+s->dpt[3][32]*C18)-S20*(AlM319_17-s->dpt[1][32]*C18));
  FB220_17 = -s->m[20]*(OpM119_17*s->dpt[3][32]+OpM120_17*s->l[3][20]-OpM319_17*s->dpt[1][32]-OpM320_17*s->l[1][20]);
  FB320_17 = s->m[20]*(C20*(AlM319_17-s->dpt[1][32]*C18)+S20*(AlM119_17+s->dpt[3][32]*C18)-s->l[1][20]*C18);
  ...
  FB220_18 = s->m[20]*(s->dpt[1][32]*S19-s->dpt[3][32]*C19+s->l[1][20]*S19p20-s->l[3][20]*C19p20);
  CM120_18 = s->In[1][20]*C19p20-FB220_18*s->l[3][20];
  CM320_18 = s->In[9][20]*S19p20+FB220_18*s->l[1][20];
  FB120_19 = s->m[20]*(s->l[3][20]+s->dpt[1][32]*S20+s->dpt[3][32]*C20);
  FB320_19 = -s->m[20]*(s->l[1][20]+s->dpt[1][32]*C20-s->dpt[3][32]*S20);
  ...
  CF119 = -(s->trq[1][19]-s->In[1][19]*OpF119-CF120*C20-CF320*S20+FA219*s->l[3][19]+FA220*s->dpt[3][32]+OM219*OM319*(
 s->In[5][19]-s->In[9][19]));
  CF219 = -(s->trq[2][19]-CF220-s->In[5][19]*OpF218-FA119*s->l[3][19]+FA319*s->l[1][19]-OM119*OM319*(s->In[1][19]-
 s->In[9][19])-s->dpt[1][32]*(FA120*S20-FA320*C20)-s->dpt[3][32]*(FA120*C20+FA320*S20));
  CF319 = -(s->trq[3][19]-s->In[9][19]*OpF319+CF120*S20-CF320*C20-FA219*s->l[1][19]-FA220*s->dpt[1][32]+OM119*OM219*(
 s->In[1][19]-s->In[5][19]));
 ...
 FB120_3*C20+FB320_3*S20);
  ...
  CM219_4 = CM220_4+s->In[5][19]*OpM218_4+FB119_4*s->l[3][19]-FB319_4*s->l[1][19]+s->dpt[1][32]*(FB120_4*S20-FB320_4*C20
 )+s->dpt[3][32]*(FB120_4*C20+FB320_4*S20);
  ...
  CM219_5 = CM220_5+s->In[5][19]*OpM218_5+FB119_5*s->l[3][19]-FB319_5*s->l[1][19]+s->dpt[1][32]*(FB120_5*S20-FB320_5*C20
 )+s->dpt[3][32]*(FB120_5*C20+FB320_5*S20);
  ...
  CM219_6 = CM220_6+s->In[5][19]*OpM218_6+FB119_6*s->l[3][19]-FB319_6*s->l[1][19]+s->dpt[1][32]*(FB120_6*S20-FB320_6*C20
 )+s->dpt[3][32]*(FB120_6*C20+FB320_6*S20);
 ...
 C20)+s->dpt[3][32]*(FB120_17*C20+FB320_17*S20);
  ...
  CM219_19 = s->In[5][19]+CM220_19+s->m[19]*s->l[1][19]*s->l[1][19]+s->m[19]*s->l[3][19]*s->l[3][19]+s->dpt[1][32]*(
 FB120_19*S20-FB320_19*C20)+s->dpt[3][32]*(FB120_19*C20+FB320_19*S20);
 ...
 CM120_18*C20+CM320_18*S20-FB219_18*s->l[3][19]-FB220_18*s->dpt[3][32])+S19*(s->In[9][19]*S19-CM120_18*S20+CM320_18*C20+
 FB219_18*s->l[1][19]+FB220_18*s->dpt[1][32]);
 ...
 s->In[3][17]*OM117-s->In[5][17]*OM317+s->In[9][17]*OM317)+s->dpt[3][26]*(FF218*C18-FF318*S18));
  CF217 = -(s->trq[2][17]-s->In[5][17]*OpF216-CF218*C18+CF318*S18-FA117*s->l[3][17]+FA317*s->l[1][17]-FF118*
 s->dpt[3][26]+OM117*(s->In[3][17]*OM117+s->In[9][17]*OM317)-OM317*(s->In[1][17]*OM117+s->In[3][17]*OM317));
 ...
 s->dpt[3][26]*(FM218_15*C18-FM318_15*S18);
  CM217_15 = CM218_15*C18-CM318_15*S18+FM118_15*s->dpt[3][26]-s->In[5][17]*S16+FB117_15*s->l[3][17]-FB317_15*s->l[1][17];
 ...
 s->l[1][17];
  ...
  CM217_16 = CM218_16*C18-CM318_16*S18+FB117_16*s->l[3][17]-FB317_16*s->l[1][17]+s->dpt[3][26]*(FB118_16+FM119_16*C19+
 FM319_16*S19);
  CM217_17 = s->In[5][17]+s->m[17]*s->l[1][17]*s->l[1][17]+s->m[17]*s->l[3][17]*s->l[3][17]+s->dpt[3][26]*(FB118_17+C19*
 ...
 s->l[2][16]+FF217*s->dpt[3][24]-OM216*(s->In[3][16]*OM116-s->In[5][16]*OM316+s->In[9][16]*OM316));
  CF216 = -(s->trq[2][16]-CF217-s->In[5][16]*OpF216-FA116*s->l[3][16]+FA316*s->l[1][16]+OM116*(s->In[3][16]*OM116+
 s->In[9][16]*OM316)-OM316*(s->In[1][16]*OM116+s->In[3][16]*OM316)-s->dpt[3][24]*(FF117*C17+FF317*S17));
 ...
 s->In[3][17]*C17-FB217_16*s->l[3][17]+FB317_16*s->l[2][17]-s->dpt[3][26]*(C18*(FB218_16+FB219_16+FB220_16)-S18*(FB318_16-
 ...
 s->l[2][15]+OM315*(s->In[2][15]*OM115+s->In[5][15]*OM215-s->In[9][15]*OM215)+s->dpt[3][22]*(FF116*S16+FF216*C16));
  CF215 = -(s->trq[2][15]-s->In[2][15]*OpF114-s->In[5][15]*OpF215-CF116*S16-CF216*C16-FA115*s->l[3][15]+FA315*
 s->l[1][15]-OM315*(s->In[1][15]*OM115+s->In[2][15]*OM215-s->In[9][15]*OM115)-s->dpt[3][22]*(FF116*C16-FF216*S16));
 ...
 s->dpt[3][22]*(FM116_5*C16-FM216_5*S16);
  ...
  CM115_6 = CM116_6*C16-CM216_6*S16-s->dpt[3][22]*(FM116_6*S16+FM216_6*C16)-s->In[1][15]*S14+s->In[2][15]*OpM215_6-
 FB215_6*s->l[3][15]+FB315_6*s->l[2][15];
  CM215_6 = CM116_6*S16+CM216_6*C16+s->dpt[3][22]*(FM116_6*C16-FM216_6*S16)-s->In[2][15]*S14+s->In[5][15]*OpM215_6+
 ...
 FM116_14*S16+FM216_14*C16);
  CM115_15 = s->In[1][15]+s->m[15]*s->l[2][15]*s->l[2][15]+s->m[15]*s->l[3][15]*s->l[3][15]-s->dpt[3][22]*(C16*(FB216_15
 +FM217_15)+S16*(FB116_15+FM117_15*C17+FM317_15*S17))+C16*(s->In[1][16]*C16+CM117_15*C17+CM317_15*S17-FB216_15*s->l[3][16]+
 FB316_15*s->l[2][16]-FM217_15*s->dpt[3][24])-S16*(CM217_15-s->In[5][16]*S16+FB116_15*s->l[3][16]-FB316_15*s->l[1][16]+
 s->dpt[3][24]*(FM117_15*C17+FM317_15*S17));
 ...
 s->In[6][14]*OM214+s->In[9][14]*OM314)+OM314*(s->In[2][14]*OM114+s->In[5][14]*OM214+s->In[6][14]*OM314)-s->dpt[2][20]*(FF215
 *S15+FF315*C15));
 ...
 +FF115*s->dpt[2][20]-OM114*(s->In[2][14]*OM114+s->In[5][14]*OM214+s->In[6][14]*OM314)+OM214*(s->In[1][14]*OM114+s->In[2][14]
 *OM214));
 ...
 *S15+FM315_5*C15);
 ...
 CM116_14*S16+CM216_14*C16+FB115_14*s->l[3][15]-FB315_14*s->l[1][15]+s->dpt[3][22]*(FM116_14*C16-FM216_14*S16))-S15*(CM316_14
...
// Backward Dynamics 
 ...
 s->l[2][23]+FF224*s->dpt[3][41]+FF228*s->dpt[3][42]-OM223*(s->In[6][23]*OM223+s->In[9][23]*OM323)+OM323*(s->In[5][23]*OM223+
 s->In[6][23]*OM323)+s->dpt[2][41]*(FF124*S24-FF324*C24)+s->dpt[2][42]*(FF128*S28-FF328*C28));
  CF223 = -(s->trq[2][23]-CF224-CF228-s->In[5][23]*OpF223-s->In[6][23]*OpF322-FA123*s->l[3][23]+FA323*s->l[1][23]-OM123*
 (s->In[1][23]*OM323-s->In[6][23]*OM223-s->In[9][23]*OM323)-s->dpt[1][41]*(FF124*S24-FF324*C24)-s->dpt[1][42]*(FF128*S28-
 FF328*C28)-s->dpt[3][41]*(FF124*C24+FF324*S24)-s->dpt[3][42]*(FF128*C28+FF328*S28));
  CF323 = -(s->trq[3][23]-s->In[6][23]*OpF223-s->In[9][23]*OpF322+CF124*S24+CF128*S28-CF324*C24-CF328*C28+FA123*
 s->l[2][23]-FA223*s->l[1][23]-FF224*s->dpt[1][41]-FF228*s->dpt[1][42]-OM123*(s->In[6][23]*OM323-OM223*(s->In[1][23]-
 s->In[5][23]))+s->dpt[2][41]*(FF124*C24+FF324*S24)+s->dpt[2][42]*(FF128*C28+FF328*S28));
 ...
 s->l[2][23]-FM224_21*s->dpt[3][41]-FM228_21*s->dpt[3][42]-s->dpt[2][41]*(FM124_21*S24-FM324_21*C24)-s->dpt[2][42]*(FM128_21*
 S28-FM328_21*C28);
  CM223_21 = CM224_21+CM228_21+s->In[5][23]*OpM223_21+s->In[6][23]*S22+FB123_21*s->l[3][23]-FB323_21*s->l[1][23]+
 s->dpt[1][41]*(FM124_21*S24-FM324_21*C24)+s->dpt[1][42]*(FM128_21*S28-FM328_21*C28)+s->dpt[3][41]*(FM124_21*C24+FM324_21*S24
 )+s->dpt[3][42]*(FM128_21*C28+FM328_21*S28);
 ...
 s->dpt[2][42]*(FM128_21*C28+FM328_21*S28);
  FB123_22 = s->m[23]*C23*(s->dpt[3][37]+s->l[3][23]);
 ...
 C28+FM328_22*S28);
  CM323_23 = s->In[9][23]+s->m[23]*s->l[1][23]*s->l[1][23]+s->m[23]*s->l[2][23]*s->l[2][23]+s->dpt[1][41]*(FB224_23+
 FM225_23*C25-FM325_23*S25)+s->dpt[1][42]*(FB228_23+FM229_23*C29-FM329_23*S29)-s->dpt[2][41]*(C24*(FB124_23+FM125_23)+S24*(
 FB324_23+FM225_23*S25+FM325_23*C25))-s->dpt[2][42]*(C28*(FB128_23+FM129_23)+S28*(FB328_23+FM229_23*S29+FM329_23*C29))+C24*(
 s->In[9][24]*C24+CM225_23*S25+CM325_23*C25-FB124_23*s->l[2][24]+FB224_23*s->l[1][24]-FM125_23*s->dpt[2][44])-S24*(CM125_23-
 s->In[1][24]*S24-FB224_23*s->l[3][24]+FB324_23*s->l[2][24]+s->dpt[2][44]*(FM225_23*S25+FM325_23*C25))+C28*(s->In[9][28]*C28+
 CM229_23*S29+CM329_23*C29-FB128_23*s->l[2][28]+FB228_23*s->l[1][28]-FM129_23*s->dpt[2][52])-S28*(CM129_23-s->In[1][28]*S28-
 FB228_23*s->l[3][28]+FB328_23*s->l[2][28]+s->dpt[2][52]*(FM229_23*S29+FM329_23*C29));
 ...
 s->l[2][22]-OM222*(s->In[3][22]*OM122-s->In[5][22]*OM322+s->In[9][22]*OM322)+s->dpt[3][37]*(FF123*S23+FF223*C23));
  CF222 = -(s->trq[2][22]-s->In[5][22]*OpF221-CF123*S23-CF223*C23-FA122*s->l[3][22]+FA322*s->l[1][22]+OM122*(
 s->In[3][22]*OM122+s->In[9][22]*OM322)-OM322*(s->In[1][22]*OM122+s->In[3][22]*OM322)-s->dpt[3][37]*(FF123*C23-FF223*S23));
 ...
 *C23-FM223_5*S23);
 ...
 S23);
  CM222_22 = s->In[5][22]+s->m[22]*s->l[1][22]*s->l[1][22]+s->m[22]*s->l[3][22]*s->l[3][22]+s->dpt[3][37]*(C23*(FB123_22
 +FM124_22*C24+FM128_22*C28+FM324_22*S24+FM328_22*S28)-S23*(FB223_22+FM224_22+FM228_22))+C23*(CM224_22+CM228_22+s->In[5][23]*
 C23+FB123_22*s->l[3][23]-FB323_22*s->l[1][23]+s->dpt[1][41]*(FM124_22*S24-FM324_22*C24)+s->dpt[1][42]*(FM128_22*S28-FM328_22
 *C28)+s->dpt[3][41]*(FM124_22*C24+FM324_22*S24)+s->dpt[3][42]*(FM128_22*C28+FM328_22*S28))+S23*(s->In[1][23]*S23+CM124_22*
 C24+CM128_22*C28+CM324_22*S24+CM328_22*S28-FB223_22*s->l[3][23]+FB323_22*s->l[2][23]-FM224_22*s->dpt[3][41]-FM228_22*
 s->dpt[3][42]-s->dpt[2][41]*(FM124_22*S24-FM324_22*C24)-s->dpt[2][42]*(FM128_22*S28-FM328_22*C28));
 ...
 *OM221+s->In[9][21]*OM321)+OM321*(s->In[5][21]*OM221+s->In[6][21]*OM321));
 ...
 s->l[1][21]-OM121*(s->In[6][21]*OM321-OM221*(s->In[1][21]-s->In[5][21])));
  ...
  FB221_6 = s->m[21]*C21*(s->dpt[1][3]+s->l[1][21]);
 ...
 s->In[3][22]*S22+CM123_21*C23-CM223_21*S23-FB222_21*s->l[3][22]+FB322_21*s->l[2][22]-s->dpt[3][37]*(FM123_21*S23+FM223_21*
...
// Backward Dynamics 
 ...
 s->dpt[2][1]*(FF17*S7-FF37*C7)+s->dpt[2][2]*(FF114*S14-FF314*C14)+s->dpt[3][3]*(FF221*C21-FF321*S21));
  CF26 = -(s->trq[2][6]-CF214-CF27-s->In[5][6]*OpF26-s->In[6][6]*OpF35-CF221*C21+CF321*S21-FA16*s->l[3][6]+FA36*
 s->l[1][6]-FF121*s->dpt[3][3]+OM16*(s->In[3][6]*OM16+s->In[6][6]*OM26+s->In[9][6]*OM36)-OM36*(s->In[1][6]*OM16+s->In[3][6]*
 OM36)+s->dpt[1][3]*(FF221*S21+FF321*C21));
 ...
 s->In[3][6]*OM36)-s->dpt[1][3]*(FF221*C21-FF321*S21)+s->dpt[2][1]*(FF17*C7+FF37*S7)+s->dpt[2][2]*(FF114*C14+FF314*S14));
 ...
 (FM221_1*S21+FM321_1*C21);
  CM36_1 = CM221_1*S21+CM321_1*C21+s->dpt[1][3]*(FM221_1*C21-FM321_1*S21)-CM114_1*S14-CM17_1*S7+CM314_1*C14+CM37_1*C7-
 FB16_1*s->l[2][6]+FB26_1*s->l[1][6]-s->dpt[2][1]*(FM17_1*C7+FM37_1*S7)-s->dpt[2][2]*(FM114_1*C14+FM314_1*S14);
 ...
 (FM221_2*S21+FM321_2*C21);
  CM36_2 = CM221_2*S21+CM321_2*C21+s->dpt[1][3]*(FM221_2*C21-FM321_2*S21)-CM114_2*S14-CM17_2*S7+CM314_2*C14+CM37_2*C7-
 FB16_2*s->l[2][6]+FB26_2*s->l[1][6]-s->dpt[2][1]*(FM17_2*C7+FM37_2*S7)-s->dpt[2][2]*(FM114_2*C14+FM314_2*S14);
 ...
 (FM221_3*S21+FM321_3*C21);
  CM36_3 = CM221_3*S21+CM321_3*C21+s->dpt[1][3]*(FM221_3*C21-FM321_3*S21)-CM114_3*S14-CM17_3*S7+CM314_3*C14+CM37_3*C7-
 FB16_3*s->l[2][6]+FB26_3*s->l[1][6]-s->dpt[2][1]*(FM17_3*C7+FM37_3*S7)-s->dpt[2][2]*(FM114_3*C14+FM314_3*S14);
 ...
 -s->dpt[1][3]*(FM221_4*S21+FM321_4*C21)+s->dpt[3][3]*(FB121_4+FM122_4*C22+FM322_4*S22);
 ...
 *C14+FM314_5*S14);
  CM36_6 = s->In[9][6]+s->m[6]*s->l[1][6]*s->l[1][6]+s->m[6]*s->l[2][6]*s->l[2][6]+s->dpt[1][3]*(C21*(FB221_6+FB222_6+
 FM123_6*S23+FM223_6*C23)-S21*(FB321_6+C22*(FB322_6+FB323_6-FM124_6*S24-FM128_6*S28+FM324_6*C24+FM328_6*C28)-S22*(FB122_6+
 FM123_6*C23-FM223_6*S23)))-s->dpt[2][1]*(C7*(FB17_6+FM18_6)+S7*(FB37_6+FM28_6*S8+FM38_6*C8))-s->dpt[2][2]*(C14*(FB114_6+
 FM115_6)+S14*(FB314_6+FM215_6*S15+FM315_6*C15))+C14*(s->In[9][14]*C14+CM215_6*S15+CM315_6*C15-FB114_6*s->l[2][14]+FB214_6*
 s->l[1][14]-FM115_6*s->dpt[2][20])-S14*(CM115_6-s->In[1][14]*S14-FB214_6*s->l[3][14]+FB314_6*s->l[2][14]+s->dpt[2][20]*(
 ...
 FB37_6*s->l[2][7]+s->dpt[2][6]*(FM28_6*S8+FM38_6*C8));
  ...
  CM55_26 = C6*(CM214_5+CM27_5+s->In[5][6]*C6+CM221_5*C21-CM321_5*S21+FB16_5*s->l[3][6]-FB36_5*s->l[1][6]-s->dpt[1][3]*(
 FM221_5*S21+FM321_5*C21)+s->dpt[3][3]*(FB121_5+FM122_5*C22+FM322_5*S22))+S6*(CM121_5+s->In[1][6]*S6+CM114_5*C14+CM17_5*C7+
 CM314_5*S14+CM37_5*S7-FB26_5*s->l[3][6]+FB36_5*s->l[2][6]-s->dpt[2][1]*(FM17_5*S7-FM37_5*C7)-s->dpt[2][2]*(FM114_5*S14-
 FM314_5*C14)-s->dpt[3][3]*(FM221_5*C21-FM321_5*S21));
