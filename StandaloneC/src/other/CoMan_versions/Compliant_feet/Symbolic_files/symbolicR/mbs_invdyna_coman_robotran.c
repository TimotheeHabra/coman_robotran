...
// Forward Kinematics 
  ...
  ALPHA114 = C14*(ALPHA16+BETA26*s->dpt[2][2])-S14*(ALPHA35+BETA86*s->dpt[2][2]);
  ALPHA214 = ALPHA26+BS56*s->dpt[2][2];
  ALPHA314 = C14*(ALPHA35+BETA86*s->dpt[2][2])+S14*(ALPHA16+BETA26*s->dpt[2][2]);
  OM115 = qd[15]+OM114;
  ...
  ALPHA115 = ALPHA114+BETA214*s->dpt[2][20];
  ALPHA215 = C15*(ALPHA214+BS514*s->dpt[2][20])+S15*(ALPHA314+BETA814*s->dpt[2][20]);
  ALPHA315 = C15*(ALPHA314+BETA814*s->dpt[2][20])-S15*(ALPHA214+BS514*s->dpt[2][20]);
  ...
  ALPHA116 = C16*(ALPHA115+BETA315*s->dpt[3][22])+S16*(ALPHA215+BETA615*s->dpt[3][22]);
  ALPHA216 = C16*(ALPHA215+BETA615*s->dpt[3][22])-S16*(ALPHA115+BETA315*s->dpt[3][22]);
  ALPHA316 = ALPHA315+BS915*s->dpt[3][22];
  ...
  ALPHA117 = C17*(ALPHA116+BETA316*s->dpt[3][24])-S17*(ALPHA316+BS916*s->dpt[3][24]);
  ALPHA217 = ALPHA216+BETA616*s->dpt[3][24];
  ALPHA317 = C17*(ALPHA316+BS916*s->dpt[3][24])+S17*(ALPHA116+BETA316*s->dpt[3][24]);
  OM118 = qd[18]+OM117;
  ...
  BS318 = OM118*OM318;
  BS618 = OM218*OM318;
  ALPHA118 = ALPHA117+BETA317*s->dpt[3][26];
  ALPHA218 = C18*(ALPHA217+BETA617*s->dpt[3][26])+S18*(ALPHA317+BS917*s->dpt[3][26]);
  ALPHA318 = C18*(ALPHA317+BS917*s->dpt[3][26])-S18*(ALPHA217+BETA617*s->dpt[3][26]);
  ...
  BS321 = OM121*OM321;
  BS621 = OM221*OM321;
  ALPHA121 = ALPHA16+BETA36*s->dpt[3][3]+BS16*s->dpt[1][3];
  ALPHA221 = C21*(ALPHA26+BETA46*s->dpt[1][3]+BETA66*s->dpt[3][3])+S21*(ALPHA35+BETA76*s->dpt[1][3]+BS96*s->dpt[3][3]);
  ALPHA321 = C21*(ALPHA35+BETA76*s->dpt[1][3]+BS96*s->dpt[3][3])-S21*(ALPHA26+BETA46*s->dpt[1][3]+BETA66*s->dpt[3][3]);
  ...
  ALPHA123 = C23*(ALPHA122+BETA322*s->dpt[3][37])+S23*(ALPHA221+BETA622*s->dpt[3][37]);
  ALPHA223 = C23*(ALPHA221+BETA622*s->dpt[3][37])-S23*(ALPHA122+BETA322*s->dpt[3][37]);
  ALPHA323 = ALPHA322+BS922*s->dpt[3][37];
  ...
  ALPHA124 = C24*(ALPHA123+BETA223*s->dpt[2][41]+BETA323*s->dpt[3][41]+BS123*s->dpt[1][41])-S24*(ALPHA323+BETA723*
 s->dpt[1][41]+BETA823*s->dpt[2][41]+BS923*s->dpt[3][41]);
  ALPHA224 = ALPHA223+BETA423*s->dpt[1][41]+BETA623*s->dpt[3][41]+BS523*s->dpt[2][41];
  ALPHA324 = C24*(ALPHA323+BETA723*s->dpt[1][41]+BETA823*s->dpt[2][41]+BS923*s->dpt[3][41])+S24*(ALPHA123+BETA223*
 s->dpt[2][41]+BETA323*s->dpt[3][41]+BS123*s->dpt[1][41]);
  OM125 = qd[25]+OM124;
  ...
  ALPHA125 = ALPHA124+BETA224*s->dpt[2][44];
  ALPHA225 = C25*(ALPHA224+BS524*s->dpt[2][44])+S25*(ALPHA324+BETA824*s->dpt[2][44]);
  ALPHA325 = C25*(ALPHA324+BETA824*s->dpt[2][44])-S25*(ALPHA224+BS524*s->dpt[2][44]);
  ...
  ALPHA126 = C26*(ALPHA125+BETA325*s->dpt[3][46])+S26*(ALPHA225+BETA625*s->dpt[3][46]);
  ALPHA226 = C26*(ALPHA225+BETA625*s->dpt[3][46])-S26*(ALPHA125+BETA325*s->dpt[3][46]);
  ALPHA326 = ALPHA325+BS925*s->dpt[3][46];
  ...
  ALPHA128 = C28*(ALPHA123+BETA223*s->dpt[2][42]+BETA323*s->dpt[3][42]+BS123*s->dpt[1][42])-S28*(ALPHA323+BETA723*
 s->dpt[1][42]+BETA823*s->dpt[2][42]+BS923*s->dpt[3][42]);
  ALPHA228 = ALPHA223+BETA423*s->dpt[1][42]+BETA623*s->dpt[3][42]+BS523*s->dpt[2][42];
  ALPHA328 = C28*(ALPHA323+BETA723*s->dpt[1][42]+BETA823*s->dpt[2][42]+BS923*s->dpt[3][42])+S28*(ALPHA123+BETA223*
 s->dpt[2][42]+BETA323*s->dpt[3][42]+BS123*s->dpt[1][42]);
  OM129 = qd[29]+OM128;
  ...
  ALPHA129 = ALPHA128+BETA228*s->dpt[2][52];
  ALPHA229 = C29*(ALPHA228+BS528*s->dpt[2][52])+S29*(ALPHA328+BETA828*s->dpt[2][52]);
  ALPHA329 = C29*(ALPHA328+BETA828*s->dpt[2][52])-S29*(ALPHA228+BS528*s->dpt[2][52]);
  ...
  ALPHA130 = C30*(ALPHA129+BETA329*s->dpt[3][54])+S30*(ALPHA229+BETA629*s->dpt[3][54]);
  ALPHA230 = C30*(ALPHA229+BETA629*s->dpt[3][54])-S30*(ALPHA129+BETA329*s->dpt[3][54]);
  ALPHA330 = ALPHA329+BS929*s->dpt[3][54];
...
// Backward Dynamics 
 ...
 OMp231)-C31*(ALPHA130+BETA330*s->dpt[3][56])+S31*(ALPHA330+BS930*s->dpt[3][56])));
  Fs231 = -(s->frc[2][31]-s->m[31]*(ALPHA230+BETA630*s->dpt[3][56]+s->l[1][31]*(BS231+OMp331)-s->l[2][31]*(OM131*OM131+
 ...
 *OM231)+C31*(ALPHA330+BS930*s->dpt[3][56])+S31*(ALPHA130+BETA330*s->dpt[3][56])));
 ...
 s->dpt[3][56]-Fs330*s->l[2][30]-OM230*(s->In[3][30]*OM130+s->In[6][30]*OM230+s->In[9][30]*OM330)+OM330*(s->In[5][30]*OM230+
 s->In[6][30]*OM330));
  Cq230 = -(s->trq[2][30]-Cq231-s->In[5][30]*OMp230-s->In[6][30]*OMp330-Fs130*s->l[3][30]+Fs330*s->l[1][30]+OM130*(
 s->In[3][30]*OM130+s->In[6][30]*OM230+s->In[9][30]*OM330)-OM330*(s->In[1][30]*OM130+s->In[3][30]*OM330)-s->dpt[3][56]*(Fs131
 *C31+Fs331*S31));
 ...
 s->In[5][29]*OM229+s->In[6][29]*OM329)+s->dpt[3][54]*(Fq130*S30+Fq230*C30));
 ...
 s->In[2][29]*OM229+s->In[3][29]*OM329)-s->dpt[3][54]*(Fq130*C30-Fq230*S30));
 ...
 s->In[9][28])-s->dpt[2][52]*(Fq229*S29+Fq329*C29));
  Cq228 = -(s->trq[2][28]-s->In[5][28]*OMp228-Cq229*C29+Cq329*S29-Fs128*s->l[3][28]+Fs328*s->l[1][28]-OM128*OM328*(
 s->In[1][28]-s->In[9][28]));
  Cq328 = -(s->trq[3][28]-s->In[9][28]*OMp328-Cq229*S29-Cq329*C29+Fq129*s->dpt[2][52]+Fs128*s->l[2][28]-Fs228*
 ...
 OMp227)-C27*(ALPHA126+BETA326*s->dpt[3][48])+S27*(ALPHA326+BS926*s->dpt[3][48])));
  Fs227 = -(s->frc[2][27]-s->m[27]*(ALPHA226+BETA626*s->dpt[3][48]+s->l[1][27]*(BS227+OMp327)-s->l[2][27]*(OM127*OM127+
 ...
 *OM227)+C27*(ALPHA326+BS926*s->dpt[3][48])+S27*(ALPHA126+BETA326*s->dpt[3][48])));
 ...
 s->l[3][26]+Fs227*s->dpt[3][48]-Fs326*s->l[2][26]-OM226*(s->In[3][26]*OM126+s->In[9][26]*OM326)+OM326*(s->In[2][26]*OM126+
 s->In[5][26]*OM226));
  Cq226 = -(s->trq[2][26]-Cq227-s->In[2][26]*OMp126-s->In[5][26]*OMp226-Fs126*s->l[3][26]+Fs326*s->l[1][26]+OM126*(
 s->In[3][26]*OM126+s->In[9][26]*OM326)-OM326*(s->In[1][26]*OM126+s->In[2][26]*OM226+s->In[3][26]*OM326)-s->dpt[3][48]*(Fs127
 *C27+Fs327*S27));
 ...
 s->l[2][25]-OM225*(s->In[3][25]*OM125-s->In[5][25]*OM325+s->In[9][25]*OM325)+s->dpt[3][46]*(Fq126*S26+Fq226*C26));
  Cq225 = -(s->trq[2][25]-s->In[5][25]*OMp225-Cq126*S26-Cq226*C26-Fs125*s->l[3][25]+Fs325*s->l[1][25]+OM125*(
 s->In[3][25]*OM125+s->In[9][25]*OM325)-OM325*(s->In[1][25]*OM125+s->In[3][25]*OM325)-s->dpt[3][46]*(Fq126*C26-Fq226*S26));
 ...
 s->In[6][24]*OM224+s->In[9][24]*OM324)+OM324*(s->In[2][24]*OM124+s->In[5][24]*OM224+s->In[6][24]*OM324)-s->dpt[2][44]*(Fq225
 *S25+Fq325*C25));
 ...
 s->l[3][24]+Fs324*s->l[1][24]+OM124*(s->In[6][24]*OM224+s->In[9][24]*OM324)-OM324*(s->In[1][24]*OM124+s->In[2][24]*OM224));
  Cq324 = -(s->trq[3][24]-s->In[6][24]*OMp224-s->In[9][24]*OMp324-Cq225*S25-Cq325*C25+Fq125*s->dpt[2][44]+Fs124*
 ...
 s->In[2][24]*OM224));
  ...
  Cq123 = -(s->trq[1][23]-s->In[1][23]*OMp123-Cq124*C24-Cq128*C28-Cq324*S24-Cq328*S28+Fq224*s->dpt[3][41]+Fq228*
 s->dpt[3][42]+Fs223*s->l[3][23]-Fs323*s->l[2][23]-OM223*(s->In[6][23]*OM223+s->In[9][23]*OM323)+OM323*(s->In[5][23]*OM223+
 s->In[6][23]*OM323)+s->dpt[2][41]*(Fq124*S24-Fq324*C24)+s->dpt[2][42]*(Fq128*S28-Fq328*C28));
  Cq223 = -(s->trq[2][23]-Cq224-Cq228-s->In[5][23]*OMp223-s->In[6][23]*OMp323-Fs123*s->l[3][23]+Fs323*s->l[1][23]-OM123*
 (s->In[1][23]*OM323-s->In[6][23]*OM223-s->In[9][23]*OM323)-s->dpt[1][41]*(Fq124*S24-Fq324*C24)-s->dpt[1][42]*(Fq128*S28-
 Fq328*C28)-s->dpt[3][41]*(Fq124*C24+Fq324*S24)-s->dpt[3][42]*(Fq128*C28+Fq328*S28));
  Cq323 = -(s->trq[3][23]-s->In[6][23]*OMp223-s->In[9][23]*OMp323+Cq124*S24+Cq128*S28-Cq324*C24-Cq328*C28-Fq224*
 s->dpt[1][41]-Fq228*s->dpt[1][42]+Fs123*s->l[2][23]-Fs223*s->l[1][23]+OM123*(s->In[1][23]*OM223-s->In[5][23]*OM223-
 s->In[6][23]*OM323)+s->dpt[2][41]*(Fq124*C24+Fq324*S24)+s->dpt[2][42]*(Fq128*C28+Fq328*S28));
 ...
 s->l[2][22]-OM222*(s->In[3][22]*OM122-s->In[5][22]*OM322+s->In[9][22]*OM322)+s->dpt[3][37]*(Fq123*S23+Fq223*C23));
  Cq222 = -(s->trq[2][22]-s->In[5][22]*OMp222-Cq123*S23-Cq223*C23-Fs122*s->l[3][22]+Fs322*s->l[1][22]+OM122*(
 s->In[3][22]*OM122+s->In[9][22]*OM322)-OM322*(s->In[1][22]*OM122+s->In[3][22]*OM322)-s->dpt[3][37]*(Fq123*C23-Fq223*S23));
 ...
 BETA319*s->dpt[3][32]+BS119*s->dpt[1][32])+S20*(ALPHA319+BETA719*s->dpt[1][32]+BS919*s->dpt[3][32])));
  Fs220 = -(s->frc[2][20]-s->m[20]*(ALPHA218+BETA419*s->dpt[1][32]+BETA619*s->dpt[3][32]+s->l[1][20]*(OMp320+OM120*OM220
 )-s->l[3][20]*(OMp120-OM220*OM320)));
  Fs320 = -(s->frc[3][20]-s->m[20]*(s->l[1][20]*(BS320-OMp220)-s->l[3][20]*(OM120*OM120+OM220*OM220)+C20*(ALPHA319+
 BETA719*s->dpt[1][32]+BS919*s->dpt[3][32])+S20*(ALPHA119+BETA319*s->dpt[3][32]+BS119*s->dpt[1][32])));
  ...
  Cq119 = -(s->trq[1][19]-s->In[1][19]*OMp119-Cq120*C20-Cq320*S20+Fs219*s->l[3][19]+Fs220*s->dpt[3][32]+OM219*OM319*(
 s->In[5][19]-s->In[9][19]));
  Cq219 = -(s->trq[2][19]-Cq220-s->In[5][19]*OMp219-Fs119*s->l[3][19]+Fs319*s->l[1][19]-OM119*OM319*(s->In[1][19]-
 s->In[9][19])-s->dpt[1][32]*(Fs120*S20-Fs320*C20)-s->dpt[3][32]*(Fs120*C20+Fs320*S20));
  Cq319 = -(s->trq[3][19]-s->In[9][19]*OMp319+Cq120*S20-Cq320*C20-Fs219*s->l[1][19]-Fs220*s->dpt[1][32]+OM119*OM219*(
 s->In[1][19]-s->In[5][19]));
 ...
 s->In[3][17]*OM117-s->In[5][17]*OM317+s->In[9][17]*OM317)+s->dpt[3][26]*(Fq218*C18-Fq318*S18));
  Cq217 = -(s->trq[2][17]-s->In[5][17]*OMp217-Cq218*C18+Cq318*S18-Fq118*s->dpt[3][26]-Fs117*s->l[3][17]+Fs317*
 ...
 OM316*OM316)));
  ...
  Fq216 = Fq217+Fs216;
  Cq116 = -(s->trq[1][16]-s->In[1][16]*OMp116-s->In[3][16]*OMp316-Cq117*C17-Cq317*S17+Fq217*s->dpt[3][24]+Fs216*
 ...
 s->In[9][16]*OM316)-OM316*(s->In[1][16]*OM116+s->In[3][16]*OM316)-s->dpt[3][24]*(Fq117*C17+Fq317*S17));
 ...
 s->l[2][15]+OM315*(s->In[2][15]*OM115+s->In[5][15]*OM215-s->In[9][15]*OM215)+s->dpt[3][22]*(Fq116*S16+Fq216*C16));
  Cq215 = -(s->trq[2][15]-s->In[2][15]*OMp115-s->In[5][15]*OMp215-Cq116*S16-Cq216*C16-Fs115*s->l[3][15]+Fs315*
 s->l[1][15]-OM315*(s->In[1][15]*OM115+s->In[2][15]*OM215-s->In[9][15]*OM115)-s->dpt[3][22]*(Fq116*C16-Fq216*S16));
 ...
 s->In[6][14]*OM214+s->In[9][14]*OM314)+OM314*(s->In[2][14]*OM114+s->In[5][14]*OM214+s->In[6][14]*OM314)-s->dpt[2][20]*(Fq215
 *S15+Fq315*C15));
 ...
 s->l[3][14]+Fs314*s->l[1][14]+OM114*(s->In[6][14]*OM214+s->In[9][14]*OM314)-OM314*(s->In[1][14]*OM114+s->In[2][14]*OM214));
  Cq314 = -(s->trq[3][14]-s->In[6][14]*OMp214-s->In[9][14]*OMp314-Cq215*S15-Cq315*C15+Fq115*s->dpt[2][20]+Fs114*
 ...
 BETA312*s->dpt[3][18]+BS112*s->dpt[1][18])+S13*(ALPHA312+BETA712*s->dpt[1][18]+BS912*s->dpt[3][18])));
  Fs213 = -(s->frc[2][13]-s->m[13]*(ALPHA211+BETA412*s->dpt[1][18]+BETA612*s->dpt[3][18]+s->l[1][13]*(OMp313+OM113*OM213
 )-s->l[3][13]*(OMp113-OM213*OM313)));
  Fs313 = -(s->frc[3][13]-s->m[13]*(s->l[1][13]*(BS313-OMp213)-s->l[3][13]*(OM113*OM113+OM213*OM213)+C13*(ALPHA312+
 BETA712*s->dpt[1][18]+BS912*s->dpt[3][18])+S13*(ALPHA112+BETA312*s->dpt[3][18]+BS112*s->dpt[1][18])));
  ...
  Cq112 = -(s->trq[1][12]-s->In[1][12]*OMp112-Cq113*C13-Cq313*S13+Fs212*s->l[3][12]+Fs213*s->dpt[3][18]+OM212*OM312*(
 s->In[5][12]-s->In[9][12]));
  Cq212 = -(s->trq[2][12]-Cq213-s->In[5][12]*OMp212-Fs112*s->l[3][12]+Fs312*s->l[1][12]-OM112*OM312*(s->In[1][12]-
 s->In[9][12])-s->dpt[1][18]*(Fs113*S13-Fs313*C13)-s->dpt[3][18]*(Fs113*C13+Fs313*S13));
  Cq312 = -(s->trq[3][12]-s->In[9][12]*OMp312+Cq113*S13-Cq313*C13-Fs212*s->l[1][12]-Fs213*s->dpt[1][18]+OM112*OM212*(
 s->In[1][12]-s->In[5][12]));
 ...
 *(s->In[3][9]*OM19+s->In[6][9]*OM29+s->In[9][9]*OM39)-OM39*(s->In[1][9]*OM19+s->In[2][9]*OM29+s->In[3][9]*OM39)-
 ...
 s->dpt[2][1]*(Fq17*S7-Fq37*C7)+s->dpt[2][2]*(Fq114*S14-Fq314*C14)+s->dpt[3][3]*(Fq221*C21-Fq321*S21));
  Cq26 = -(s->trq[2][6]-Cq214-Cq27-s->In[5][6]*OMp26-s->In[6][6]*OMp36-Cq221*C21+Cq321*S21-Fq121*s->dpt[3][3]-Fs16*
 s->l[3][6]+Fs36*s->l[1][6]+OM16*(s->In[3][6]*OM16+s->In[6][6]*OM26+s->In[9][6]*OM36)-OM36*(s->In[1][6]*OM16+s->In[3][6]*OM36
 )+s->dpt[1][3]*(Fq221*S21+Fq321*C21));
 ...
 s->In[3][6]*OM36)-s->dpt[1][3]*(Fq221*C21-Fq321*S21)+s->dpt[2][1]*(Fq17*C7+Fq37*S7)+s->dpt[2][2]*(Fq114*C14+Fq314*S14));
