...
// Forward Kinematics 
  ...
  BeF27 = BS27-OpF37;
  BeF87 = BS67+OpF17;
  AlF17 = C7*(AlF16+BeF26*s->dpt[2][3])-S7*(AlF35+BeF86*s->dpt[2][3]);
  AlF27 = AlF26+BS56*s->dpt[2][3];
  AlF37 = C7*(AlF35+BeF86*s->dpt[2][3])+S7*(AlF16+BeF26*s->dpt[2][3]);
  ...
  AlM17_4 = -s->dpt[2][3]*(OpM16_4*S7+S5*C7);
  AlM37_4 = s->dpt[2][3]*(OpM16_4*C7-S5*S7);
  OpM17_5 = S6*C7;
  OpM37_5 = S6*S7;
  AlM17_5 = -s->dpt[2][3]*S6*S7;
  AlM37_5 = s->dpt[2][3]*S6*C7;
  AlM17_6 = -s->dpt[2][3]*C7;
  AlM37_6 = -s->dpt[2][3]*S7;
  OM18 = qd[8]+OM17;
  ...
  BeF38 = BS38+OpF28;
  BeF68 = BS68-OpF17;
  AlF18 = AlF17+BeF27*s->dpt[2][8];
  AlF28 = C8*(AlF27+BS57*s->dpt[2][8])+S8*(AlF37+BeF87*s->dpt[2][8]);
  AlF38 = C8*(AlF37+BeF87*s->dpt[2][8])-S8*(AlF27+BS57*s->dpt[2][8]);
  ...
  AlM18_4 = AlM17_4-OpM37_4*s->dpt[2][8];
  AlM28_4 = S8*(AlM37_4+OpM17_4*s->dpt[2][8]);
  AlM38_4 = C8*(AlM37_4+OpM17_4*s->dpt[2][8]);
  OpM28_5 = OpM37_5*S8+C6*C8;
  OpM38_5 = OpM37_5*C8-C6*S8;
  AlM18_5 = AlM17_5-OpM37_5*s->dpt[2][8];
  AlM28_5 = S8*(AlM37_5+OpM17_5*s->dpt[2][8]);
  AlM38_5 = C8*(AlM37_5+OpM17_5*s->dpt[2][8]);
  OpM28_6 = C7*S8;
  OpM38_6 = C7*C8;
  AlM18_6 = AlM17_6-s->dpt[2][8]*C7;
  AlM28_6 = S8*(AlM37_6-s->dpt[2][8]*S7);
  AlM38_6 = C8*(AlM37_6-s->dpt[2][8]*S7);
  ...
  BeF39 = BS39+OpF29;
  BeF69 = BS69-OpF19;
  AlF19 = C9*(AlF18+BeF38*s->dpt[3][10])+S9*(AlF28+BeF68*s->dpt[3][10]);
  AlF29 = C9*(AlF28+BeF68*s->dpt[3][10])-S9*(AlF18+BeF38*s->dpt[3][10]);
  AlF39 = AlF38+BS98*s->dpt[3][10];
  ...
  AlM19_4 = C9*(AlM18_4+OpM28_4*s->dpt[3][10])+S9*(AlM28_4-OpM17_4*s->dpt[3][10]);
  AlM29_4 = C9*(AlM28_4-OpM17_4*s->dpt[3][10])-S9*(AlM18_4+OpM28_4*s->dpt[3][10]);
  OpM19_5 = OpM17_5*C9+OpM28_5*S9;
  OpM29_5 = -(OpM17_5*S9-OpM28_5*C9);
  AlM19_5 = C9*(AlM18_5+OpM28_5*s->dpt[3][10])+S9*(AlM28_5-OpM17_5*s->dpt[3][10]);
  AlM29_5 = C9*(AlM28_5-OpM17_5*s->dpt[3][10])-S9*(AlM18_5+OpM28_5*s->dpt[3][10]);
  OpM19_6 = OpM28_6*S9-S7*C9;
  OpM29_6 = OpM28_6*C9+S7*S9;
  AlM19_6 = C9*(AlM18_6+OpM28_6*s->dpt[3][10])+S9*(AlM28_6+s->dpt[3][10]*S7);
  AlM29_6 = C9*(AlM28_6+s->dpt[3][10]*S7)-S9*(AlM18_6+OpM28_6*s->dpt[3][10]);
  OpM19_7 = C8*S9;
  OpM29_7 = C8*C9;
  AlM19_7 = s->dpt[3][10]*C8*C9;
  AlM29_7 = -s->dpt[3][10]*C8*S9;
  AlM19_8 = -s->dpt[3][10]*S9;
  AlM29_8 = -s->dpt[3][10]*C9;
  ...
  BeF310 = BS310+OpF29;
  BeF610 = BS610-OpF110;
  AlF110 = C10*(AlF19+BeF39*s->dpt[3][12])-S10*(AlF39+BS99*s->dpt[3][12]);
  AlF210 = AlF29+BeF69*s->dpt[3][12];
  AlF310 = C10*(AlF39+BS99*s->dpt[3][12])+S10*(AlF19+BeF39*s->dpt[3][12]);
  ...
  AlM110_4 = -(AlM38_4*S10-C10*(AlM19_4+OpM29_4*s->dpt[3][12]));
  AlM210_4 = AlM29_4-OpM19_4*s->dpt[3][12];
  AlM310_4 = AlM38_4*C10+S10*(AlM19_4+OpM29_4*s->dpt[3][12]);
  OpM110_5 = OpM19_5*C10-OpM38_5*S10;
  OpM310_5 = OpM19_5*S10+OpM38_5*C10;
  AlM110_5 = -(AlM38_5*S10-C10*(AlM19_5+OpM29_5*s->dpt[3][12]));
  AlM210_5 = AlM29_5-OpM19_5*s->dpt[3][12];
  AlM310_5 = AlM38_5*C10+S10*(AlM19_5+OpM29_5*s->dpt[3][12]);
  OpM110_6 = OpM19_6*C10-OpM38_6*S10;
  OpM310_6 = OpM19_6*S10+OpM38_6*C10;
  AlM110_6 = -(AlM38_6*S10-C10*(AlM19_6+OpM29_6*s->dpt[3][12]));
  AlM210_6 = AlM29_6-OpM19_6*s->dpt[3][12];
  AlM310_6 = AlM38_6*C10+S10*(AlM19_6+OpM29_6*s->dpt[3][12]);
  OpM110_7 = OpM19_7*C10+S10*S8;
  OpM310_7 = OpM19_7*S10-C10*S8;
  AlM110_7 = C10*(AlM19_7+OpM29_7*s->dpt[3][12]);
  AlM210_7 = AlM29_7-OpM19_7*s->dpt[3][12];
  AlM310_7 = S10*(AlM19_7+OpM29_7*s->dpt[3][12]);
  OpM110_8 = C10*C9;
  OpM310_8 = S10*C9;
  AlM110_8 = C10*(AlM19_8-s->dpt[3][12]*S9);
  AlM210_8 = AlM29_8-s->dpt[3][12]*C9;
  AlM310_8 = S10*(AlM19_8-s->dpt[3][12]*S9);
  OM111 = qd[11]+OM110;
...
// Forward Kinematics 
  ...
  BeF213 = BS213-OpF313;
  BeF813 = BS613+OpF113;
  AlF113 = C13*(AlF16+BeF26*s->dpt[2][4])-S13*(AlF35+BeF86*s->dpt[2][4]);
  ...
  AlM113_4 = -s->dpt[2][4]*(OpM16_4*S13+C13*S5);
  AlM313_4 = s->dpt[2][4]*(OpM16_4*C13-S13*S5);
  OpM113_5 = C13*S6;
  OpM313_5 = S13*S6;
  AlM113_5 = -s->dpt[2][4]*S13*S6;
  AlM313_5 = s->dpt[2][4]*C13*S6;
  AlM113_6 = -s->dpt[2][4]*C13;
  ...
  BeF316 = BS316+OpF215;
  BeF616 = BS616-OpF116;
  AlF116 = C16*(AlF115+BeF315*s->dpt[3][24])-S16*(AlF315+BS915*s->dpt[3][24]);
  AlF216 = AlF215+BeF615*s->dpt[3][24];
  AlF316 = C16*(AlF315+BS915*s->dpt[3][24])+S16*(AlF115+BeF315*s->dpt[3][24]);
  ...
  AlM116_4 = -(AlM314_4*S16-C16*(AlM115_4+OpM215_4*s->dpt[3][24]));
  AlM216_4 = AlM215_4-OpM115_4*s->dpt[3][24];
  AlM316_4 = AlM314_4*C16+S16*(AlM115_4+OpM215_4*s->dpt[3][24]);
  OpM116_5 = OpM115_5*C16-OpM314_5*S16;
  OpM316_5 = OpM115_5*S16+OpM314_5*C16;
  AlM116_5 = -(AlM314_5*S16-C16*(AlM115_5+OpM215_5*s->dpt[3][24]));
  AlM216_5 = AlM215_5-OpM115_5*s->dpt[3][24];
  AlM316_5 = AlM314_5*C16+S16*(AlM115_5+OpM215_5*s->dpt[3][24]);
  OpM116_6 = OpM115_6*C16-OpM314_6*S16;
  OpM316_6 = OpM115_6*S16+OpM314_6*C16;
  AlM116_6 = -(AlM314_6*S16-C16*(AlM115_6+OpM215_6*s->dpt[3][24]));
  AlM216_6 = AlM215_6-OpM115_6*s->dpt[3][24];
  AlM316_6 = AlM314_6*C16+S16*(AlM115_6+OpM215_6*s->dpt[3][24]);
  OpM116_13 = OpM115_13*C16+S14*S16;
  OpM316_13 = OpM115_13*S16-S14*C16;
  AlM116_13 = C16*(AlM115_13+OpM215_13*s->dpt[3][24]);
  AlM216_13 = AlM215_13-OpM115_13*s->dpt[3][24];
  AlM316_13 = S16*(AlM115_13+OpM215_13*s->dpt[3][24]);
  OpM116_14 = C15*C16;
  OpM316_14 = C15*S16;
  AlM116_14 = C16*(AlM115_14-s->dpt[3][24]*S15);
  AlM216_14 = AlM215_14-s->dpt[3][24]*C15;
  AlM316_14 = S16*(AlM115_14-s->dpt[3][24]*S15);
  OM117 = qd[17]+OM116;
  ...
  BS317 = OM117*OM317;
  BS617 = OM217*OM317;
  AlF117 = AlF116+BeF316*s->dpt[3][26];
  AlF217 = C17*(AlF216+BeF616*s->dpt[3][26])+S17*(AlF316+BS916*s->dpt[3][26]);
  AlF317 = C17*(AlF316+BS916*s->dpt[3][26])-S17*(AlF216+BeF616*s->dpt[3][26]);
  ...
  AlM117_4 = AlM116_4+OpM215_4*s->dpt[3][26];
  AlM217_4 = AlM316_4*S17+C17*(AlM216_4-OpM116_4*s->dpt[3][26]);
  AlM317_4 = AlM316_4*C17-S17*(AlM216_4-OpM116_4*s->dpt[3][26]);
  OpM217_5 = OpM215_5*C17+OpM316_5*S17;
  OpM317_5 = -(OpM215_5*S17-OpM316_5*C17);
  AlM117_5 = AlM116_5+OpM215_5*s->dpt[3][26];
  AlM217_5 = AlM316_5*S17+C17*(AlM216_5-OpM116_5*s->dpt[3][26]);
  AlM317_5 = AlM316_5*C17-S17*(AlM216_5-OpM116_5*s->dpt[3][26]);
  OpM217_6 = OpM215_6*C17+OpM316_6*S17;
  OpM317_6 = -(OpM215_6*S17-OpM316_6*C17);
  AlM117_6 = AlM116_6+OpM215_6*s->dpt[3][26];
  AlM217_6 = AlM316_6*S17+C17*(AlM216_6-OpM116_6*s->dpt[3][26]);
  AlM317_6 = AlM316_6*C17-S17*(AlM216_6-OpM116_6*s->dpt[3][26]);
  OpM217_13 = OpM215_13*C17+OpM316_13*S17;
  OpM317_13 = -(OpM215_13*S17-OpM316_13*C17);
  AlM117_13 = AlM116_13+OpM215_13*s->dpt[3][26];
  AlM217_13 = AlM316_13*S17+C17*(AlM216_13-OpM116_13*s->dpt[3][26]);
  AlM317_13 = AlM316_13*C17-S17*(AlM216_13-OpM116_13*s->dpt[3][26]);
  OpM217_14 = OpM316_14*S17-S15*C17;
  OpM317_14 = OpM316_14*C17+S15*S17;
  AlM117_14 = AlM116_14-s->dpt[3][26]*S15;
  AlM217_14 = AlM316_14*S17+C17*(AlM216_14-OpM116_14*s->dpt[3][26]);
  AlM317_14 = AlM316_14*C17-S17*(AlM216_14-OpM116_14*s->dpt[3][26]);
  OpM217_15 = C16*S17;
  OpM317_15 = C16*C17;
  AlM217_15 = s->dpt[3][26]*S16*C17;
  AlM317_15 = -s->dpt[3][26]*S16*S17;
...
// Forward Kinematics 
  ...
  BS319 = OM119*OM319;
  BS619 = OM219*OM319;
  AlF119 = AlF16+BS16*s->dpt[1][5]+BeF36*s->dpt[3][5];
  AlF219 = C19*(AlF26+BeF46*s->dpt[1][5]+BeF66*s->dpt[3][5])+S19*(AlF35+BS96*s->dpt[3][5]+BeF76*s->dpt[1][5]);
  AlF319 = C19*(AlF35+BS96*s->dpt[3][5]+BeF76*s->dpt[1][5])-S19*(AlF26+BeF46*s->dpt[1][5]+BeF66*s->dpt[3][5]);
  ...
  AlM119_4 = OpM26_4*s->dpt[3][5];
  AlM219_4 = -(OpM26_4*s->dpt[1][5]*S19+C19*(OpM16_4*s->dpt[3][5]-s->dpt[1][5]*S5));
  AlM319_4 = -(OpM26_4*s->dpt[1][5]*C19-S19*(OpM16_4*s->dpt[3][5]-s->dpt[1][5]*S5));
  OpM219_5 = C19*C6;
  OpM319_5 = -S19*C6;
  AlM119_5 = s->dpt[3][5]*C6;
  AlM219_5 = -(s->dpt[1][5]*S19*C6+s->dpt[3][5]*C19*S6);
  AlM319_5 = -(s->dpt[1][5]*C19*C6-s->dpt[3][5]*S19*S6);
  AlM219_6 = s->dpt[1][5]*C19;
  AlM319_6 = -s->dpt[1][5]*S19;
  ...
  BeF721 = BS321-OpF221;
  BeF821 = BS621+OpF121;
  AlF121 = C21*(AlF120+BeF320*s->dpt[3][35])+S21*(AlF219+BeF620*s->dpt[3][35]);
  AlF221 = C21*(AlF219+BeF620*s->dpt[3][35])-S21*(AlF120+BeF320*s->dpt[3][35]);
  AlF321 = AlF320+BS920*s->dpt[3][35];
  ...
  AlM121_4 = C21*(AlM120_4+OpM219_4*s->dpt[3][35])+S21*(AlM219_4-OpM120_4*s->dpt[3][35]);
  AlM221_4 = C21*(AlM219_4-OpM120_4*s->dpt[3][35])-S21*(AlM120_4+OpM219_4*s->dpt[3][35]);
  OpM121_5 = OpM120_5*C21+OpM219_5*S21;
  OpM221_5 = -(OpM120_5*S21-OpM219_5*C21);
  AlM121_5 = C21*(AlM120_5+OpM219_5*s->dpt[3][35])+S21*(AlM219_5-OpM120_5*s->dpt[3][35]);
  AlM221_5 = C21*(AlM219_5-OpM120_5*s->dpt[3][35])-S21*(AlM120_5+OpM219_5*s->dpt[3][35]);
  OpM121_6 = OpM120_6*C21+S19*S21;
  OpM221_6 = -(OpM120_6*S21-S19*C21);
  AlM121_6 = C21*(AlM120_6+s->dpt[3][35]*S19)+S21*(AlM219_6-OpM120_6*s->dpt[3][35]);
  AlM221_6 = C21*(AlM219_6-OpM120_6*s->dpt[3][35])-S21*(AlM120_6+s->dpt[3][35]*S19);
  OpM121_19 = C20*C21;
  OpM221_19 = -C20*S21;
  AlM121_19 = -s->dpt[3][35]*C20*S21;
  AlM221_19 = -s->dpt[3][35]*C20*C21;
  AlM221_20 = -s->dpt[3][35]*S21;
...
// Forward Kinematics 
  ...
  BeF222 = BS222-OpF322;
  BeF822 = BS622+OpF122;
  AlF122 = C22*(AlF121+BS121*s->dpt[1][39]+BeF221*s->dpt[2][39]+BeF321*s->dpt[3][39])-S22*(AlF321+BS921*s->dpt[3][39]+
 BeF721*s->dpt[1][39]+BeF821*s->dpt[2][39]);
  AlF222 = AlF221+BS521*s->dpt[2][39]+BeF421*s->dpt[1][39]+BeF621*s->dpt[3][39];
  AlF322 = C22*(AlF321+BS921*s->dpt[3][39]+BeF721*s->dpt[1][39]+BeF821*s->dpt[2][39])+S22*(AlF121+BS121*s->dpt[1][39]+
 BeF221*s->dpt[2][39]+BeF321*s->dpt[3][39]);
  ...
  AlM122_4 = C22*(AlM121_4+OpM221_4*s->dpt[3][39]-OpM320_4*s->dpt[2][39])-S22*(AlM320_4+OpM121_4*s->dpt[2][39]-OpM221_4*
 s->dpt[1][39]);
  AlM222_4 = AlM221_4-OpM121_4*s->dpt[3][39]+OpM320_4*s->dpt[1][39];
  AlM322_4 = C22*(AlM320_4+OpM121_4*s->dpt[2][39]-OpM221_4*s->dpt[1][39])+S22*(AlM121_4+OpM221_4*s->dpt[3][39]-OpM320_4*
 s->dpt[2][39]);
  OpM122_5 = OpM121_5*C22-OpM320_5*S22;
  OpM322_5 = OpM121_5*S22+OpM320_5*C22;
  AlM122_5 = C22*(AlM121_5+OpM221_5*s->dpt[3][39]-OpM320_5*s->dpt[2][39])-S22*(AlM320_5+OpM121_5*s->dpt[2][39]-OpM221_5*
 s->dpt[1][39]);
  AlM222_5 = AlM221_5-OpM121_5*s->dpt[3][39]+OpM320_5*s->dpt[1][39];
  AlM322_5 = C22*(AlM320_5+OpM121_5*s->dpt[2][39]-OpM221_5*s->dpt[1][39])+S22*(AlM121_5+OpM221_5*s->dpt[3][39]-OpM320_5*
 s->dpt[2][39]);
  OpM122_6 = OpM121_6*C22-OpM320_6*S22;
  OpM322_6 = OpM121_6*S22+OpM320_6*C22;
  AlM122_6 = C22*(AlM121_6+OpM221_6*s->dpt[3][39]-OpM320_6*s->dpt[2][39])-S22*(AlM320_6+OpM121_6*s->dpt[2][39]-OpM221_6*
 s->dpt[1][39]);
  AlM222_6 = AlM221_6-OpM121_6*s->dpt[3][39]+OpM320_6*s->dpt[1][39];
  AlM322_6 = C22*(AlM320_6+OpM121_6*s->dpt[2][39]-OpM221_6*s->dpt[1][39])+S22*(AlM121_6+OpM221_6*s->dpt[3][39]-OpM320_6*
 s->dpt[2][39]);
  OpM122_19 = OpM121_19*C22-S20*S22;
  OpM322_19 = OpM121_19*S22+S20*C22;
  AlM122_19 = C22*(AlM121_19+OpM221_19*s->dpt[3][39]-s->dpt[2][39]*S20)-S22*(OpM121_19*s->dpt[2][39]-OpM221_19*
 s->dpt[1][39]);
  AlM222_19 = AlM221_19-OpM121_19*s->dpt[3][39]+s->dpt[1][39]*S20;
  AlM322_19 = C22*(OpM121_19*s->dpt[2][39]-OpM221_19*s->dpt[1][39])+S22*(AlM121_19+OpM221_19*s->dpt[3][39]-s->dpt[2][39]
 *S20);
  OpM122_20 = S21*C22;
  OpM322_20 = S21*S22;
  AlM122_20 = C21*C22*(s->dpt[3][35]+s->dpt[3][39])+S22*(s->dpt[1][39]*C21-s->dpt[2][39]*S21);
  AlM222_20 = AlM221_20-s->dpt[3][39]*S21;
  AlM322_20 = C21*S22*(s->dpt[3][35]+s->dpt[3][39])-C22*(s->dpt[1][39]*C21-s->dpt[2][39]*S21);
  AlM122_21 = -s->dpt[2][39]*C22;
  OM123 = qd[23]+OM122;
  ...
  BeF323 = BS323+OpF223;
  BeF623 = BS623-OpF122;
  AlF123 = AlF122+BeF222*s->dpt[2][44];
  AlF223 = C23*(AlF222+BS522*s->dpt[2][44])+S23*(AlF322+BeF822*s->dpt[2][44]);
  AlF323 = C23*(AlF322+BeF822*s->dpt[2][44])-S23*(AlF222+BS522*s->dpt[2][44]);
  ...
  AlM123_4 = AlM122_4-OpM322_4*s->dpt[2][44];
  AlM223_4 = AlM222_4*C23+S23*(AlM322_4+OpM122_4*s->dpt[2][44]);
  AlM323_4 = -(AlM222_4*S23-C23*(AlM322_4+OpM122_4*s->dpt[2][44]));
  OpM223_5 = OpM221_5*C23+OpM322_5*S23;
  OpM323_5 = -(OpM221_5*S23-OpM322_5*C23);
  AlM123_5 = AlM122_5-OpM322_5*s->dpt[2][44];
  AlM223_5 = AlM222_5*C23+S23*(AlM322_5+OpM122_5*s->dpt[2][44]);
  AlM323_5 = -(AlM222_5*S23-C23*(AlM322_5+OpM122_5*s->dpt[2][44]));
  OpM223_6 = OpM221_6*C23+OpM322_6*S23;
  OpM323_6 = -(OpM221_6*S23-OpM322_6*C23);
  AlM123_6 = AlM122_6-OpM322_6*s->dpt[2][44];
  AlM223_6 = AlM222_6*C23+S23*(AlM322_6+OpM122_6*s->dpt[2][44]);
  AlM323_6 = -(AlM222_6*S23-C23*(AlM322_6+OpM122_6*s->dpt[2][44]));
  OpM223_19 = OpM221_19*C23+OpM322_19*S23;
  OpM323_19 = -(OpM221_19*S23-OpM322_19*C23);
  AlM123_19 = AlM122_19-OpM322_19*s->dpt[2][44];
  AlM223_19 = AlM222_19*C23+S23*(AlM322_19+OpM122_19*s->dpt[2][44]);
  AlM323_19 = -(AlM222_19*S23-C23*(AlM322_19+OpM122_19*s->dpt[2][44]));
  OpM223_20 = OpM322_20*S23+C21*C23;
  OpM323_20 = OpM322_20*C23-C21*S23;
  AlM123_20 = AlM122_20-OpM322_20*s->dpt[2][44];
  AlM223_20 = AlM222_20*C23+S23*(AlM322_20+OpM122_20*s->dpt[2][44]);
  AlM323_20 = -(AlM222_20*S23-C23*(AlM322_20+OpM122_20*s->dpt[2][44]));
  OpM223_21 = C22*S23;
  OpM323_21 = C22*C23;
  AlM123_21 = AlM122_21-s->dpt[2][44]*C22;
  AlM223_21 = s->dpt[1][39]*C23-S22*S23*(s->dpt[2][39]+s->dpt[2][44]);
  AlM323_21 = -(s->dpt[1][39]*S23+S22*C23*(s->dpt[2][39]+s->dpt[2][44]));
  ...
  BeF324 = BS324+OpF224;
  BeF624 = BS624-OpF124;
  AlF124 = C24*(AlF123+BeF323*s->dpt[3][46])+S24*(AlF223+BeF623*s->dpt[3][46]);
  AlF224 = C24*(AlF223+BeF623*s->dpt[3][46])-S24*(AlF123+BeF323*s->dpt[3][46]);
  AlF324 = AlF323+BS923*s->dpt[3][46];
  ...
  AlM124_4 = C24*(AlM123_4+OpM223_4*s->dpt[3][46])+S24*(AlM223_4-OpM122_4*s->dpt[3][46]);
  AlM224_4 = C24*(AlM223_4-OpM122_4*s->dpt[3][46])-S24*(AlM123_4+OpM223_4*s->dpt[3][46]);
  OpM124_5 = OpM122_5*C24+OpM223_5*S24;
  OpM224_5 = -(OpM122_5*S24-OpM223_5*C24);
  AlM124_5 = C24*(AlM123_5+OpM223_5*s->dpt[3][46])+S24*(AlM223_5-OpM122_5*s->dpt[3][46]);
  AlM224_5 = C24*(AlM223_5-OpM122_5*s->dpt[3][46])-S24*(AlM123_5+OpM223_5*s->dpt[3][46]);
  OpM124_6 = OpM122_6*C24+OpM223_6*S24;
  OpM224_6 = -(OpM122_6*S24-OpM223_6*C24);
  AlM124_6 = C24*(AlM123_6+OpM223_6*s->dpt[3][46])+S24*(AlM223_6-OpM122_6*s->dpt[3][46]);
  AlM224_6 = C24*(AlM223_6-OpM122_6*s->dpt[3][46])-S24*(AlM123_6+OpM223_6*s->dpt[3][46]);
  OpM124_19 = OpM122_19*C24+OpM223_19*S24;
  OpM224_19 = -(OpM122_19*S24-OpM223_19*C24);
  AlM124_19 = C24*(AlM123_19+OpM223_19*s->dpt[3][46])+S24*(AlM223_19-OpM122_19*s->dpt[3][46]);
  AlM224_19 = C24*(AlM223_19-OpM122_19*s->dpt[3][46])-S24*(AlM123_19+OpM223_19*s->dpt[3][46]);
  OpM124_20 = OpM122_20*C24+OpM223_20*S24;
  OpM224_20 = -(OpM122_20*S24-OpM223_20*C24);
  AlM124_20 = C24*(AlM123_20+OpM223_20*s->dpt[3][46])+S24*(AlM223_20-OpM122_20*s->dpt[3][46]);
  AlM224_20 = C24*(AlM223_20-OpM122_20*s->dpt[3][46])-S24*(AlM123_20+OpM223_20*s->dpt[3][46]);
  OpM124_21 = OpM223_21*S24-S22*C24;
  OpM224_21 = OpM223_21*C24+S22*S24;
  AlM124_21 = C24*(AlM123_21+OpM223_21*s->dpt[3][46])+S24*(AlM223_21+s->dpt[3][46]*S22);
  AlM224_21 = C24*(AlM223_21+s->dpt[3][46]*S22)-S24*(AlM123_21+OpM223_21*s->dpt[3][46]);
  OpM124_22 = C23*S24;
  OpM224_22 = C23*C24;
  AlM124_22 = s->dpt[3][46]*C23*C24;
  AlM224_22 = -s->dpt[3][46]*C23*S24;
  AlM124_23 = -s->dpt[3][46]*S24;
  AlM224_23 = -s->dpt[3][46]*C24;
...
// Forward Kinematics 
  ...
  BeF226 = BS226-OpF326;
  BeF826 = BS626+OpF126;
  AlF126 = C26*(AlF121+BS121*s->dpt[1][40]+BeF221*s->dpt[2][40]+BeF321*s->dpt[3][40])-S26*(AlF321+BS921*s->dpt[3][40]+
 BeF721*s->dpt[1][40]+BeF821*s->dpt[2][40]);
  AlF226 = AlF221+BS521*s->dpt[2][40]+BeF421*s->dpt[1][40]+BeF621*s->dpt[3][40];
  AlF326 = C26*(AlF321+BS921*s->dpt[3][40]+BeF721*s->dpt[1][40]+BeF821*s->dpt[2][40])+S26*(AlF121+BS121*s->dpt[1][40]+
 BeF221*s->dpt[2][40]+BeF321*s->dpt[3][40]);
  ...
  AlM126_4 = C26*(AlM121_4+OpM221_4*s->dpt[3][40]-OpM320_4*s->dpt[2][40])-S26*(AlM320_4+OpM121_4*s->dpt[2][40]-OpM221_4*
 s->dpt[1][40]);
  AlM226_4 = AlM221_4-OpM121_4*s->dpt[3][40]+OpM320_4*s->dpt[1][40];
  AlM326_4 = C26*(AlM320_4+OpM121_4*s->dpt[2][40]-OpM221_4*s->dpt[1][40])+S26*(AlM121_4+OpM221_4*s->dpt[3][40]-OpM320_4*
 s->dpt[2][40]);
  OpM126_5 = OpM121_5*C26-OpM320_5*S26;
  OpM326_5 = OpM121_5*S26+OpM320_5*C26;
  AlM126_5 = C26*(AlM121_5+OpM221_5*s->dpt[3][40]-OpM320_5*s->dpt[2][40])-S26*(AlM320_5+OpM121_5*s->dpt[2][40]-OpM221_5*
 s->dpt[1][40]);
  AlM226_5 = AlM221_5-OpM121_5*s->dpt[3][40]+OpM320_5*s->dpt[1][40];
  AlM326_5 = C26*(AlM320_5+OpM121_5*s->dpt[2][40]-OpM221_5*s->dpt[1][40])+S26*(AlM121_5+OpM221_5*s->dpt[3][40]-OpM320_5*
 s->dpt[2][40]);
  OpM126_6 = OpM121_6*C26-OpM320_6*S26;
  OpM326_6 = OpM121_6*S26+OpM320_6*C26;
  AlM126_6 = C26*(AlM121_6+OpM221_6*s->dpt[3][40]-OpM320_6*s->dpt[2][40])-S26*(AlM320_6+OpM121_6*s->dpt[2][40]-OpM221_6*
 s->dpt[1][40]);
  AlM226_6 = AlM221_6-OpM121_6*s->dpt[3][40]+OpM320_6*s->dpt[1][40];
  AlM326_6 = C26*(AlM320_6+OpM121_6*s->dpt[2][40]-OpM221_6*s->dpt[1][40])+S26*(AlM121_6+OpM221_6*s->dpt[3][40]-OpM320_6*
 s->dpt[2][40]);
  OpM126_19 = OpM121_19*C26-S20*S26;
  OpM326_19 = OpM121_19*S26+S20*C26;
  AlM126_19 = C26*(AlM121_19+OpM221_19*s->dpt[3][40]-s->dpt[2][40]*S20)-S26*(OpM121_19*s->dpt[2][40]-OpM221_19*
 s->dpt[1][40]);
  AlM226_19 = AlM221_19-OpM121_19*s->dpt[3][40]+s->dpt[1][40]*S20;
  AlM326_19 = C26*(OpM121_19*s->dpt[2][40]-OpM221_19*s->dpt[1][40])+S26*(AlM121_19+OpM221_19*s->dpt[3][40]-s->dpt[2][40]
 *S20);
  OpM126_20 = S21*C26;
  OpM326_20 = S21*S26;
  AlM126_20 = C21*C26*(s->dpt[3][35]+s->dpt[3][40])+S26*(s->dpt[1][40]*C21-s->dpt[2][40]*S21);
  AlM226_20 = AlM221_20-s->dpt[3][40]*S21;
  AlM326_20 = C21*S26*(s->dpt[3][35]+s->dpt[3][40])-C26*(s->dpt[1][40]*C21-s->dpt[2][40]*S21);
  AlM126_21 = -s->dpt[2][40]*C26;
  OM127 = qd[27]+OM126;
  ...
  AlM227_21 = s->dpt[1][40]*C27-S26*S27*(s->dpt[2][40]+s->dpt[2][52]);
  AlM327_21 = -(s->dpt[1][40]*S27+S26*C27*(s->dpt[2][40]+s->dpt[2][52]));
 ...
 *C25+FA325*S25));
 ...
 s->l[2][23]-OM223*(s->In[3][23]*OM123-s->In[5][23]*OM323+s->In[9][23]*OM323)+s->dpt[3][46]*(FF124*S24+FF224*C24));
  CF223 = -(s->trq[2][23]-s->In[5][23]*OpF223-CF124*S24-CF224*C24-FA123*s->l[3][23]+FA323*s->l[1][23]+OM123*(
 s->In[3][23]*OM123+s->In[9][23]*OM323)-OM323*(s->In[1][23]*OM123+s->In[3][23]*OM323)-s->dpt[3][46]*(FF124*C24-FF224*S24));
 ...
 s->In[1][23]*OM123+s->In[3][23]*OM323-s->In[5][23]*OM123));
  ...
  CM123_1 = CM124_1*C24-CM224_1*S24-FB223_1*s->l[3][23]+FB323_1*s->l[2][23]-s->dpt[3][46]*(FM124_1*S24+FM224_1*C24);
  CM223_1 = CM124_1*S24+CM224_1*C24+FB123_1*s->l[3][23]-FB323_1*s->l[1][23]+s->dpt[3][46]*(FM124_1*C24-FM224_1*S24);
  ...
  CM123_2 = CM124_2*C24-CM224_2*S24-FB223_2*s->l[3][23]+FB323_2*s->l[2][23]-s->dpt[3][46]*(FM124_2*S24+FM224_2*C24);
  CM223_2 = CM124_2*S24+CM224_2*C24+FB123_2*s->l[3][23]-FB323_2*s->l[1][23]+s->dpt[3][46]*(FM124_2*C24-FM224_2*S24);
  ...
  CM123_3 = CM124_3*C24-CM224_3*S24-FB223_3*s->l[3][23]+FB323_3*s->l[2][23]-s->dpt[3][46]*(FM124_3*S24+FM224_3*C24);
  CM223_3 = CM124_3*S24+CM224_3*C24+FB123_3*s->l[3][23]-FB323_3*s->l[1][23]+s->dpt[3][46]*(FM124_3*C24-FM224_3*S24);
 ...
 s->dpt[3][46]*(FM124_4*S24+FM224_4*C24);
  CM223_4 = s->In[5][23]*OpM223_4+CM124_4*S24+CM224_4*C24+FB123_4*s->l[3][23]-FB323_4*s->l[1][23]+s->dpt[3][46]*(FM124_4
 *C24-FM224_4*S24);
 ...
 s->dpt[3][46]*(FM124_5*S24+FM224_5*C24);
  CM223_5 = s->In[5][23]*OpM223_5+CM124_5*S24+CM224_5*C24+FB123_5*s->l[3][23]-FB323_5*s->l[1][23]+s->dpt[3][46]*(FM124_5
 *C24-FM224_5*S24);
 ...
 s->dpt[3][46]*(FM124_6*S24+FM224_6*C24);
  CM223_6 = s->In[5][23]*OpM223_6+CM124_6*S24+CM224_6*C24+FB123_6*s->l[3][23]-FB323_6*s->l[1][23]+s->dpt[3][46]*(FM124_6
 *C24-FM224_6*S24);
 ...
 s->l[2][23]-s->dpt[3][46]*(FM124_19*S24+FM224_19*C24);
  CM223_19 = s->In[5][23]*OpM223_19+CM124_19*S24+CM224_19*C24+FB123_19*s->l[3][23]-FB323_19*s->l[1][23]+s->dpt[3][46]*(
 ...
 s->l[2][23]-s->dpt[3][46]*(FM124_20*S24+FM224_20*C24);
  CM223_20 = s->In[5][23]*OpM223_20+CM124_20*S24+CM224_20*C24+FB123_20*s->l[3][23]-FB323_20*s->l[1][23]+s->dpt[3][46]*(
 FM124_20*C24-FM224_20*S24);
  ...
  CM123_21 = CM124_21*C24-CM224_21*S24-s->dpt[3][46]*(FM124_21*S24+FM224_21*C24)-s->In[1][23]*S22+s->In[3][23]*OpM323_21
 -FB223_21*s->l[3][23]+FB323_21*s->l[2][23];
  CM223_21 = s->In[5][23]*OpM223_21+CM124_21*S24+CM224_21*C24+FB123_21*s->l[3][23]-FB323_21*s->l[1][23]+s->dpt[3][46]*(
 FM124_21*C24-FM224_21*S24);
  ...
  CM123_22 = CM124_22*C24-CM224_22*S24-s->dpt[3][46]*(FM124_22*S24+FM224_22*C24)-s->In[3][23]*S23-FB223_22*s->l[3][23]+
 FB323_22*s->l[2][23];
  CM123_23 = s->In[1][23]+s->m[23]*s->l[2][23]*s->l[2][23]+s->m[23]*s->l[3][23]*s->l[3][23]-s->dpt[3][46]*(C24*(FB224_23
 ...
 s->In[6][22]*OM222+s->In[9][22]*OM322)+OM322*(s->In[2][22]*OM122+s->In[5][22]*OM222+s->In[6][22]*OM322)-s->dpt[2][44]*(FF223
 *S23+FF323*C23));
 ...
 s->l[1][22]+FF123*s->dpt[2][44]-OM122*(s->In[2][22]*OM122+s->In[5][22]*OM222+s->In[6][22]*OM322)+OM222*(s->In[1][22]*OM122+
 s->In[2][22]*OM222));
  ...
  CM122_1 = CM123_1-FB222_1*s->l[3][22]+FB322_1*s->l[2][22]+s->dpt[2][44]*(FM223_1*S23+FM323_1*C23);
  CM222_1 = CM223_1*C23-CM323_1*S23+FB122_1*s->l[3][22]-FB322_1*s->l[1][22];
  CM322_1 = CM223_1*S23+CM323_1*C23-FB122_1*s->l[2][22]+FB222_1*s->l[1][22]-FM123_1*s->dpt[2][44];
  ...
  CM122_2 = CM123_2-FB222_2*s->l[3][22]+FB322_2*s->l[2][22]+s->dpt[2][44]*(FM223_2*S23+FM323_2*C23);
  CM222_2 = CM223_2*C23-CM323_2*S23+FB122_2*s->l[3][22]-FB322_2*s->l[1][22];
  CM322_2 = CM223_2*S23+CM323_2*C23-FB122_2*s->l[2][22]+FB222_2*s->l[1][22]-FM123_2*s->dpt[2][44];
  ...
  CM122_3 = CM123_3-FB222_3*s->l[3][22]+FB322_3*s->l[2][22]+s->dpt[2][44]*(FM223_3*S23+FM323_3*C23);
  CM222_3 = CM223_3*C23-CM323_3*S23+FB122_3*s->l[3][22]-FB322_3*s->l[1][22];
  CM322_3 = CM223_3*S23+CM323_3*C23-FB122_3*s->l[2][22]+FB222_3*s->l[1][22]-FM123_3*s->dpt[2][44];
  ...
  CM122_4 = CM123_4+s->In[1][22]*OpM122_4+s->In[2][22]*OpM221_4-FB222_4*s->l[3][22]+FB322_4*s->l[2][22]+s->dpt[2][44]*(
 ...
 FM123_4*s->dpt[2][44];
  ...
  CM122_5 = CM123_5+s->In[1][22]*OpM122_5+s->In[2][22]*OpM221_5-FB222_5*s->l[3][22]+FB322_5*s->l[2][22]+s->dpt[2][44]*(
 ...
 FM123_5*s->dpt[2][44];
  ...
  CM122_6 = CM123_6+s->In[1][22]*OpM122_6+s->In[2][22]*OpM221_6-FB222_6*s->l[3][22]+FB322_6*s->l[2][22]+s->dpt[2][44]*(
 ...
 s->dpt[2][44]*(FM223_19*S23+FM323_19*C23);
 ...
 s->l[1][22]-FM123_19*s->dpt[2][44];
  ...
  CM122_20 = CM123_20+s->In[1][22]*OpM122_20+s->In[2][22]*C21-FB222_20*s->l[3][22]+FB322_20*s->l[2][22]+s->dpt[2][44]*(
 ...
 -FM123_20*s->dpt[2][44];
  ...
  FB222_21 = s->m[22]*(s->dpt[1][39]+s->l[1][22]*C22+s->l[3][22]*S22);
  FB322_21 = -s->m[22]*S22*(s->dpt[2][39]+s->l[2][22]);
 ...
 CM124_22*S24+CM224_22*C24+FB123_22*s->l[3][23]-FB323_22*s->l[1][23]+s->dpt[3][46]*(FM124_22*C24-FM224_22*S24))-S23*(CM324_22
 ...
 *OM229)+C29*(AlF328+BS928*s->dpt[3][56])+S29*(AlF128+BeF328*s->dpt[3][56])));
 ...
 s->In[2][29]*OM129+s->In[5][29]*OM229+s->In[6][29]*OM329)+OM229*(s->In[1][29]*OM129+s->In[2][29]*OM229));
  ...
  FB129_19 = -s->m[29]*(AlM327_19*S29-OpM228_19*s->l[3][29]+OpM329_19*s->l[2][29]-C29*(AlM128_19+OpM228_19*s->dpt[3][56]
 ));
  FB229_19 = s->m[29]*(AlM228_19-OpM128_19*s->dpt[3][56]-OpM129_19*s->l[3][29]+OpM329_19*s->l[1][29]);
  FB329_19 = s->m[29]*(AlM327_19*C29+OpM129_19*s->l[2][29]-OpM228_19*s->l[1][29]+S29*(AlM128_19+OpM228_19*s->dpt[3][56])
 );
 ...
 s->l[1][29];
  ...
  FB129_20 = -s->m[29]*(AlM327_20*S29-OpM228_20*s->l[3][29]+OpM329_20*s->l[2][29]-C29*(AlM128_20+OpM228_20*s->dpt[3][56]
 ));
  FB229_20 = s->m[29]*(AlM228_20-OpM128_20*s->dpt[3][56]-OpM129_20*s->l[3][29]+OpM329_20*s->l[1][29]);
  FB329_20 = s->m[29]*(AlM327_20*C29+OpM129_20*s->l[2][29]-OpM228_20*s->l[1][29]+S29*(AlM128_20+OpM228_20*s->dpt[3][56])
 );
 ...
 s->l[1][29];
  ...
  FB129_21 = -s->m[29]*(AlM327_21*S29-OpM228_21*s->l[3][29]+OpM329_21*s->l[2][29]-C29*(AlM128_21+OpM228_21*s->dpt[3][56]
 ));
  FB229_21 = s->m[29]*(AlM228_21-OpM128_21*s->dpt[3][56]-OpM129_21*s->l[3][29]+OpM329_21*s->l[1][29]);
  FB329_21 = s->m[29]*(AlM327_21*C29+OpM129_21*s->l[2][29]-OpM228_21*s->l[1][29]+S29*(AlM128_21+OpM228_21*s->dpt[3][56])
 );
 ...
 s->dpt[3][56]-FA328*s->l[2][28]-OM228*(s->In[3][28]*OM128+s->In[6][28]*OM228+s->In[9][28]*OM328)+OM328*(s->In[5][28]*OM228+
 s->In[6][28]*OM328));
  CF228 = -(s->trq[2][28]-CF229-s->In[5][28]*OpF228-s->In[6][28]*OpF327-FA128*s->l[3][28]+FA328*s->l[1][28]+OM128*(
 s->In[3][28]*OM128+s->In[6][28]*OM228+s->In[9][28]*OM328)-OM328*(s->In[1][28]*OM128+s->In[3][28]*OM328)-s->dpt[3][56]*(FA129
 *C29+FA329*S29));
 ...
 s->dpt[3][56]+FB328_4*s->l[2][28];
  CM228_4 = CM229_4+s->In[5][28]*OpM228_4+s->In[6][28]*OpM327_4+FB128_4*s->l[3][28]-FB328_4*s->l[1][28]+s->dpt[3][56]*(
 ...
 s->dpt[3][56]+FB328_5*s->l[2][28];
  CM228_5 = CM229_5+s->In[5][28]*OpM228_5+s->In[6][28]*OpM327_5+FB128_5*s->l[3][28]-FB328_5*s->l[1][28]+s->dpt[3][56]*(
 ...
 s->dpt[3][56]+FB328_6*s->l[2][28];
  CM228_6 = CM229_6+s->In[5][28]*OpM228_6+s->In[6][28]*OpM327_6+FB128_6*s->l[3][28]-FB328_6*s->l[1][28]+s->dpt[3][56]*(
 ...
 s->dpt[3][56]+FB328_26*s->l[2][28];
  CM228_26 = CM229_26+s->In[5][28]*OpM228_26-s->In[6][28]*S27+FB128_26*s->l[3][28]-FB328_26*s->l[1][28]+s->dpt[3][56]*(
 ...
 *s->l[1][27];
 ...
 FB229_27*s->dpt[3][56]+FB328_27*s->l[2][28])-S28*(CM229_27-s->In[5][28]*S28+FB128_27*s->l[3][28]-FB328_27*s->l[1][28]+
 s->dpt[3][56]*(FB129_27*C29+FB329_27*S29));
 ...
 s->dpt[2][52];
  ...
  FB226_21 = s->m[26]*(s->dpt[1][40]+s->l[1][26]*C26+s->l[3][26]*S26);
  FB326_21 = -s->m[26]*S26*(s->dpt[2][40]+s->l[2][26]);
...
// Backward Dynamics 
 ...
 s->l[2][9]+FF210*s->dpt[3][12]-OM29*(s->In[3][9]*OM19+s->In[6][9]*OM29+s->In[9][9]*OM39)+OM39*(s->In[2][9]*OM19+s->In[5][9]*
 OM29+s->In[6][9]*OM39));
 ...
 *(s->In[3][9]*OM19+s->In[6][9]*OM29+s->In[9][9]*OM39)-OM39*(s->In[1][9]*OM19+s->In[2][9]*OM29+s->In[3][9]*OM39)-
 s->dpt[3][12]*(FF110*C10+FF310*S10));
 ...
 OM39));
  ...
  CM19_1 = CM110_1*C10+CM310_1*S10-FB29_1*s->l[3][9]+FB39_1*s->l[2][9]-FM210_1*s->dpt[3][12];
  CM29_1 = CM210_1+FB19_1*s->l[3][9]-FB39_1*s->l[1][9]+s->dpt[3][12]*(FM110_1*C10+FM310_1*S10);
  ...
  CM19_2 = CM110_2*C10+CM310_2*S10-FB29_2*s->l[3][9]+FB39_2*s->l[2][9]-FM210_2*s->dpt[3][12];
  CM29_2 = CM210_2+FB19_2*s->l[3][9]-FB39_2*s->l[1][9]+s->dpt[3][12]*(FM110_2*C10+FM310_2*S10);
  ...
  CM19_3 = CM110_3*C10+CM310_3*S10-FB29_3*s->l[3][9]+FB39_3*s->l[2][9]-FM210_3*s->dpt[3][12];
  CM29_3 = CM210_3+FB19_3*s->l[3][9]-FB39_3*s->l[1][9]+s->dpt[3][12]*(FM110_3*C10+FM310_3*S10);
 ...
 s->In[9][8]*OM38)+OM38*(s->In[5][8]*OM28+s->In[6][8]*OM38)+s->dpt[3][10]*(FF19*S9+FF29*C9));
  CF28 = -(s->trq[2][8]-s->In[5][8]*OpF28-s->In[6][8]*OpF38-CF19*S9-CF29*C9-FA18*s->l[3][8]+FA38*s->l[1][8]-OM18*(
 s->In[1][8]*OM38-s->In[6][8]*OM28-s->In[9][8]*OM38)-s->dpt[3][10]*(FF19*C9-FF29*S9));
 ...
 s->In[5][8]*OM28-s->In[6][8]*OM38));
  ...
  CM18_1 = CM19_1*C9-CM29_1*S9-FB28_1*s->l[3][8]+FB38_1*s->l[2][8]-s->dpt[3][10]*(FM19_1*S9+FM29_1*C9);
  CM28_1 = CM19_1*S9+CM29_1*C9+FB18_1*s->l[3][8]-FB38_1*s->l[1][8]+s->dpt[3][10]*(FM19_1*C9-FM29_1*S9);
  ...
  CM18_2 = CM19_2*C9-CM29_2*S9-FB28_2*s->l[3][8]+FB38_2*s->l[2][8]-s->dpt[3][10]*(FM19_2*S9+FM29_2*C9);
  CM28_2 = CM19_2*S9+CM29_2*C9+FB18_2*s->l[3][8]-FB38_2*s->l[1][8]+s->dpt[3][10]*(FM19_2*C9-FM29_2*S9);
  ...
  CM18_3 = CM19_3*C9-CM29_3*S9-FB28_3*s->l[3][8]+FB38_3*s->l[2][8]-s->dpt[3][10]*(FM19_3*S9+FM29_3*C9);
  CM28_3 = CM19_3*S9+CM29_3*C9+FB18_3*s->l[3][8]-FB38_3*s->l[1][8]+s->dpt[3][10]*(FM19_3*C9-FM29_3*S9);
  ...
  CM18_4 = s->In[1][8]*OpM17_4+CM19_4*C9-CM29_4*S9-FB28_4*s->l[3][8]+FB38_4*s->l[2][8]-s->dpt[3][10]*(FM19_4*S9+FM29_4*
 C9);
  CM28_4 = s->In[5][8]*OpM28_4+s->In[6][8]*OpM38_4+CM19_4*S9+CM29_4*C9+FB18_4*s->l[3][8]-FB38_4*s->l[1][8]+s->dpt[3][10]
 *(FM19_4*C9-FM29_4*S9);
  ...
  CM18_5 = s->In[1][8]*OpM17_5+CM19_5*C9-CM29_5*S9-FB28_5*s->l[3][8]+FB38_5*s->l[2][8]-s->dpt[3][10]*(FM19_5*S9+FM29_5*
 C9);
  CM28_5 = s->In[5][8]*OpM28_5+s->In[6][8]*OpM38_5+CM19_5*S9+CM29_5*C9+FB18_5*s->l[3][8]-FB38_5*s->l[1][8]+s->dpt[3][10]
 *(FM19_5*C9-FM29_5*S9);
  ...
  CM18_6 = CM19_6*C9-CM29_6*S9-s->dpt[3][10]*(FM19_6*S9+FM29_6*C9)-s->In[1][8]*S7-FB28_6*s->l[3][8]+FB38_6*s->l[2][8];
  CM28_6 = s->In[5][8]*OpM28_6+s->In[6][8]*OpM38_6+CM19_6*S9+CM29_6*C9+FB18_6*s->l[3][8]-FB38_6*s->l[1][8]+s->dpt[3][10]
 *(FM19_6*C9-FM29_6*S9);
  ...
  CM18_7 = CM19_7*C9-CM29_7*S9-FB28_7*s->l[3][8]+FB38_7*s->l[2][8]-s->dpt[3][10]*(FM19_7*S9+FM29_7*C9);
  CM18_8 = s->In[1][8]+s->m[8]*s->l[2][8]*s->l[2][8]+s->m[8]*s->l[3][8]*s->l[3][8]-s->dpt[3][10]*(C9*(FB29_8+FM210_8)+S9
 *(FB19_8+FM110_8*C10+FM310_8*S10))+C9*(s->In[1][9]*C9-s->In[2][9]*S9+CM110_8*C10+CM310_8*S10-FB29_8*s->l[3][9]+FB39_8*
 s->l[2][9]-FM210_8*s->dpt[3][12])-S9*(CM210_8+s->In[2][9]*C9-s->In[5][9]*S9+FB19_8*s->l[3][9]-FB39_8*s->l[1][9]+
 s->dpt[3][12]*(FM110_8*C10+FM310_8*S10));
 ...
 s->dpt[2][8]*(FF28*S8+FF38*C8));
  CF27 = -(s->trq[2][7]-s->In[5][7]*OpF26-CF28*C8+CF38*S8-FA17*s->l[3][7]+FA37*s->l[1][7]-OM17*OM37*(s->In[1][7]-
 s->In[9][7]));
  CF37 = -(s->trq[3][7]-s->In[9][7]*OpF37-CF28*S8-CF38*C8+FA17*s->l[2][7]-FA27*s->l[1][7]+FF18*s->dpt[2][8]+OM17*OM27*(
 s->In[1][7]-s->In[5][7]));
  ...
  CM17_1 = CM18_1-FB27_1*s->l[3][7]+FB37_1*s->l[2][7]+s->dpt[2][8]*(FM28_1*S8+FM38_1*C8);
  CM27_1 = CM28_1*C8-CM38_1*S8+FB17_1*s->l[3][7]-FB37_1*s->l[1][7];
  CM37_1 = CM28_1*S8+CM38_1*C8-FB17_1*s->l[2][7]+FB27_1*s->l[1][7]-FM18_1*s->dpt[2][8];
  FB17_2 = s->m[7]*AlM17_2;
  FB27_2 = s->m[7]*AlM26_2;
  FB37_2 = s->m[7]*AlM37_2;
  FM17_2 = FB17_2+FM18_2;
  FM37_2 = FB37_2+FM28_2*S8+FM38_2*C8;
  CM17_2 = CM18_2-FB27_2*s->l[3][7]+FB37_2*s->l[2][7]+s->dpt[2][8]*(FM28_2*S8+FM38_2*C8);
  CM27_2 = CM28_2*C8-CM38_2*S8+FB17_2*s->l[3][7]-FB37_2*s->l[1][7];
  CM37_2 = CM28_2*S8+CM38_2*C8-FB17_2*s->l[2][7]+FB27_2*s->l[1][7]-FM18_2*s->dpt[2][8];
  FB17_3 = s->m[7]*AlM17_3;
  FB27_3 = s->m[7]*AlM26_3;
  FB37_3 = s->m[7]*AlM37_3;
  FM17_3 = FB17_3+FM18_3;
  FM37_3 = FB37_3+FM28_3*S8+FM38_3*C8;
  CM17_3 = CM18_3-FB27_3*s->l[3][7]+FB37_3*s->l[2][7]+s->dpt[2][8]*(FM28_3*S8+FM38_3*C8);
  CM27_3 = CM28_3*C8-CM38_3*S8+FB17_3*s->l[3][7]-FB37_3*s->l[1][7];
  CM37_3 = CM28_3*S8+CM38_3*C8-FB17_3*s->l[2][7]+FB27_3*s->l[1][7]-FM18_3*s->dpt[2][8];
  ...
  CM17_4 = CM18_4+s->In[1][7]*OpM17_4-FB27_4*s->l[3][7]+FB37_4*s->l[2][7]+s->dpt[2][8]*(FM28_4*S8+FM38_4*C8);
  CM27_4 = s->In[5][7]*OpM26_4+CM28_4*C8-CM38_4*S8+FB17_4*s->l[3][7]-FB37_4*s->l[1][7];
  CM37_4 = s->In[9][7]*OpM37_4+CM28_4*S8+CM38_4*C8-FB17_4*s->l[2][7]+FB27_4*s->l[1][7]-FM18_4*s->dpt[2][8];
  ...
  CM17_5 = CM18_5+s->In[1][7]*OpM17_5-FB27_5*s->l[3][7]+FB37_5*s->l[2][7]+s->dpt[2][8]*(FM28_5*S8+FM38_5*C8);
  CM27_5 = s->In[5][7]*C6+CM28_5*C8-CM38_5*S8+FB17_5*s->l[3][7]-FB37_5*s->l[1][7];
  CM37_5 = s->In[9][7]*OpM37_5+CM28_5*S8+CM38_5*C8-FB17_5*s->l[2][7]+FB27_5*s->l[1][7]-FM18_5*s->dpt[2][8];
 ...
 CM19_7*S9+CM29_7*C9+FB18_7*s->l[3][8]-FB38_7*s->l[1][8]+s->dpt[3][10]*(FM19_7*C9-FM29_7*S9))-S8*(CM39_7+s->In[6][8]*C8-
...
// Backward Dynamics 
 ...
 s->l[2][18];
  ...
  FB118_16 = s->m[18]*(s->dpt[3][26]*C18-OpM318_16*s->l[2][18]+s->l[3][18]*C17);
  FB218_16 = -s->m[18]*(OpM118_16*s->l[3][18]-OpM318_16*s->l[1][18]);
  FB318_16 = s->m[18]*(OpM118_16*s->l[2][18]+s->dpt[3][26]*S18-s->l[1][18]*C17);
 ...
 s->l[2][17]-FB217_15*s->l[1][17]);
  FB117_16 = s->m[17]*(s->dpt[3][26]+s->l[2][17]*S17+s->l[3][17]*C17);
 ...
 s->In[3][16]*OM116-s->In[5][16]*OM316+s->In[9][16]*OM316)+s->dpt[3][26]*(FF217*C17-FF317*S17));
  CF216 = -(s->trq[2][16]-s->In[5][16]*OpF215-CF217*C17+CF317*S17-FA116*s->l[3][16]+FA316*s->l[1][16]-FF117*
 s->dpt[3][26]+OM116*(s->In[3][16]*OM116+s->In[9][16]*OM316)-OM316*(s->In[1][16]*OM116+s->In[3][16]*OM316));
 ...
 s->l[1][16]+OM216*(s->In[1][16]*OM116+s->In[3][16]*OM316-s->In[5][16]*OM116));
  ...
  CM116_1 = CM117_1-FB216_1*s->l[3][16]+FB316_1*s->l[2][16]-s->dpt[3][26]*(FM217_1*C17-FM317_1*S17);
  CM216_1 = CM217_1*C17-CM317_1*S17+FB116_1*s->l[3][16]-FB316_1*s->l[1][16]+FM117_1*s->dpt[3][26];
  ...
  CM116_2 = CM117_2-FB216_2*s->l[3][16]+FB316_2*s->l[2][16]-s->dpt[3][26]*(FM217_2*C17-FM317_2*S17);
  CM216_2 = CM217_2*C17-CM317_2*S17+FB116_2*s->l[3][16]-FB316_2*s->l[1][16]+FM117_2*s->dpt[3][26];
  ...
  CM116_3 = CM117_3-FB216_3*s->l[3][16]+FB316_3*s->l[2][16]-s->dpt[3][26]*(FM217_3*C17-FM317_3*S17);
  CM216_3 = CM217_3*C17-CM317_3*S17+FB116_3*s->l[3][16]-FB316_3*s->l[1][16]+FM117_3*s->dpt[3][26];
  ...
  CM116_4 = CM117_4+s->In[1][16]*OpM116_4+s->In[3][16]*OpM316_4-FB216_4*s->l[3][16]+FB316_4*s->l[2][16]-s->dpt[3][26]*(
 FM217_4*C17-FM317_4*S17);
  CM216_4 = s->In[5][16]*OpM215_4+CM217_4*C17-CM317_4*S17+FB116_4*s->l[3][16]-FB316_4*s->l[1][16]+FM117_4*s->dpt[3][26];
  ...
  CM116_5 = CM117_5+s->In[1][16]*OpM116_5+s->In[3][16]*OpM316_5-FB216_5*s->l[3][16]+FB316_5*s->l[2][16]-s->dpt[3][26]*(
 FM217_5*C17-FM317_5*S17);
  CM216_5 = s->In[5][16]*OpM215_5+CM217_5*C17-CM317_5*S17+FB116_5*s->l[3][16]-FB316_5*s->l[1][16]+FM117_5*s->dpt[3][26];
  ...
  CM116_6 = CM117_6+s->In[1][16]*OpM116_6+s->In[3][16]*OpM316_6-FB216_6*s->l[3][16]+FB316_6*s->l[2][16]-s->dpt[3][26]*(
 FM217_6*C17-FM317_6*S17);
  CM216_6 = s->In[5][16]*OpM215_6+CM217_6*C17-CM317_6*S17+FB116_6*s->l[3][16]-FB316_6*s->l[1][16]+FM117_6*s->dpt[3][26];
 ...
 s->dpt[3][26]*(FM217_13*C17-FM317_13*S17);
 ...
 s->dpt[3][26]*(FM217_14*C17-FM317_14*S17);
  CM216_14 = CM217_14*C17-CM317_14*S17+FM117_14*s->dpt[3][26]-s->In[5][16]*S15+FB116_14*s->l[3][16]-FB316_14*s->l[1][16];
 ...
 s->l[1][16];
  ...
  CM216_15 = CM217_15*C17-CM317_15*S17+FB116_15*s->l[3][16]-FB316_15*s->l[1][16]+s->dpt[3][26]*(FB117_15+FB118_15*C18+
 FB318_15*S18);
  CM216_16 = s->In[5][16]+s->m[16]*s->l[1][16]*s->l[1][16]+s->m[16]*s->l[3][16]*s->l[3][16]+s->dpt[3][26]*(FB117_16+
 ...
 s->l[2][15]+FF216*s->dpt[3][24]-OM215*(s->In[3][15]*OM115-s->In[5][15]*OM315+s->In[9][15]*OM315));
  CF215 = -(s->trq[2][15]-CF216-s->In[5][15]*OpF215-FA115*s->l[3][15]+FA315*s->l[1][15]+OM115*(s->In[3][15]*OM115+
 s->In[9][15]*OM315)-OM315*(s->In[1][15]*OM115+s->In[3][15]*OM315)-s->dpt[3][24]*(FF116*C16+FF316*S16));
 ...
 s->l[1][15]+OM215*(s->In[1][15]*OM115+s->In[3][15]*OM315-s->In[5][15]*OM115));
  ...
  CM115_1 = CM116_1*C16+CM316_1*S16-FB215_1*s->l[3][15]+FB315_1*s->l[2][15]-FM216_1*s->dpt[3][24];
  CM215_1 = CM216_1+FB115_1*s->l[3][15]-FB315_1*s->l[1][15]+s->dpt[3][24]*(FM116_1*C16+FM316_1*S16);
  ...
  CM115_2 = CM116_2*C16+CM316_2*S16-FB215_2*s->l[3][15]+FB315_2*s->l[2][15]-FM216_2*s->dpt[3][24];
  CM215_2 = CM216_2+FB115_2*s->l[3][15]-FB315_2*s->l[1][15]+s->dpt[3][24]*(FM116_2*C16+FM316_2*S16);
  ...
  CM115_3 = CM116_3*C16+CM316_3*S16-FB215_3*s->l[3][15]+FB315_3*s->l[2][15]-FM216_3*s->dpt[3][24];
  CM215_3 = CM216_3+FB115_3*s->l[3][15]-FB315_3*s->l[1][15]+s->dpt[3][24]*(FM116_3*C16+FM316_3*S16);
 ...
 FM216_4*s->dpt[3][24];
  CM215_4 = CM216_4+s->In[5][15]*OpM215_4+FB115_4*s->l[3][15]-FB315_4*s->l[1][15]+s->dpt[3][24]*(FM116_4*C16+FM316_4*S16
 );
 ...
 FM216_5*s->dpt[3][24];
  CM215_5 = CM216_5+s->In[5][15]*OpM215_5+FB115_5*s->l[3][15]-FB315_5*s->l[1][15]+s->dpt[3][24]*(FM116_5*C16+FM316_5*S16
 );
 ...
 FM216_6*s->dpt[3][24];
  CM215_6 = CM216_6+s->In[5][15]*OpM215_6+FB115_6*s->l[3][15]-FB315_6*s->l[1][15]+s->dpt[3][24]*(FM116_6*C16+FM316_6*S16
 );
 ...
 -FM216_13*s->dpt[3][24];
  CM215_13 = CM216_13+s->In[5][15]*OpM215_13+FB115_13*s->l[3][15]-FB315_13*s->l[1][15]+s->dpt[3][24]*(FM116_13*C16+
 FM316_13*S16);
 ...
 s->In[3][16]*C16-FB216_15*s->l[3][16]+FB316_15*s->l[2][16]-s->dpt[3][26]*(C17*(FB217_15+FB218_15)-S17*(FB317_15-FB118_15*S18
 +FB318_15*C18)));
 ...
 FB315_14*s->l[2][15]-FM216_14*s->dpt[3][24])-S15*(CM216_14-s->In[5][15]*S15+FB115_14*s->l[3][15]-FB315_14*s->l[1][15]+
 s->dpt[3][24]*(FM116_14*C16+FM316_14*S16));
...
// Backward Dynamics 
 ...
 s->l[2][21]+FF222*s->dpt[3][39]+FF226*s->dpt[3][40]-OM221*(s->In[6][21]*OM221+s->In[9][21]*OM321)+OM321*(s->In[5][21]*OM221+
 s->In[6][21]*OM321)+s->dpt[2][39]*(FF122*S22-FF322*C22)+s->dpt[2][40]*(FF126*S26-FF326*C26));
  CF221 = -(s->trq[2][21]-CF222-CF226-s->In[5][21]*OpF221-s->In[6][21]*OpF320-FA121*s->l[3][21]+FA321*s->l[1][21]-OM121*
 (s->In[1][21]*OM321-s->In[6][21]*OM221-s->In[9][21]*OM321)-s->dpt[1][39]*(FF122*S22-FF322*C22)-s->dpt[1][40]*(FF126*S26-
 FF326*C26)-s->dpt[3][39]*(FF122*C22+FF322*S22)-s->dpt[3][40]*(FF126*C26+FF326*S26));
  CF321 = -(s->trq[3][21]-s->In[6][21]*OpF221-s->In[9][21]*OpF320+CF122*S22+CF126*S26-CF322*C22-CF326*C26+FA121*
 s->l[2][21]-FA221*s->l[1][21]-FF222*s->dpt[1][39]-FF226*s->dpt[1][40]-OM121*(s->In[6][21]*OM321-OM221*(s->In[1][21]-
 s->In[5][21]))+s->dpt[2][39]*(FF122*C22+FF322*S22)+s->dpt[2][40]*(FF126*C26+FF326*S26));
 ...
 s->dpt[3][39]-FM226_1*s->dpt[3][40]-s->dpt[2][39]*(FM122_1*S22-FM322_1*C22)-s->dpt[2][40]*(FM126_1*S26-FM326_1*C26);
  CM221_1 = CM222_1+CM226_1+FB121_1*s->l[3][21]-FB321_1*s->l[1][21]+s->dpt[1][39]*(FM122_1*S22-FM322_1*C22)+
 s->dpt[1][40]*(FM126_1*S26-FM326_1*C26)+s->dpt[3][39]*(FM122_1*C22+FM322_1*S22)+s->dpt[3][40]*(FM126_1*C26+FM326_1*S26);
  CM321_1 = -(CM122_1*S22+CM126_1*S26-CM322_1*C22-CM326_1*C26+FB121_1*s->l[2][21]-FB221_1*s->l[1][21]-FM222_1*
 s->dpt[1][39]-FM226_1*s->dpt[1][40]+s->dpt[2][39]*(FM122_1*C22+FM322_1*S22)+s->dpt[2][40]*(FM126_1*C26+FM326_1*S26));
 ...
 s->dpt[3][39]-FM226_2*s->dpt[3][40]-s->dpt[2][39]*(FM122_2*S22-FM322_2*C22)-s->dpt[2][40]*(FM126_2*S26-FM326_2*C26);
  CM221_2 = CM222_2+CM226_2+FB121_2*s->l[3][21]-FB321_2*s->l[1][21]+s->dpt[1][39]*(FM122_2*S22-FM322_2*C22)+
 s->dpt[1][40]*(FM126_2*S26-FM326_2*C26)+s->dpt[3][39]*(FM122_2*C22+FM322_2*S22)+s->dpt[3][40]*(FM126_2*C26+FM326_2*S26);
  CM321_2 = -(CM122_2*S22+CM126_2*S26-CM322_2*C22-CM326_2*C26+FB121_2*s->l[2][21]-FB221_2*s->l[1][21]-FM222_2*
 s->dpt[1][39]-FM226_2*s->dpt[1][40]+s->dpt[2][39]*(FM122_2*C22+FM322_2*S22)+s->dpt[2][40]*(FM126_2*C26+FM326_2*S26));
 ...
 s->dpt[3][39]-FM226_3*s->dpt[3][40]-s->dpt[2][39]*(FM122_3*S22-FM322_3*C22)-s->dpt[2][40]*(FM126_3*S26-FM326_3*C26);
  CM221_3 = CM222_3+CM226_3+FB121_3*s->l[3][21]-FB321_3*s->l[1][21]+s->dpt[1][39]*(FM122_3*S22-FM322_3*C22)+
 s->dpt[1][40]*(FM126_3*S26-FM326_3*C26)+s->dpt[3][39]*(FM122_3*C22+FM322_3*S22)+s->dpt[3][40]*(FM126_3*C26+FM326_3*S26);
  CM321_3 = -(CM122_3*S22+CM126_3*S26-CM322_3*C22-CM326_3*C26+FB121_3*s->l[2][21]-FB221_3*s->l[1][21]-FM222_3*
 s->dpt[1][39]-FM226_3*s->dpt[1][40]+s->dpt[2][39]*(FM122_3*C22+FM322_3*S22)+s->dpt[2][40]*(FM126_3*C26+FM326_3*S26));
 ...
 s->l[2][21]-FM222_4*s->dpt[3][39]-FM226_4*s->dpt[3][40]-s->dpt[2][39]*(FM122_4*S22-FM322_4*C22)-s->dpt[2][40]*(FM126_4*S26-
 FM326_4*C26);
  CM221_4 = CM222_4+CM226_4+s->In[5][21]*OpM221_4+s->In[6][21]*OpM320_4+FB121_4*s->l[3][21]-FB321_4*s->l[1][21]+
 s->dpt[1][39]*(FM122_4*S22-FM322_4*C22)+s->dpt[1][40]*(FM126_4*S26-FM326_4*C26)+s->dpt[3][39]*(FM122_4*C22+FM322_4*S22)+
 s->dpt[3][40]*(FM126_4*C26+FM326_4*S26);
  CM321_4 = s->In[6][21]*OpM221_4+s->In[9][21]*OpM320_4-CM122_4*S22-CM126_4*S26+CM322_4*C22+CM326_4*C26-FB121_4*
 s->l[2][21]+FB221_4*s->l[1][21]+FM222_4*s->dpt[1][39]+FM226_4*s->dpt[1][40]-s->dpt[2][39]*(FM122_4*C22+FM322_4*S22)-
 s->dpt[2][40]*(FM126_4*C26+FM326_4*S26);
 ...
 s->l[2][21]-FM222_5*s->dpt[3][39]-FM226_5*s->dpt[3][40]-s->dpt[2][39]*(FM122_5*S22-FM322_5*C22)-s->dpt[2][40]*(FM126_5*S26-
 FM326_5*C26);
  CM221_5 = CM222_5+CM226_5+s->In[5][21]*OpM221_5+s->In[6][21]*OpM320_5+FB121_5*s->l[3][21]-FB321_5*s->l[1][21]+
 s->dpt[1][39]*(FM122_5*S22-FM322_5*C22)+s->dpt[1][40]*(FM126_5*S26-FM326_5*C26)+s->dpt[3][39]*(FM122_5*C22+FM322_5*S22)+
 s->dpt[3][40]*(FM126_5*C26+FM326_5*S26);
  CM321_5 = s->In[6][21]*OpM221_5+s->In[9][21]*OpM320_5-CM122_5*S22-CM126_5*S26+CM322_5*C22+CM326_5*C26-FB121_5*
 s->l[2][21]+FB221_5*s->l[1][21]+FM222_5*s->dpt[1][39]+FM226_5*s->dpt[1][40]-s->dpt[2][39]*(FM122_5*C22+FM322_5*S22)-
 s->dpt[2][40]*(FM126_5*C26+FM326_5*S26);
 ...
 s->l[2][21]-FM222_6*s->dpt[3][39]-FM226_6*s->dpt[3][40]-s->dpt[2][39]*(FM122_6*S22-FM322_6*C22)-s->dpt[2][40]*(FM126_6*S26-
 FM326_6*C26);
  CM221_6 = CM222_6+CM226_6+s->In[5][21]*OpM221_6+s->In[6][21]*OpM320_6+FB121_6*s->l[3][21]-FB321_6*s->l[1][21]+
 s->dpt[1][39]*(FM122_6*S22-FM322_6*C22)+s->dpt[1][40]*(FM126_6*S26-FM326_6*C26)+s->dpt[3][39]*(FM122_6*C22+FM322_6*S22)+
 s->dpt[3][40]*(FM126_6*C26+FM326_6*S26);
  CM321_6 = s->In[6][21]*OpM221_6+s->In[9][21]*OpM320_6-CM122_6*S22-CM126_6*S26+CM322_6*C22+CM326_6*C26-FB121_6*
 s->l[2][21]+FB221_6*s->l[1][21]+FM222_6*s->dpt[1][39]+FM226_6*s->dpt[1][40]-s->dpt[2][39]*(FM122_6*C22+FM322_6*S22)-
 s->dpt[2][40]*(FM126_6*C26+FM326_6*S26);
 ...
 s->l[2][21]-FM222_19*s->dpt[3][39]-FM226_19*s->dpt[3][40]-s->dpt[2][39]*(FM122_19*S22-FM322_19*C22)-s->dpt[2][40]*(FM126_19*
 S26-FM326_19*C26);
  CM221_19 = CM222_19+CM226_19+s->In[5][21]*OpM221_19+s->In[6][21]*S20+FB121_19*s->l[3][21]-FB321_19*s->l[1][21]+
 s->dpt[1][39]*(FM122_19*S22-FM322_19*C22)+s->dpt[1][40]*(FM126_19*S26-FM326_19*C26)+s->dpt[3][39]*(FM122_19*C22+FM322_19*S22
 )+s->dpt[3][40]*(FM126_19*C26+FM326_19*S26);
  CM321_19 = s->In[6][21]*OpM221_19+s->In[9][21]*S20-CM122_19*S22-CM126_19*S26+CM322_19*C22+CM326_19*C26-FB121_19*
 s->l[2][21]+FB221_19*s->l[1][21]+FM222_19*s->dpt[1][39]+FM226_19*s->dpt[1][40]-s->dpt[2][39]*(FM122_19*C22+FM322_19*S22)-
 s->dpt[2][40]*(FM126_19*C26+FM326_19*S26);
  FB121_20 = s->m[21]*C21*(s->dpt[3][35]+s->l[3][21]);
 ...
 s->l[1][21]+FM222_20*s->dpt[1][39]+FM226_20*s->dpt[1][40]-s->dpt[2][39]*(FM122_20*C22+FM322_20*S22)-s->dpt[2][40]*(FM126_20*
 C26+FM326_20*S26);
  CM321_21 = s->In[9][21]+s->m[21]*s->l[1][21]*s->l[1][21]+s->m[21]*s->l[2][21]*s->l[2][21]+s->dpt[1][39]*(FB222_21+
 FM223_21*C23-FM323_21*S23)+s->dpt[1][40]*(FB226_21+FM227_21*C27-FM327_21*S27)-s->dpt[2][39]*(C22*(FB122_21+FM123_21)+S22*(
 FB322_21+FM223_21*S23+FM323_21*C23))-s->dpt[2][40]*(C26*(FB126_21+FM127_21)+S26*(FB326_21+FM227_21*S27+FM327_21*C27))+C22*(
 s->In[9][22]*C22+CM223_21*S23+CM323_21*C23-FB122_21*s->l[2][22]+FB222_21*s->l[1][22]-FM123_21*s->dpt[2][44])-S22*(CM123_21-
 s->In[1][22]*S22-FB222_21*s->l[3][22]+FB322_21*s->l[2][22]+s->dpt[2][44]*(FM223_21*S23+FM323_21*C23))+C26*(s->In[9][26]*C26+
 ...
 s->l[2][20]-OM220*(s->In[3][20]*OM120-s->In[5][20]*OM320+s->In[9][20]*OM320)+s->dpt[3][35]*(FF121*S21+FF221*C21));
  CF220 = -(s->trq[2][20]-s->In[5][20]*OpF219-CF121*S21-CF221*C21-FA120*s->l[3][20]+FA320*s->l[1][20]+OM120*(
 s->In[3][20]*OM120+s->In[9][20]*OM320)-OM320*(s->In[1][20]*OM120+s->In[3][20]*OM320)-s->dpt[3][35]*(FF121*C21-FF221*S21));
 ...
 s->In[1][20]*OM120+s->In[3][20]*OM320-s->In[5][20]*OM120));
  ...
  CM120_1 = CM121_1*C21-CM221_1*S21-FB220_1*s->l[3][20]+FB320_1*s->l[2][20]-s->dpt[3][35]*(FM121_1*S21+FM221_1*C21);
  CM220_1 = CM121_1*S21+CM221_1*C21+FB120_1*s->l[3][20]-FB320_1*s->l[1][20]+s->dpt[3][35]*(FM121_1*C21-FM221_1*S21);
  ...
  CM120_2 = CM121_2*C21-CM221_2*S21-FB220_2*s->l[3][20]+FB320_2*s->l[2][20]-s->dpt[3][35]*(FM121_2*S21+FM221_2*C21);
  CM220_2 = CM121_2*S21+CM221_2*C21+FB120_2*s->l[3][20]-FB320_2*s->l[1][20]+s->dpt[3][35]*(FM121_2*C21-FM221_2*S21);
  ...
  CM120_3 = CM121_3*C21-CM221_3*S21-FB220_3*s->l[3][20]+FB320_3*s->l[2][20]-s->dpt[3][35]*(FM121_3*S21+FM221_3*C21);
  CM220_3 = CM121_3*S21+CM221_3*C21+FB120_3*s->l[3][20]-FB320_3*s->l[1][20]+s->dpt[3][35]*(FM121_3*C21-FM221_3*S21);
 ...
 s->dpt[3][35]*(FM121_4*S21+FM221_4*C21);
  CM220_4 = s->In[5][20]*OpM219_4+CM121_4*S21+CM221_4*C21+FB120_4*s->l[3][20]-FB320_4*s->l[1][20]+s->dpt[3][35]*(FM121_4
 *C21-FM221_4*S21);
 ...
 s->dpt[3][35]*(FM121_5*S21+FM221_5*C21);
  CM220_5 = s->In[5][20]*OpM219_5+CM121_5*S21+CM221_5*C21+FB120_5*s->l[3][20]-FB320_5*s->l[1][20]+s->dpt[3][35]*(FM121_5
 *C21-FM221_5*S21);
 ...
 s->dpt[3][35]*(FM121_6*S21+FM221_6*C21);
  CM220_6 = s->In[5][20]*S19+CM121_6*S21+CM221_6*C21+FB120_6*s->l[3][20]-FB320_6*s->l[1][20]+s->dpt[3][35]*(FM121_6*C21-
 FM221_6*S21);
  ...
  CM220_19 = CM121_19*S21+CM221_19*C21+FB120_19*s->l[3][20]-FB320_19*s->l[1][20]+s->dpt[3][35]*(FM121_19*C21-FM221_19*
 S21);
  CM220_20 = s->In[5][20]+s->m[20]*s->l[1][20]*s->l[1][20]+s->m[20]*s->l[3][20]*s->l[3][20]+s->dpt[3][35]*(C21*(FB121_20
 +FM122_20*C22+FM126_20*C26+FM322_20*S22+FM326_20*S26)-S21*(FB221_20+FM222_20+FM226_20))+C21*(CM222_20+CM226_20+s->In[5][21]*
 C21+FB121_20*s->l[3][21]-FB321_20*s->l[1][21]+s->dpt[1][39]*(FM122_20*S22-FM322_20*C22)+s->dpt[1][40]*(FM126_20*S26-FM326_20
 *C26)+s->dpt[3][39]*(FM122_20*C22+FM322_20*S22)+s->dpt[3][40]*(FM126_20*C26+FM326_20*S26))+S21*(s->In[1][21]*S21+CM122_20*
 C22+CM126_20*C26+CM322_20*S22+CM326_20*S26-FB221_20*s->l[3][21]+FB321_20*s->l[2][21]-FM222_20*s->dpt[3][39]-FM226_20*
 s->dpt[3][40]-s->dpt[2][39]*(FM122_20*S22-FM322_20*C22)-s->dpt[2][40]*(FM126_20*S26-FM326_20*C26));
 ...
 *OM219+s->In[9][19]*OM319)+OM319*(s->In[5][19]*OM219+s->In[6][19]*OM319));
 ...
 s->l[1][19]-OM119*(s->In[6][19]*OM319-OM219*(s->In[1][19]-s->In[5][19])));
  ...
  FB219_6 = s->m[19]*C19*(s->dpt[1][5]+s->l[1][19]);
 ...
 s->In[3][20]*S20+CM121_19*C21-CM221_19*S21-FB220_19*s->l[3][20]+FB320_19*s->l[2][20]-s->dpt[3][35]*(FM121_19*S21+FM221_19*
...
// Backward Dynamics 
 ...
 s->dpt[2][3]*(FF17*S7-FF37*C7)+s->dpt[2][4]*(FF113*S13-FF313*C13)+s->dpt[3][5]*(FF219*C19-FF319*S19));
  CF26 = -(s->trq[2][6]-CF213-CF27-s->In[5][6]*OpF26-s->In[6][6]*OpF35-CF219*C19+CF319*S19-FA16*s->l[3][6]+FA36*
 s->l[1][6]-FF119*s->dpt[3][5]+OM16*(s->In[3][6]*OM16+s->In[6][6]*OM26+s->In[9][6]*OM36)-OM36*(s->In[1][6]*OM16+s->In[3][6]*
 OM36)+s->dpt[1][5]*(FF219*S19+FF319*C19));
 ...
 s->In[3][6]*OM36)-s->dpt[1][5]*(FF219*C19-FF319*S19)+s->dpt[2][3]*(FF17*C7+FF37*S7)+s->dpt[2][4]*(FF113*C13+FF313*S13));
  ...
  CM16_1 = CM119_1+CM113_1*C13+CM17_1*C7+CM313_1*S13+CM37_1*S7-FB26_1*s->l[3][6]+FB36_1*s->l[2][6]-s->dpt[2][3]*(FM17_1*
 S7-FM37_1*C7)-s->dpt[2][4]*(FM113_1*S13-FM313_1*C13)-s->dpt[3][5]*(FM219_1*C19-FM319_1*S19);
  CM26_1 = CM213_1+CM27_1+CM219_1*C19-CM319_1*S19+FB16_1*s->l[3][6]-FB36_1*s->l[1][6]+FM119_1*s->dpt[3][5]-s->dpt[1][5]*
 (FM219_1*S19+FM319_1*C19);
  CM36_1 = CM219_1*S19+CM319_1*C19+s->dpt[1][5]*(FM219_1*C19-FM319_1*S19)-CM113_1*S13-CM17_1*S7+CM313_1*C13+CM37_1*C7-
 FB16_1*s->l[2][6]+FB26_1*s->l[1][6]-s->dpt[2][3]*(FM17_1*C7+FM37_1*S7)-s->dpt[2][4]*(FM113_1*C13+FM313_1*S13);
  ...
  CM16_2 = CM119_2+CM113_2*C13+CM17_2*C7+CM313_2*S13+CM37_2*S7-FB26_2*s->l[3][6]+FB36_2*s->l[2][6]-s->dpt[2][3]*(FM17_2*
 S7-FM37_2*C7)-s->dpt[2][4]*(FM113_2*S13-FM313_2*C13)-s->dpt[3][5]*(FM219_2*C19-FM319_2*S19);
  CM26_2 = CM213_2+CM27_2+CM219_2*C19-CM319_2*S19+FB16_2*s->l[3][6]-FB36_2*s->l[1][6]+FM119_2*s->dpt[3][5]-s->dpt[1][5]*
 (FM219_2*S19+FM319_2*C19);
  CM36_2 = CM219_2*S19+CM319_2*C19+s->dpt[1][5]*(FM219_2*C19-FM319_2*S19)-CM113_2*S13-CM17_2*S7+CM313_2*C13+CM37_2*C7-
 FB16_2*s->l[2][6]+FB26_2*s->l[1][6]-s->dpt[2][3]*(FM17_2*C7+FM37_2*S7)-s->dpt[2][4]*(FM113_2*C13+FM313_2*S13);
  ...
  CM16_3 = CM119_3+CM113_3*C13+CM17_3*C7+CM313_3*S13+CM37_3*S7-FB26_3*s->l[3][6]+FB36_3*s->l[2][6]-s->dpt[2][3]*(FM17_3*
 S7-FM37_3*C7)-s->dpt[2][4]*(FM113_3*S13-FM313_3*C13)-s->dpt[3][5]*(FM219_3*C19-FM319_3*S19);
  CM26_3 = CM213_3+CM27_3+CM219_3*C19-CM319_3*S19+FB16_3*s->l[3][6]-FB36_3*s->l[1][6]+FM119_3*s->dpt[3][5]-s->dpt[1][5]*
 (FM219_3*S19+FM319_3*C19);
  CM36_3 = CM219_3*S19+CM319_3*C19+s->dpt[1][5]*(FM219_3*C19-FM319_3*S19)-CM113_3*S13-CM17_3*S7+CM313_3*C13+CM37_3*C7-
 FB16_3*s->l[2][6]+FB26_3*s->l[1][6]-s->dpt[2][3]*(FM17_3*C7+FM37_3*S7)-s->dpt[2][4]*(FM113_3*C13+FM313_3*S13);
 ...
 FB36_4*s->l[2][6]-s->dpt[2][3]*(FM17_4*S7-FM37_4*C7)-s->dpt[2][4]*(FM113_4*S13-FM313_4*C13)-s->dpt[3][5]*(FM219_4*C19-
 FM319_4*S19);
  CM26_4 = CM213_4+CM27_4+s->In[5][6]*OpM26_4+s->In[6][6]*S5+CM219_4*C19-CM319_4*S19+FB16_4*s->l[3][6]-FB36_4*s->l[1][6]
 -s->dpt[1][5]*(FM219_4*S19+FM319_4*C19)+s->dpt[3][5]*(FB119_4+FM120_4*C20+FM320_4*S20);
  CM36_4 = s->In[3][6]*OpM16_4+s->In[6][6]*OpM26_4+s->In[9][6]*S5-CM113_4*S13-CM17_4*S7+CM219_4*S19+CM313_4*C13+CM319_4*
 C19+CM37_4*C7-FB16_4*s->l[2][6]+FB26_4*s->l[1][6]+s->dpt[1][5]*(FM219_4*C19-FM319_4*S19)-s->dpt[2][3]*(FM17_4*C7+FM37_4*S7)-
 s->dpt[2][4]*(FM113_4*C13+FM313_4*S13);
 ...
 s->l[2][6]+FB26_5*s->l[1][6]+s->dpt[1][5]*(FM219_5*C19-FM319_5*S19)-s->dpt[2][3]*(FM17_5*C7+FM37_5*S7)-s->dpt[2][4]*(FM113_5
 *C13+FM313_5*S13);
  CM36_6 = s->In[9][6]+s->m[6]*s->l[1][6]*s->l[1][6]+s->m[6]*s->l[2][6]*s->l[2][6]+s->dpt[1][5]*(C19*(FB219_6+FB220_6+
 FM121_6*S21+FM221_6*C21)-S19*(FB319_6+C20*(FB320_6+FB321_6-FM122_6*S22-FM126_6*S26+FM322_6*C22+FM326_6*C26)-S20*(FB120_6+
 FM121_6*C21-FM221_6*S21)))-s->dpt[2][3]*(C7*(FB17_6+FM18_6)+S7*(FB37_6+FM28_6*S8+FM38_6*C8))-s->dpt[2][4]*(C13*(FB113_6+
 ...
 CM28_6*S8+CM38_6*C8-FB17_6*s->l[2][7]+FB27_6*s->l[1][7]-FM18_6*s->dpt[2][8])-S7*(CM18_6-s->In[1][7]*S7-FB27_6*s->l[3][7]+
 FB37_6*s->l[2][7]+s->dpt[2][8]*(FM28_6*S8+FM38_6*C8));
  ...
  CM55_26 = C6*(CM213_5+CM27_5+s->In[5][6]*C6+CM219_5*C19-CM319_5*S19+FB16_5*s->l[3][6]-FB36_5*s->l[1][6]-s->dpt[1][5]*(
 FM219_5*S19+FM319_5*C19)+s->dpt[3][5]*(FB119_5+FM120_5*C20+FM320_5*S20))+S6*(CM119_5+s->In[1][6]*S6+CM113_5*C13+CM17_5*C7+
 CM313_5*S13+CM37_5*S7-FB26_5*s->l[3][6]+FB36_5*s->l[2][6]-s->dpt[2][3]*(FM17_5*S7-FM37_5*C7)-s->dpt[2][4]*(FM113_5*S13-
 FM313_5*C13)-s->dpt[3][5]*(FM219_5*C19-FM319_5*S19));
...
// Backward Dynamics 
  ...
  CF231 = -(s->trq[2][31]-OM131*OM331*(s->In[1][31]-s->In[9][31])+s->l[3][31]*(s->frc[1][31]-s->m[31]*(OM131*OM331*
 s->l[3][31]+s->g[3]*C30*S31)));
  CM231_31 = s->In[5][31]+s->m[31]*s->l[3][31]*s->l[3][31];
  CF30_131 = -(C31*(s->trq[1][31]+qd[31]*OM331*(s->In[5][31]-s->In[9][31])-s->In[1][31]*OpF131-s->l[3][31]*(
 s->frc[2][31]+s->m[31]*(s->g[3]*S30+s->l[3][31]*(OpF131-qd[31]*OM331))))+S31*(s->trq[3][31]-qd[30]*qd[31]*s->In[9][31]*C31+
 qd[31]*OM131*(s->In[1][31]-s->In[5][31])));
  CM3030_131 = s->In[9][31]*S31*S31+C31*C31*(s->In[1][31]+s->m[31]*s->l[3][31]*s->l[3][31]);

// = = Block_0_2_0_3_0_8 = = 
 
// Backward Dynamics 

  CF233 = -(s->trq[2][33]-OM133*OM333*(s->In[1][33]-s->In[9][33])+s->l[3][33]*(s->frc[1][33]-s->m[33]*(OM133*OM333*
 s->l[3][33]+s->g[3]*C32*S33)));
  CM233_33 = s->In[5][33]+s->m[33]*s->l[3][33]*s->l[3][33];
  CF32_133 = -(C33*(s->trq[1][33]+qd[33]*OM333*(s->In[5][33]-s->In[9][33])-s->In[1][33]*OpF133-s->l[3][33]*(
 s->frc[2][33]+s->m[33]*(s->g[3]*S32+s->l[3][33]*(OpF133-qd[33]*OM333))))+S33*(s->trq[3][33]-qd[32]*qd[33]*s->In[9][33]*C33+
 qd[33]*OM133*(s->In[1][33]-s->In[5][33])));
  CM3232_133 = s->In[9][33]*S33*S33+C33*C33*(s->In[1][33]+s->m[33]*s->l[3][33]*s->l[3][33]);
