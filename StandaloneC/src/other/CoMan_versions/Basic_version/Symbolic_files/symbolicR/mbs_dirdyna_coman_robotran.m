...
% Forward Kinematics 
  ...
  BeF222 = BS222-OpF322;
  BeF822 = BS622+OpF122;
  AlF122 = C22*(AlF121+BS121*s.dpt(1,37)+BeF221*s.dpt(2,37)+BeF321*s.dpt(3,37))-S22*(AlF321+BS921*s.dpt(3,37)+BeF721*s.dpt(1,37)+BeF821*...
 s.dpt(2,37));
  AlF222 = AlF221+BS521*s.dpt(2,37)+BeF421*s.dpt(1,37)+BeF621*s.dpt(3,37);
  AlF322 = C22*(AlF321+BS921*s.dpt(3,37)+BeF721*s.dpt(1,37)+BeF821*s.dpt(2,37))+S22*(AlF121+BS121*s.dpt(1,37)+BeF221*s.dpt(2,37)+BeF321*...
 s.dpt(3,37));
  ...
  AlM122_4 = C22*(AlM121_4+OpM221_4*s.dpt(3,37)-OpM320_4*s.dpt(2,37))-S22*(AlM320_4+OpM121_4*s.dpt(2,37)-OpM221_4*s.dpt(1,37));
  AlM222_4 = AlM221_4-OpM121_4*s.dpt(3,37)+OpM320_4*s.dpt(1,37);
  AlM322_4 = C22*(AlM320_4+OpM121_4*s.dpt(2,37)-OpM221_4*s.dpt(1,37))+S22*(AlM121_4+OpM221_4*s.dpt(3,37)-OpM320_4*s.dpt(2,37));
  OpM122_5 = OpM121_5*C22-OpM320_5*S22;
  OpM322_5 = OpM121_5*S22+OpM320_5*C22;
  AlM122_5 = C22*(AlM121_5+OpM221_5*s.dpt(3,37)-OpM320_5*s.dpt(2,37))-S22*(AlM320_5+OpM121_5*s.dpt(2,37)-OpM221_5*s.dpt(1,37));
  AlM222_5 = AlM221_5-OpM121_5*s.dpt(3,37)+OpM320_5*s.dpt(1,37);
  AlM322_5 = C22*(AlM320_5+OpM121_5*s.dpt(2,37)-OpM221_5*s.dpt(1,37))+S22*(AlM121_5+OpM221_5*s.dpt(3,37)-OpM320_5*s.dpt(2,37));
  OpM122_6 = OpM121_6*C22-OpM320_6*S22;
  OpM322_6 = OpM121_6*S22+OpM320_6*C22;
  AlM122_6 = C22*(AlM121_6+OpM221_6*s.dpt(3,37)-OpM320_6*s.dpt(2,37))-S22*(AlM320_6+OpM121_6*s.dpt(2,37)-OpM221_6*s.dpt(1,37));
  AlM222_6 = AlM221_6-OpM121_6*s.dpt(3,37)+OpM320_6*s.dpt(1,37);
  AlM322_6 = C22*(AlM320_6+OpM121_6*s.dpt(2,37)-OpM221_6*s.dpt(1,37))+S22*(AlM121_6+OpM221_6*s.dpt(3,37)-OpM320_6*s.dpt(2,37));
  OpM122_19 = OpM121_19*C22-S20*S22;
  OpM322_19 = OpM121_19*S22+S20*C22;
  AlM122_19 = C22*(AlM121_19+OpM221_19*s.dpt(3,37)-s.dpt(2,37)*S20)-S22*(OpM121_19*s.dpt(2,37)-OpM221_19*s.dpt(1,37));
  AlM222_19 = AlM221_19-OpM121_19*s.dpt(3,37)+s.dpt(1,37)*S20;
  AlM322_19 = C22*(OpM121_19*s.dpt(2,37)-OpM221_19*s.dpt(1,37))+S22*(AlM121_19+OpM221_19*s.dpt(3,37)-s.dpt(2,37)*S20);
  OpM122_20 = S21*C22;
  OpM322_20 = S21*S22;
...
% Forward Kinematics 
  ...
  BeF226 = BS226-OpF326;
  BeF826 = BS626+OpF126;
  AlF126 = C26*(AlF121+BS121*s.dpt(1,38)+BeF221*s.dpt(2,38)+BeF321*s.dpt(3,38))-S26*(AlF321+BS921*s.dpt(3,38)+BeF721*s.dpt(1,38)+BeF821*...
 s.dpt(2,38));
  AlF226 = AlF221+BS521*s.dpt(2,38)+BeF421*s.dpt(1,38)+BeF621*s.dpt(3,38);
  AlF326 = C26*(AlF321+BS921*s.dpt(3,38)+BeF721*s.dpt(1,38)+BeF821*s.dpt(2,38))+S26*(AlF121+BS121*s.dpt(1,38)+BeF221*s.dpt(2,38)+BeF321*...
 s.dpt(3,38));
  ...
  AlM126_4 = C26*(AlM121_4+OpM221_4*s.dpt(3,38)-OpM320_4*s.dpt(2,38))-S26*(AlM320_4+OpM121_4*s.dpt(2,38)-OpM221_4*s.dpt(1,38));
  AlM226_4 = AlM221_4-OpM121_4*s.dpt(3,38)+OpM320_4*s.dpt(1,38);
  AlM326_4 = C26*(AlM320_4+OpM121_4*s.dpt(2,38)-OpM221_4*s.dpt(1,38))+S26*(AlM121_4+OpM221_4*s.dpt(3,38)-OpM320_4*s.dpt(2,38));
  OpM126_5 = OpM121_5*C26-OpM320_5*S26;
  OpM326_5 = OpM121_5*S26+OpM320_5*C26;
  AlM126_5 = C26*(AlM121_5+OpM221_5*s.dpt(3,38)-OpM320_5*s.dpt(2,38))-S26*(AlM320_5+OpM121_5*s.dpt(2,38)-OpM221_5*s.dpt(1,38));
  AlM226_5 = AlM221_5-OpM121_5*s.dpt(3,38)+OpM320_5*s.dpt(1,38);
  AlM326_5 = C26*(AlM320_5+OpM121_5*s.dpt(2,38)-OpM221_5*s.dpt(1,38))+S26*(AlM121_5+OpM221_5*s.dpt(3,38)-OpM320_5*s.dpt(2,38));
  OpM126_6 = OpM121_6*C26-OpM320_6*S26;
  OpM326_6 = OpM121_6*S26+OpM320_6*C26;
  AlM126_6 = C26*(AlM121_6+OpM221_6*s.dpt(3,38)-OpM320_6*s.dpt(2,38))-S26*(AlM320_6+OpM121_6*s.dpt(2,38)-OpM221_6*s.dpt(1,38));
  AlM226_6 = AlM221_6-OpM121_6*s.dpt(3,38)+OpM320_6*s.dpt(1,38);
  AlM326_6 = C26*(AlM320_6+OpM121_6*s.dpt(2,38)-OpM221_6*s.dpt(1,38))+S26*(AlM121_6+OpM221_6*s.dpt(3,38)-OpM320_6*s.dpt(2,38));
  OpM126_19 = OpM121_19*C26-S20*S26;
  OpM326_19 = OpM121_19*S26+S20*C26;
  AlM126_19 = C26*(AlM121_19+OpM221_19*s.dpt(3,38)-s.dpt(2,38)*S20)-S26*(OpM121_19*s.dpt(2,38)-OpM221_19*s.dpt(1,38));
  AlM226_19 = AlM221_19-OpM121_19*s.dpt(3,38)+s.dpt(1,38)*S20;
  AlM326_19 = C26*(OpM121_19*s.dpt(2,38)-OpM221_19*s.dpt(1,38))+S26*(AlM121_19+OpM221_19*s.dpt(3,38)-s.dpt(2,38)*S20);
  OpM126_20 = S21*C26;
  OpM326_20 = S21*S26;
...
% Backward Dynamics 
 ...
 s.dpt(3,44))+S25*(AlF324+BS924*s.dpt(3,44))));
  FA225 = -(s.frc(2,25)-s.m(25)*(AlF224+BeF624*s.dpt(3,44)+s.l(1,25)*(BS225+OpF325)-s.l(2,25)*(OM125*OM125+OM325*OM325)+s.l(3,25)*(BS625-OpF125))...
 );
  FA325 = -(s.frc(3,25)-s.m(25)*(s.l(1,25)*(BS325-OpF224)+s.l(2,25)*(BS625+OpF125)-s.l(3,25)*(OM125*OM125+OM225*OM225)+C25*(AlF324+BS924*...
 s.dpt(3,44))+S25*(AlF124+BeF324*s.dpt(3,44))));
  ...
  FF224 = FA224+FA225;
  CF124 = -(s.trq(1,24)-s.In(1,24)*OpF124-s.In(2,24)*OpF224-s.In(3,24)*OpF323-CF125*C25-CF325*S25+FA224*s.l(3,24)+FA225*s.dpt(3,44)-FA324*...
 ...
 *(s.In(1,24)*OM124+s.In(2,24)*OM224+s.In(3,24)*OM324)-s.dpt(3,44)*(FA125*C25+FA325*S25));
 ...
 s.In(5,24)*OM224)+OM224*(s.In(1,24)*OM124+s.In(2,24)*OM224+s.In(3,24)*OM324));
  ...
  CM124_4 = s.In(1,24)*OpM124_4+s.In(2,24)*OpM224_4+s.In(3,24)*OpM323_4+CM125_4*C25+CM325_4*S25-FB224_4*s.l(3,24)-FB225_4*s.dpt(3,44)+FB324_4*...
 s.l(2,24);
  CM224_4 = CM225_4+s.In(2,24)*OpM124_4+s.In(5,24)*OpM224_4+FB124_4*s.l(3,24)-FB324_4*s.l(1,24)+s.dpt(3,44)*(FB125_4*C25+FB325_4*S25);
  ...
  CM124_5 = s.In(1,24)*OpM124_5+s.In(2,24)*OpM224_5+s.In(3,24)*OpM323_5+CM125_5*C25+CM325_5*S25-FB224_5*s.l(3,24)-FB225_5*s.dpt(3,44)+FB324_5*...
 s.l(2,24);
  CM224_5 = CM225_5+s.In(2,24)*OpM124_5+s.In(5,24)*OpM224_5+FB124_5*s.l(3,24)-FB324_5*s.l(1,24)+s.dpt(3,44)*(FB125_5*C25+FB325_5*S25);
  ...
  CM124_6 = s.In(1,24)*OpM124_6+s.In(2,24)*OpM224_6+s.In(3,24)*OpM323_6+CM125_6*C25+CM325_6*S25-FB224_6*s.l(3,24)-FB225_6*s.dpt(3,44)+FB324_6*...
 s.l(2,24);
  CM224_6 = CM225_6+s.In(2,24)*OpM124_6+s.In(5,24)*OpM224_6+FB124_6*s.l(3,24)-FB324_6*s.l(1,24)+s.dpt(3,44)*(FB125_6*C25+FB325_6*S25);
  ...
  CM124_19 = s.In(1,24)*OpM124_19+s.In(2,24)*OpM224_19+s.In(3,24)*OpM323_19+CM125_19*C25+CM325_19*S25-FB224_19*s.l(3,24)-FB225_19*s.dpt(3,44)+...
 FB324_19*s.l(2,24);
  CM224_19 = CM225_19+s.In(2,24)*OpM124_19+s.In(5,24)*OpM224_19+FB124_19*s.l(3,24)-FB324_19*s.l(1,24)+s.dpt(3,44)*(FB125_19*C25+FB325_19*S25);
  ...
  CM124_20 = s.In(1,24)*OpM124_20+s.In(2,24)*OpM224_20+s.In(3,24)*OpM323_20+CM125_20*C25+CM325_20*S25-FB224_20*s.l(3,24)-FB225_20*s.dpt(3,44)+...
 FB324_20*s.l(2,24);
  CM224_20 = CM225_20+s.In(2,24)*OpM124_20+s.In(5,24)*OpM224_20+FB124_20*s.l(3,24)-FB324_20*s.l(1,24)+s.dpt(3,44)*(FB125_20*C25+FB325_20*S25);
  ...
  CM124_21 = s.In(1,24)*OpM124_21+s.In(2,24)*OpM224_21+s.In(3,24)*OpM323_21+CM125_21*C25+CM325_21*S25-FB224_21*s.l(3,24)-FB225_21*s.dpt(3,44)+...
 FB324_21*s.l(2,24);
  CM224_21 = CM225_21+s.In(2,24)*OpM124_21+s.In(5,24)*OpM224_21+FB124_21*s.l(3,24)-FB324_21*s.l(1,24)+s.dpt(3,44)*(FB125_21*C25+FB325_21*S25);
  ...
  CM124_22 = s.In(1,24)*OpM124_22+s.In(2,24)*OpM224_22-s.In(3,24)*S23+CM125_22*C25+CM325_22*S25-FB224_22*s.l(3,24)-FB225_22*s.dpt(3,44)+FB324_22*...
 s.l(2,24);
  CM224_22 = CM225_22+s.In(2,24)*OpM124_22+s.In(5,24)*OpM224_22+FB124_22*s.l(3,24)-FB324_22*s.l(1,24)+s.dpt(3,44)*(FB125_22*C25+FB325_22*S25);
 ...
 s.In(5,23)*OM323+s.In(9,23)*OM323)+s.dpt(3,42)*(FF124*S24+FF224*C24));
 ...
 s.In(1,23)*OM123+s.In(3,23)*OM323)-s.dpt(3,42)*(FF124*C24-FF224*S24));
 ...
 s.In(5,23)*OM123));
  ...
  CM123_4 = s.In(1,23)*OpM122_4+s.In(3,23)*OpM323_4+CM124_4*C24-CM224_4*S24-FB223_4*s.l(3,23)+FB323_4*s.l(2,23)-s.dpt(3,42)*(FM124_4*S24+FM224_4*...
 C24);
  CM223_4 = s.In(5,23)*OpM223_4+CM124_4*S24+CM224_4*C24+FB123_4*s.l(3,23)-FB323_4*s.l(1,23)+s.dpt(3,42)*(FM124_4*C24-FM224_4*S24);
  ...
  CM123_5 = s.In(1,23)*OpM122_5+s.In(3,23)*OpM323_5+CM124_5*C24-CM224_5*S24-FB223_5*s.l(3,23)+FB323_5*s.l(2,23)-s.dpt(3,42)*(FM124_5*S24+FM224_5*...
 C24);
  CM223_5 = s.In(5,23)*OpM223_5+CM124_5*S24+CM224_5*C24+FB123_5*s.l(3,23)-FB323_5*s.l(1,23)+s.dpt(3,42)*(FM124_5*C24-FM224_5*S24);
  ...
  CM123_6 = s.In(1,23)*OpM122_6+s.In(3,23)*OpM323_6+CM124_6*C24-CM224_6*S24-FB223_6*s.l(3,23)+FB323_6*s.l(2,23)-s.dpt(3,42)*(FM124_6*S24+FM224_6*...
 C24);
  CM223_6 = s.In(5,23)*OpM223_6+CM124_6*S24+CM224_6*C24+FB123_6*s.l(3,23)-FB323_6*s.l(1,23)+s.dpt(3,42)*(FM124_6*C24-FM224_6*S24);
  ...
  CM123_19 = s.In(1,23)*OpM122_19+s.In(3,23)*OpM323_19+CM124_19*C24-CM224_19*S24-FB223_19*s.l(3,23)+FB323_19*s.l(2,23)-s.dpt(3,42)*(FM124_19*S24+...
 FM224_19*C24);
  CM223_19 = s.In(5,23)*OpM223_19+CM124_19*S24+CM224_19*C24+FB123_19*s.l(3,23)-FB323_19*s.l(1,23)+s.dpt(3,42)*(FM124_19*C24-FM224_19*S24);
  ...
  CM123_20 = s.In(1,23)*OpM122_20+s.In(3,23)*OpM323_20+CM124_20*C24-CM224_20*S24-FB223_20*s.l(3,23)+FB323_20*s.l(2,23)-s.dpt(3,42)*(FM124_20*S24+...
 FM224_20*C24);
  CM223_20 = s.In(5,23)*OpM223_20+CM124_20*S24+CM224_20*C24+FB123_20*s.l(3,23)-FB323_20*s.l(1,23)+s.dpt(3,42)*(FM124_20*C24-FM224_20*S24);
  ...
  CM123_21 = CM124_21*C24-CM224_21*S24-s.dpt(3,42)*(FM124_21*S24+FM224_21*C24)-s.In(1,23)*S22+s.In(3,23)*OpM323_21-FB223_21*s.l(3,23)+FB323_21*...
 s.l(2,23);
  CM223_21 = s.In(5,23)*OpM223_21+CM124_21*S24+CM224_21*C24+FB123_21*s.l(3,23)-FB323_21*s.l(1,23)+s.dpt(3,42)*(FM124_21*C24-FM224_21*S24);
  ...
  CM123_22 = CM124_22*C24-CM224_22*S24-s.dpt(3,42)*(FM124_22*S24+FM224_22*C24)-s.In(3,23)*S23-FB223_22*s.l(3,23)+FB323_22*s.l(2,23);
  CM123_23 = s.In(1,23)+s.m(23)*s.l(2,23)*s.l(2,23)+s.m(23)*s.l(3,23)*s.l(3,23)-s.dpt(3,42)*(C24*(FB224_23+FB225_23)+S24*(FB124_23+FB125_23*C25+...
 FB325_23*S25))+C24*(s.In(1,24)*C24-s.In(2,24)*S24+CM125_23*C25+CM325_23*S25-FB224_23*s.l(3,24)-FB225_23*s.dpt(3,44)+FB324_23*s.l(2,24))-S24*(CM225_23...
 +s.In(2,24)*C24-s.In(5,24)*S24+FB124_23*s.l(3,24)-FB324_23*s.l(1,24)+s.dpt(3,44)*(FB125_23*C25+FB325_23*S25));
 ...
 *(s.In(2,22)*OM122+s.In(5,22)*OM222+s.In(6,22)*OM322)-s.dpt(2,40)*(FF223*S23+FF323*C23));
 ...
 s.In(6,22)*OM222+s.In(9,22)*OM322)-OM322*(s.In(1,22)*OM122+s.In(2,22)*OM222));
  CF322 = -(s.trq(3,22)-s.In(6,22)*OpF221-s.In(9,22)*OpF322-CF223*S23-CF323*C23+FA122*s.l(2,22)-FA222*s.l(1,22)+FF123*s.dpt(2,40)-OM122*(...
 s.In(2,22)*OM122+s.In(5,22)*OM222+s.In(6,22)*OM322)+OM222*(s.In(1,22)*OM122+s.In(2,22)*OM222));
  ...
  CM122_4 = CM123_4+s.In(1,22)*OpM122_4+s.In(2,22)*OpM221_4-FB222_4*s.l(3,22)+FB322_4*s.l(2,22)+s.dpt(2,40)*(FM223_4*S23+FM323_4*C23);
  ...
  CM322_4 = s.In(6,22)*OpM221_4+s.In(9,22)*OpM322_4+CM223_4*S23+CM323_4*C23-FB122_4*s.l(2,22)+FB222_4*s.l(1,22)-FM123_4*s.dpt(2,40);
  ...
  CM122_5 = CM123_5+s.In(1,22)*OpM122_5+s.In(2,22)*OpM221_5-FB222_5*s.l(3,22)+FB322_5*s.l(2,22)+s.dpt(2,40)*(FM223_5*S23+FM323_5*C23);
  ...
  CM322_5 = s.In(6,22)*OpM221_5+s.In(9,22)*OpM322_5+CM223_5*S23+CM323_5*C23-FB122_5*s.l(2,22)+FB222_5*s.l(1,22)-FM123_5*s.dpt(2,40);
  ...
  CM122_6 = CM123_6+s.In(1,22)*OpM122_6+s.In(2,22)*OpM221_6-FB222_6*s.l(3,22)+FB322_6*s.l(2,22)+s.dpt(2,40)*(FM223_6*S23+FM323_6*C23);
  ...
  CM322_6 = s.In(6,22)*OpM221_6+s.In(9,22)*OpM322_6+CM223_6*S23+CM323_6*C23-FB122_6*s.l(2,22)+FB222_6*s.l(1,22)-FM123_6*s.dpt(2,40);
  ...
  CM122_19 = CM123_19+s.In(1,22)*OpM122_19+s.In(2,22)*OpM221_19-FB222_19*s.l(3,22)+FB322_19*s.l(2,22)+s.dpt(2,40)*(FM223_19*S23+FM323_19*C23);
  ...
  CM322_19 = s.In(6,22)*OpM221_19+s.In(9,22)*OpM322_19+CM223_19*S23+CM323_19*C23-FB122_19*s.l(2,22)+FB222_19*s.l(1,22)-FM123_19*s.dpt(2,40);
  ...
  CM122_20 = CM123_20+s.In(1,22)*OpM122_20+s.In(2,22)*C21-FB222_20*s.l(3,22)+FB322_20*s.l(2,22)+s.dpt(2,40)*(FM223_20*S23+FM323_20*C23);
  ...
  CM322_20 = s.In(6,22)*C21+s.In(9,22)*OpM322_20+CM223_20*S23+CM323_20*C23-FB122_20*s.l(2,22)+FB222_20*s.l(1,22)-FM123_20*s.dpt(2,40);
 ...
 FB323_22*s.l(1,23)+s.dpt(3,42)*(FM124_22*C24-FM224_22*S24))-S23*(CM324_22-s.In(9,23)*S23-FB123_22*s.l(2,23)+FB223_22*s.l(1,23));
...
% Backward Dynamics 
 ...
 s.dpt(3,52))+S29*(AlF328+BS928*s.dpt(3,52))));
  FA229 = -(s.frc(2,29)-s.m(29)*(AlF228+BeF628*s.dpt(3,52)+s.l(1,29)*(BS229+OpF329)-s.l(2,29)*(OM129*OM129+OM329*OM329)+s.l(3,29)*(BS629-OpF129))...
 );
  FA329 = -(s.frc(3,29)-s.m(29)*(s.l(1,29)*(BS329-OpF228)+s.l(2,29)*(BS629+OpF129)-s.l(3,29)*(OM129*OM129+OM229*OM229)+C29*(AlF328+BS928*...
 s.dpt(3,52))+S29*(AlF128+BeF328*s.dpt(3,52))));
 ...
 OM329)+OM229*(s.In(1,29)*OM129+s.In(2,29)*OM229));
  ...
  FF228 = FA228+FA229;
  CF128 = -(s.trq(1,28)-s.In(1,28)*OpF128-s.In(3,28)*OpF327-CF129*C29-CF329*S29+FA228*s.l(3,28)+FA229*s.dpt(3,52)-FA328*s.l(2,28)-OM228*(...
 ...
 s.In(9,28)*OM328)-OM328*(s.In(1,28)*OM128+s.In(3,28)*OM328)-s.dpt(3,52)*(FA129*C29+FA329*S29));
 ...
 s.In(5,28)*OM228+s.In(6,28)*OM328)+OM228*(s.In(1,28)*OM128+s.In(3,28)*OM328));
  ...
  CM128_4 = s.In(1,28)*OpM128_4+s.In(3,28)*OpM327_4+CM129_4*C29+CM329_4*S29-FB228_4*s.l(3,28)-FB229_4*s.dpt(3,52)+FB328_4*s.l(2,28);
  CM228_4 = CM229_4+s.In(5,28)*OpM228_4+s.In(6,28)*OpM327_4+FB128_4*s.l(3,28)-FB328_4*s.l(1,28)+s.dpt(3,52)*(FB129_4*C29+FB329_4*S29);
  ...
  CM128_5 = s.In(1,28)*OpM128_5+s.In(3,28)*OpM327_5+CM129_5*C29+CM329_5*S29-FB228_5*s.l(3,28)-FB229_5*s.dpt(3,52)+FB328_5*s.l(2,28);
  CM228_5 = CM229_5+s.In(5,28)*OpM228_5+s.In(6,28)*OpM327_5+FB128_5*s.l(3,28)-FB328_5*s.l(1,28)+s.dpt(3,52)*(FB129_5*C29+FB329_5*S29);
  ...
  CM128_6 = s.In(1,28)*OpM128_6+s.In(3,28)*OpM327_6+CM129_6*C29+CM329_6*S29-FB228_6*s.l(3,28)-FB229_6*s.dpt(3,52)+FB328_6*s.l(2,28);
  CM228_6 = CM229_6+s.In(5,28)*OpM228_6+s.In(6,28)*OpM327_6+FB128_6*s.l(3,28)-FB328_6*s.l(1,28)+s.dpt(3,52)*(FB129_6*C29+FB329_6*S29);
  ...
  CM128_19 = s.In(1,28)*OpM128_19+s.In(3,28)*OpM327_19+CM129_19*C29+CM329_19*S29-FB228_19*s.l(3,28)-FB229_19*s.dpt(3,52)+FB328_19*s.l(2,28);
  CM228_19 = CM229_19+s.In(5,28)*OpM228_19+s.In(6,28)*OpM327_19+FB128_19*s.l(3,28)-FB328_19*s.l(1,28)+s.dpt(3,52)*(FB129_19*C29+FB329_19*S29);
  ...
  CM128_20 = s.In(1,28)*OpM128_20+s.In(3,28)*OpM327_20+CM129_20*C29+CM329_20*S29-FB228_20*s.l(3,28)-FB229_20*s.dpt(3,52)+FB328_20*s.l(2,28);
  CM228_20 = CM229_20+s.In(5,28)*OpM228_20+s.In(6,28)*OpM327_20+FB128_20*s.l(3,28)-FB328_20*s.l(1,28)+s.dpt(3,52)*(FB129_20*C29+FB329_20*S29);
  ...
  CM128_21 = s.In(1,28)*OpM128_21+s.In(3,28)*OpM327_21+CM129_21*C29+CM329_21*S29-FB228_21*s.l(3,28)-FB229_21*s.dpt(3,52)+FB328_21*s.l(2,28);
  CM228_21 = CM229_21+s.In(5,28)*OpM228_21+s.In(6,28)*OpM327_21+FB128_21*s.l(3,28)-FB328_21*s.l(1,28)+s.dpt(3,52)*(FB129_21*C29+FB329_21*S29);
  ...
  CM128_26 = s.In(1,28)*OpM128_26-s.In(3,28)*S27+CM129_26*C29+CM329_26*S29-FB228_26*s.l(3,28)-FB229_26*s.dpt(3,52)+FB328_26*s.l(2,28);
  CM228_26 = CM229_26+s.In(5,28)*OpM228_26-s.In(6,28)*S27+FB128_26*s.l(3,28)-FB328_26*s.l(1,28)+s.dpt(3,52)*(FB129_26*C29+FB329_26*S29);
 ...
 s.In(3,27)*OM127+s.In(6,27)*OM227+s.In(9,27)*OM327)+OM327*(s.In(2,27)*OM127+s.In(5,27)*OM227+s.In(6,27)*OM327)+s.dpt(3,50)*(FF128*S28+FF228*C28));
 ...
 s.In(3,27)*OM127+s.In(6,27)*OM227+s.In(9,27)*OM327)-OM327*(s.In(1,27)*OM127+s.In(2,27)*OM227+s.In(3,27)*OM327)-s.dpt(3,50)*(FF128*C28-FF228*S28));
 ...
 s.In(5,27)*OM227+s.In(6,27)*OM327)+OM227*(s.In(1,27)*OM127+s.In(2,27)*OM227+s.In(3,27)*OM327));
  ...
  CM127_4 = s.In(1,27)*OpM126_4+s.In(2,27)*OpM227_4+s.In(3,27)*OpM327_4+CM128_4*C28-CM228_4*S28-FB227_4*s.l(3,27)+FB327_4*s.l(2,27)-s.dpt(3,50)*(...
 FM128_4*S28+FM228_4*C28);
  CM227_4 = s.In(2,27)*OpM126_4+s.In(5,27)*OpM227_4+s.In(6,27)*OpM327_4+CM128_4*S28+CM228_4*C28+FB127_4*s.l(3,27)-FB327_4*s.l(1,27)+s.dpt(3,50)*(...
 FM128_4*C28-FM228_4*S28);
  ...
  CM127_5 = s.In(1,27)*OpM126_5+s.In(2,27)*OpM227_5+s.In(3,27)*OpM327_5+CM128_5*C28-CM228_5*S28-FB227_5*s.l(3,27)+FB327_5*s.l(2,27)-s.dpt(3,50)*(...
 FM128_5*S28+FM228_5*C28);
  CM227_5 = s.In(2,27)*OpM126_5+s.In(5,27)*OpM227_5+s.In(6,27)*OpM327_5+CM128_5*S28+CM228_5*C28+FB127_5*s.l(3,27)-FB327_5*s.l(1,27)+s.dpt(3,50)*(...
 FM128_5*C28-FM228_5*S28);
  ...
  CM127_6 = s.In(1,27)*OpM126_6+s.In(2,27)*OpM227_6+s.In(3,27)*OpM327_6+CM128_6*C28-CM228_6*S28-FB227_6*s.l(3,27)+FB327_6*s.l(2,27)-s.dpt(3,50)*(...
 FM128_6*S28+FM228_6*C28);
  CM227_6 = s.In(2,27)*OpM126_6+s.In(5,27)*OpM227_6+s.In(6,27)*OpM327_6+CM128_6*S28+CM228_6*C28+FB127_6*s.l(3,27)-FB327_6*s.l(1,27)+s.dpt(3,50)*(...
 ...
 s.dpt(3,50)*(FM128_19*S28+FM228_19*C28);
 ...
 s.dpt(3,50)*(FM128_19*C28-FM228_19*S28);
 ...
 s.dpt(3,50)*(FM128_20*S28+FM228_20*C28);
 ...
 s.dpt(3,50)*(FM128_20*C28-FM228_20*S28);
  ...
  CM127_21 = CM128_21*C28-CM228_21*S28-s.dpt(3,50)*(FM128_21*S28+FM228_21*C28)-s.In(1,27)*S26+s.In(2,27)*OpM227_21+s.In(3,27)*OpM327_21-FB227_21*...
 s.l(3,27)+FB327_21*s.l(2,27);
  CM227_21 = CM128_21*S28+CM228_21*C28+s.dpt(3,50)*(FM128_21*C28-FM228_21*S28)-s.In(2,27)*S26+s.In(5,27)*OpM227_21+s.In(6,27)*OpM327_21+FB127_21*...
 s.l(3,27)-FB327_21*s.l(1,27);
  ...
  CM127_26 = s.In(2,27)*C27-s.In(3,27)*S27+CM128_26*C28-CM228_26*S28-FB227_26*s.l(3,27)+FB327_26*s.l(2,27)-s.dpt(3,50)*(FM128_26*S28+FM228_26*C28...
 );
  CM127_27 = s.In(1,27)+s.m(27)*s.l(2,27)*s.l(2,27)+s.m(27)*s.l(3,27)*s.l(3,27)-s.dpt(3,50)*(C28*(FB228_27+FB229_27)+S28*(FB128_27+FB129_27*C29+...
 FB329_27*S29))+C28*(s.In(1,28)*C28+CM129_27*C29+CM329_27*S29-FB228_27*s.l(3,28)-FB229_27*s.dpt(3,52)+FB328_27*s.l(2,28))-S28*(CM229_27-s.In(5,28)*S28...
 +FB128_27*s.l(3,28)-FB328_27*s.l(1,28)+s.dpt(3,52)*(FB129_27*C29+FB329_27*S29));
  ...
  CF126 = -(s.trq(1,26)-CF127-s.In(1,26)*OpF126+FA226*s.l(3,26)-FA326*s.l(2,26)+OM226*OM326*(s.In(5,26)-s.In(9,26))-s.dpt(2,48)*(FF227*S27+FF327*...
 C27));
  CF226 = -(s.trq(2,26)-s.In(5,26)*OpF221-CF227*C27+CF327*S27-FA126*s.l(3,26)+FA326*s.l(1,26)-OM126*OM326*(s.In(1,26)-s.In(9,26)));
  CF326 = -(s.trq(3,26)-s.In(9,26)*OpF326-CF227*S27-CF327*C27+FA126*s.l(2,26)-FA226*s.l(1,26)+FF127*s.dpt(2,48)+OM126*OM226*(s.In(1,26)-...
 s.In(5,26)));
  ...
  CM126_19 = CM127_19+s.In(1,26)*OpM126_19-FB226_19*s.l(3,26)+FB326_19*s.l(2,26)+s.dpt(2,48)*(FM227_19*S27+FM327_19*C27);
  CM226_19 = s.In(5,26)*OpM221_19+CM227_19*C27-CM327_19*S27+FB126_19*s.l(3,26)-FB326_19*s.l(1,26);
  CM326_19 = s.In(9,26)*OpM326_19+CM227_19*S27+CM327_19*C27-FB126_19*s.l(2,26)+FB226_19*s.l(1,26)-FM127_19*s.dpt(2,48);
  ...
  CM126_20 = CM127_20+s.In(1,26)*OpM126_20-FB226_20*s.l(3,26)+FB326_20*s.l(2,26)+s.dpt(2,48)*(FM227_20*S27+FM327_20*C27);
  CM226_20 = s.In(5,26)*C21+CM227_20*C27-CM327_20*S27+FB126_20*s.l(3,26)-FB326_20*s.l(1,26);
  CM326_20 = s.In(9,26)*OpM326_20+CM227_20*S27+CM327_20*C27-FB126_20*s.l(2,26)+FB226_20*s.l(1,26)-FM127_20*s.dpt(2,48);
 ...
 FB127_26*s.l(3,27)-FB327_26*s.l(1,27)+s.dpt(3,50)*(FM128_26*C28-FM228_26*S28))-S27*(CM328_26+s.In(6,27)*C27-s.In(9,27)*S27-FB127_26*s.l(2,27)+...
 FB227_26*s.l(1,27));
...
% Backward Dynamics 
 ...
 s.In(9,16)*OM316)+s.dpt(3,24)*(FF217*C17-FF317*S17));
  CF216 = -(s.trq(2,16)-s.In(5,16)*OpF215-CF217*C17+CF317*S17-FA116*s.l(3,16)+FA316*s.l(1,16)-FF117*s.dpt(3,24)+OM116*(s.In(3,16)*OM116+...
 ...
 s.In(3,16)*OM316-s.In(5,16)*OM116));
  ...
  CM116_4 = CM117_4+s.In(1,16)*OpM116_4+s.In(3,16)*OpM316_4-FB216_4*s.l(3,16)+FB316_4*s.l(2,16)-s.dpt(3,24)*(FM217_4*C17-FM317_4*S17);
  ...
  CM116_5 = CM117_5+s.In(1,16)*OpM116_5+s.In(3,16)*OpM316_5-FB216_5*s.l(3,16)+FB316_5*s.l(2,16)-s.dpt(3,24)*(FM217_5*C17-FM317_5*S17);
  ...
  CM116_6 = CM117_6+s.In(1,16)*OpM116_6+s.In(3,16)*OpM316_6-FB216_6*s.l(3,16)+FB316_6*s.l(2,16)-s.dpt(3,24)*(FM217_6*C17-FM317_6*S17);
  ...
  CM116_13 = CM117_13+s.In(1,16)*OpM116_13+s.In(3,16)*OpM316_13-FB216_13*s.l(3,16)+FB316_13*s.l(2,16)-s.dpt(3,24)*(FM217_13*C17-FM317_13*S17);
  CM216_13 = s.In(5,16)*OpM215_13+CM217_13*C17-CM317_13*S17+FB116_13*s.l(3,16)-FB316_13*s.l(1,16)+FM117_13*s.dpt(3,24);
  ...
  CM116_14 = CM117_14+s.In(1,16)*OpM116_14+s.In(3,16)*OpM316_14-FB216_14*s.l(3,16)+FB316_14*s.l(2,16)-s.dpt(3,24)*(FM217_14*C17-FM317_14*S17);
  ...
  CM216_15 = CM217_15*C17-CM317_15*S17+FB116_15*s.l(3,16)-FB316_15*s.l(1,16)+s.dpt(3,24)*(FB117_15+FB118_15*C18+FB318_15*S18);
  CM216_16 = s.In(5,16)+s.m(16)*s.l(1,16)*s.l(1,16)+s.m(16)*s.l(3,16)*s.l(3,16)+s.dpt(3,24)*(FB117_16+FB118_16*C18+FB318_16*S18)+C17*(CM218_16+...
 ...
 FB217_16*s.l(1,17));
  ...
  FF215 = FA215+FF216;
  CF115 = -(s.trq(1,15)-s.In(1,15)*OpF115-s.In(3,15)*OpF314-CF116*C16-CF316*S16+FA215*s.l(3,15)-FA315*s.l(2,15)+FF216*s.dpt(3,22)-OM215*(...
 ...
 s.In(3,15)*OM315-s.In(5,15)*OM115));
  ...
  CM115_4 = s.In(1,15)*OpM115_4+s.In(3,15)*OpM314_4+CM116_4*C16+CM316_4*S16-FB215_4*s.l(3,15)+FB315_4*s.l(2,15)-FM216_4*s.dpt(3,22);
  ...
  CM115_5 = s.In(1,15)*OpM115_5+s.In(3,15)*OpM314_5+CM116_5*C16+CM316_5*S16-FB215_5*s.l(3,15)+FB315_5*s.l(2,15)-FM216_5*s.dpt(3,22);
  ...
  CM115_6 = s.In(1,15)*OpM115_6+s.In(3,15)*OpM314_6+CM116_6*C16+CM316_6*S16-FB215_6*s.l(3,15)+FB315_6*s.l(2,15)-FM216_6*s.dpt(3,22);
  ...
  CM115_13 = s.In(1,15)*OpM115_13-s.In(3,15)*S14+CM116_13*C16+CM316_13*S16-FB215_13*s.l(3,15)+FB315_13*s.l(2,15)-FM216_13*s.dpt(3,22);
  CM215_13 = CM216_13+s.In(5,15)*OpM215_13+FB115_13*s.l(3,15)-FB315_13*s.l(1,15)+s.dpt(3,22)*(FM116_13*C16+FM316_13*S16);
 ...
 FB116_15*s.l(2,16)-FB216_15*s.l(1,16))-S16*(CM117_15-s.In(1,16)*S16+s.In(3,16)*C16-FB216_15*s.l(3,16)+FB316_15*s.l(2,16)-s.dpt(3,24)*(C17*(FB217_15+...
 ...
 s.In(5,14)*OM214-s.In(9,14)*OM214)+s.dpt(3,20)*(FF115*S15+FF215*C15));
 ...
 s.In(2,14)*OM214-s.In(9,14)*OM114)-s.dpt(3,20)*(FF115*C15-FF215*S15));
 ...
 +s.In(2,14)*OM214));
  ...
  CM114_4 = s.In(1,14)*OpM113_4+s.In(2,14)*OpM214_4+CM115_4*C15-CM215_4*S15-FB214_4*s.l(3,14)+FB314_4*s.l(2,14)-s.dpt(3,20)*(FM115_4*S15+FM215_4*...
 C15);
  CM214_4 = s.In(2,14)*OpM113_4+s.In(5,14)*OpM214_4+CM115_4*S15+CM215_4*C15+FB114_4*s.l(3,14)-FB314_4*s.l(1,14)+s.dpt(3,20)*(FM115_4*C15-FM215_4*...
 S15);
  ...
  CM114_5 = s.In(1,14)*OpM113_5+s.In(2,14)*OpM214_5+CM115_5*C15-CM215_5*S15-FB214_5*s.l(3,14)+FB314_5*s.l(2,14)-s.dpt(3,20)*(FM115_5*S15+FM215_5*...
 C15);
  CM214_5 = s.In(2,14)*OpM113_5+s.In(5,14)*OpM214_5+CM115_5*S15+CM215_5*C15+FB114_5*s.l(3,14)-FB314_5*s.l(1,14)+s.dpt(3,20)*(FM115_5*C15-FM215_5*...
 S15);
  ...
  CM114_6 = CM115_6*C15-CM215_6*S15-s.dpt(3,20)*(FM115_6*S15+FM215_6*C15)-s.In(1,14)*S13+s.In(2,14)*OpM214_6-FB214_6*s.l(3,14)+FB314_6*s.l(2,14);
  CM214_6 = CM115_6*S15+CM215_6*C15+s.dpt(3,20)*(FM115_6*C15-FM215_6*S15)-s.In(2,14)*S13+s.In(5,14)*OpM214_6+FB114_6*s.l(3,14)-FB314_6*s.l(1,14);
  ...
  CM114_13 = s.In(2,14)*C14+CM115_13*C15-CM215_13*S15-FB214_13*s.l(3,14)+FB314_13*s.l(2,14)-s.dpt(3,20)*(FM115_13*S15+FM215_13*C15);
  CM114_14 = s.In(1,14)+s.m(14)*s.l(2,14)*s.l(2,14)+s.m(14)*s.l(3,14)*s.l(3,14)-s.dpt(3,20)*(C15*(FB215_14+FM216_14)+S15*(FB115_14+FM116_14*C16+...
 FM316_14*S16))+C15*(s.In(1,15)*C15+CM116_14*C16+CM316_14*S16-FB215_14*s.l(3,15)+FB315_14*s.l(2,15)-FM216_14*s.dpt(3,22))-S15*(CM216_14-s.In(5,15)*S15...
 ...
 s.In(6,13)*OM213+s.In(9,13)*OM313)-OM313*(s.In(1,13)*OM113+s.In(2,13)*OM213));
  CF313 = -(s.trq(3,13)-s.In(6,13)*OpF26-s.In(9,13)*OpF313-CF214*S14-CF314*C14+FA113*s.l(2,13)-FA213*s.l(1,13)+FF114*s.dpt(2,18)-OM113*(...
 s.In(2,13)*OM113+s.In(5,13)*OM213+s.In(6,13)*OM313)+OM213*(s.In(1,13)*OM113+s.In(2,13)*OM213));
  ...
  CM113_4 = CM114_4+s.In(1,13)*OpM113_4+s.In(2,13)*OpM26_4-FB213_4*s.l(3,13)+FB313_4*s.l(2,13)+s.dpt(2,18)*(FM214_4*S14+FM314_4*C14);
  ...
  CM313_4 = s.In(6,13)*OpM26_4+s.In(9,13)*OpM313_4+CM214_4*S14+CM314_4*C14-FB113_4*s.l(2,13)+FB213_4*s.l(1,13)-FM114_4*s.dpt(2,18);
  ...
  CM113_5 = CM114_5+s.In(1,13)*OpM113_5+s.In(2,13)*C6-FB213_5*s.l(3,13)+FB313_5*s.l(2,13)+s.dpt(2,18)*(FM214_5*S14+FM314_5*C14);
  CM213_5 = s.In(2,13)*OpM113_5+s.In(5,13)*C6+s.In(6,13)*OpM313_5+CM214_5*C14-CM314_5*S14+FB113_5*s.l(3,13)-FB313_5*s.l(1,13);
  CM313_5 = s.In(6,13)*C6+s.In(9,13)*OpM313_5+CM214_5*S14+CM314_5*C14-FB113_5*s.l(2,13)+FB213_5*s.l(1,13)-FM114_5*s.dpt(2,18);
 ...
 FB314_13*s.l(1,14)+s.dpt(3,20)*(FM115_13*C15-FM215_13*S15))-S14*(CM315_13-s.In(9,14)*S14-FB114_13*s.l(2,14)+FB214_13*s.l(1,14));
...
% Backward Dynamics 
  ...
  CF121 = -(s.trq(1,21)-s.In(1,21)*OpF121-CF122*C22-CF126*C26-CF322*S22-CF326*S26+FA221*s.l(3,21)-FA321*s.l(2,21)+FF222*s.dpt(3,37)+FF226*...
 s.dpt(3,38)-OM221*(s.In(6,21)*OM221+s.In(9,21)*OM321)+OM321*(s.In(5,21)*OM221+s.In(6,21)*OM321)+s.dpt(2,37)*(FF122*S22-FF322*C22)+s.dpt(2,38)*(FF126*...
 S26-FF326*C26));
 ...
 s.In(9,21)*OM321)-s.dpt(1,37)*(FF122*S22-FF322*C22)-s.dpt(1,38)*(FF126*S26-FF326*C26)-s.dpt(3,37)*(FF122*C22+FF322*S22)-s.dpt(3,38)*(FF126*C26+FF326*...
 S26));
 ...
 s.dpt(1,37)-FF226*s.dpt(1,38)-OM121*(s.In(6,21)*OM321-OM221*(s.In(1,21)-s.In(5,21)))+s.dpt(2,37)*(FF122*C22+FF322*S22)+s.dpt(2,38)*(FF126*C26+FF326*...
 S26));
  ...
  CM121_1 = CM122_1*C22+CM126_1*C26+CM322_1*S22+CM326_1*S26-FB221_1*s.l(3,21)+FB321_1*s.l(2,21)-FM222_1*s.dpt(3,37)-FM226_1*s.dpt(3,38)-...
 s.dpt(2,37)*(FM122_1*S22-FM322_1*C22)-s.dpt(2,38)*(FM126_1*S26-FM326_1*C26);
  CM221_1 = CM222_1+CM226_1+FB121_1*s.l(3,21)-FB321_1*s.l(1,21)+s.dpt(1,37)*(FM122_1*S22-FM322_1*C22)+s.dpt(1,38)*(FM126_1*S26-FM326_1*C26)+...
 s.dpt(3,37)*(FM122_1*C22+FM322_1*S22)+s.dpt(3,38)*(FM126_1*C26+FM326_1*S26);
  CM321_1 = -(CM122_1*S22+CM126_1*S26-CM322_1*C22-CM326_1*C26+FB121_1*s.l(2,21)-FB221_1*s.l(1,21)-FM222_1*s.dpt(1,37)-FM226_1*s.dpt(1,38)+...
 s.dpt(2,37)*(FM122_1*C22+FM322_1*S22)+s.dpt(2,38)*(FM126_1*C26+FM326_1*S26));
  ...
  CM121_2 = CM122_2*C22+CM126_2*C26+CM322_2*S22+CM326_2*S26-FB221_2*s.l(3,21)+FB321_2*s.l(2,21)-FM222_2*s.dpt(3,37)-FM226_2*s.dpt(3,38)-...
 s.dpt(2,37)*(FM122_2*S22-FM322_2*C22)-s.dpt(2,38)*(FM126_2*S26-FM326_2*C26);
  CM221_2 = CM222_2+CM226_2+FB121_2*s.l(3,21)-FB321_2*s.l(1,21)+s.dpt(1,37)*(FM122_2*S22-FM322_2*C22)+s.dpt(1,38)*(FM126_2*S26-FM326_2*C26)+...
 s.dpt(3,37)*(FM122_2*C22+FM322_2*S22)+s.dpt(3,38)*(FM126_2*C26+FM326_2*S26);
  CM321_2 = -(CM122_2*S22+CM126_2*S26-CM322_2*C22-CM326_2*C26+FB121_2*s.l(2,21)-FB221_2*s.l(1,21)-FM222_2*s.dpt(1,37)-FM226_2*s.dpt(1,38)+...
 s.dpt(2,37)*(FM122_2*C22+FM322_2*S22)+s.dpt(2,38)*(FM126_2*C26+FM326_2*S26));
  ...
  CM121_3 = CM122_3*C22+CM126_3*C26+CM322_3*S22+CM326_3*S26-FB221_3*s.l(3,21)+FB321_3*s.l(2,21)-FM222_3*s.dpt(3,37)-FM226_3*s.dpt(3,38)-...
 s.dpt(2,37)*(FM122_3*S22-FM322_3*C22)-s.dpt(2,38)*(FM126_3*S26-FM326_3*C26);
  CM221_3 = CM222_3+CM226_3+FB121_3*s.l(3,21)-FB321_3*s.l(1,21)+s.dpt(1,37)*(FM122_3*S22-FM322_3*C22)+s.dpt(1,38)*(FM126_3*S26-FM326_3*C26)+...
 s.dpt(3,37)*(FM122_3*C22+FM322_3*S22)+s.dpt(3,38)*(FM126_3*C26+FM326_3*S26);
  CM321_3 = -(CM122_3*S22+CM126_3*S26-CM322_3*C22-CM326_3*C26+FB121_3*s.l(2,21)-FB221_3*s.l(1,21)-FM222_3*s.dpt(1,37)-FM226_3*s.dpt(1,38)+...
 s.dpt(2,37)*(FM122_3*C22+FM322_3*S22)+s.dpt(2,38)*(FM126_3*C26+FM326_3*S26));
  ...
  CM121_4 = s.In(1,21)*OpM121_4+CM122_4*C22+CM126_4*C26+CM322_4*S22+CM326_4*S26-FB221_4*s.l(3,21)+FB321_4*s.l(2,21)-FM222_4*s.dpt(3,37)-FM226_4*...
 s.dpt(3,38)-s.dpt(2,37)*(FM122_4*S22-FM322_4*C22)-s.dpt(2,38)*(FM126_4*S26-FM326_4*C26);
  CM221_4 = CM222_4+CM226_4+s.In(5,21)*OpM221_4+s.In(6,21)*OpM320_4+FB121_4*s.l(3,21)-FB321_4*s.l(1,21)+s.dpt(1,37)*(FM122_4*S22-FM322_4*C22)+...
 s.dpt(1,38)*(FM126_4*S26-FM326_4*C26)+s.dpt(3,37)*(FM122_4*C22+FM322_4*S22)+s.dpt(3,38)*(FM126_4*C26+FM326_4*S26);
 ...
 s.dpt(1,37)+FM226_4*s.dpt(1,38)-s.dpt(2,37)*(FM122_4*C22+FM322_4*S22)-s.dpt(2,38)*(FM126_4*C26+FM326_4*S26);
  ...
  CM121_5 = s.In(1,21)*OpM121_5+CM122_5*C22+CM126_5*C26+CM322_5*S22+CM326_5*S26-FB221_5*s.l(3,21)+FB321_5*s.l(2,21)-FM222_5*s.dpt(3,37)-FM226_5*...
 s.dpt(3,38)-s.dpt(2,37)*(FM122_5*S22-FM322_5*C22)-s.dpt(2,38)*(FM126_5*S26-FM326_5*C26);
  CM221_5 = CM222_5+CM226_5+s.In(5,21)*OpM221_5+s.In(6,21)*OpM320_5+FB121_5*s.l(3,21)-FB321_5*s.l(1,21)+s.dpt(1,37)*(FM122_5*S22-FM322_5*C22)+...
 s.dpt(1,38)*(FM126_5*S26-FM326_5*C26)+s.dpt(3,37)*(FM122_5*C22+FM322_5*S22)+s.dpt(3,38)*(FM126_5*C26+FM326_5*S26);
 ...
 s.dpt(1,37)+FM226_5*s.dpt(1,38)-s.dpt(2,37)*(FM122_5*C22+FM322_5*S22)-s.dpt(2,38)*(FM126_5*C26+FM326_5*S26);
  ...
  CM121_6 = s.In(1,21)*OpM121_6+CM122_6*C22+CM126_6*C26+CM322_6*S22+CM326_6*S26-FB221_6*s.l(3,21)+FB321_6*s.l(2,21)-FM222_6*s.dpt(3,37)-FM226_6*...
 s.dpt(3,38)-s.dpt(2,37)*(FM122_6*S22-FM322_6*C22)-s.dpt(2,38)*(FM126_6*S26-FM326_6*C26);
  CM221_6 = CM222_6+CM226_6+s.In(5,21)*OpM221_6+s.In(6,21)*OpM320_6+FB121_6*s.l(3,21)-FB321_6*s.l(1,21)+s.dpt(1,37)*(FM122_6*S22-FM322_6*C22)+...
 s.dpt(1,38)*(FM126_6*S26-FM326_6*C26)+s.dpt(3,37)*(FM122_6*C22+FM322_6*S22)+s.dpt(3,38)*(FM126_6*C26+FM326_6*S26);
 ...
 s.dpt(1,37)+FM226_6*s.dpt(1,38)-s.dpt(2,37)*(FM122_6*C22+FM322_6*S22)-s.dpt(2,38)*(FM126_6*C26+FM326_6*S26);
  ...
  CM121_19 = s.In(1,21)*OpM121_19+CM122_19*C22+CM126_19*C26+CM322_19*S22+CM326_19*S26-FB221_19*s.l(3,21)+FB321_19*s.l(2,21)-FM222_19*s.dpt(3,37)-...
 FM226_19*s.dpt(3,38)-s.dpt(2,37)*(FM122_19*S22-FM322_19*C22)-s.dpt(2,38)*(FM126_19*S26-FM326_19*C26);
  CM221_19 = CM222_19+CM226_19+s.In(5,21)*OpM221_19+s.In(6,21)*S20+FB121_19*s.l(3,21)-FB321_19*s.l(1,21)+s.dpt(1,37)*(FM122_19*S22-FM322_19*C22)+...
 s.dpt(1,38)*(FM126_19*S26-FM326_19*C26)+s.dpt(3,37)*(FM122_19*C22+FM322_19*S22)+s.dpt(3,38)*(FM126_19*C26+FM326_19*S26);
 ...
 FM222_19*s.dpt(1,37)+FM226_19*s.dpt(1,38)-s.dpt(2,37)*(FM122_19*C22+FM322_19*S22)-s.dpt(2,38)*(FM126_19*C26+FM326_19*S26);
  FB121_20 = s.m(21)*C21*(s.dpt(3,33)+s.l(3,21));
  FB221_20 = s.m(21)*(AlM221_20-s.l(3,21)*S21);
  FB321_20 = -s.m(21)*(s.l(1,21)*C21-s.l(2,21)*S21);
  CM321_20 = s.In(6,21)*C21-CM122_20*S22-CM126_20*S26+CM322_20*C22+CM326_20*C26-FB121_20*s.l(2,21)+FB221_20*s.l(1,21)+FM222_20*s.dpt(1,37)+...
 FM226_20*s.dpt(1,38)-s.dpt(2,37)*(FM122_20*C22+FM322_20*S22)-s.dpt(2,38)*(FM126_20*C26+FM326_20*S26);
  CM321_21 = s.In(9,21)+s.m(21)*s.l(1,21)*s.l(1,21)+s.m(21)*s.l(2,21)*s.l(2,21)+s.dpt(1,37)*(FB222_21+FM223_21*C23-FM323_21*S23)+s.dpt(1,38)*(...
 FB226_21+FM227_21*C27-FM327_21*S27)-s.dpt(2,37)*(C22*(FB122_21+FM123_21)+S22*(FB322_21+FM223_21*S23+FM323_21*C23))-s.dpt(2,38)*(C26*(FB126_21+...
 ...
 s.dpt(2,40))-S22*(CM123_21-s.In(1,22)*S22-FB222_21*s.l(3,22)+FB322_21*s.l(2,22)+s.dpt(2,40)*(FM223_21*S23+FM323_21*C23))+C26*(s.In(9,26)*C26+CM227_21...
 *S27+CM327_21*C27-FB126_21*s.l(2,26)+FB226_21*s.l(1,26)-FM127_21*s.dpt(2,48))-S26*(CM127_21-s.In(1,26)*S26-FB226_21*s.l(3,26)+FB326_21*s.l(2,26)+...
 s.dpt(2,48)*(FM227_21*S27+FM327_21*C27));
 ...
 s.In(5,20)*OM320+s.In(9,20)*OM320)+s.dpt(3,33)*(FF121*S21+FF221*C21));
 ...
 s.In(1,20)*OM120+s.In(3,20)*OM320)-s.dpt(3,33)*(FF121*C21-FF221*S21));
 ...
 s.In(5,20)*OM120));
  ...
  CM120_4 = s.In(1,20)*OpM120_4+s.In(3,20)*OpM320_4+CM121_4*C21-CM221_4*S21-FB220_4*s.l(3,20)+FB320_4*s.l(2,20)-s.dpt(3,33)*(FM121_4*S21+FM221_4*...
 C21);
  CM220_4 = s.In(5,20)*OpM219_4+CM121_4*S21+CM221_4*C21+FB120_4*s.l(3,20)-FB320_4*s.l(1,20)+s.dpt(3,33)*(FM121_4*C21-FM221_4*S21);
  ...
  CM120_5 = s.In(1,20)*OpM120_5+s.In(3,20)*OpM320_5+CM121_5*C21-CM221_5*S21-FB220_5*s.l(3,20)+FB320_5*s.l(2,20)-s.dpt(3,33)*(FM121_5*S21+FM221_5*...
 C21);
  CM220_5 = s.In(5,20)*OpM219_5+CM121_5*S21+CM221_5*C21+FB120_5*s.l(3,20)-FB320_5*s.l(1,20)+s.dpt(3,33)*(FM121_5*C21-FM221_5*S21);
  ...
  CM120_6 = s.In(1,20)*OpM120_6+s.In(3,20)*OpM320_6+CM121_6*C21-CM221_6*S21-FB220_6*s.l(3,20)+FB320_6*s.l(2,20)-s.dpt(3,33)*(FM121_6*S21+FM221_6*...
 C21);
  CM220_6 = s.In(5,20)*S19+CM121_6*S21+CM221_6*C21+FB120_6*s.l(3,20)-FB320_6*s.l(1,20)+s.dpt(3,33)*(FM121_6*C21-FM221_6*S21);
  ...
  CM220_19 = CM121_19*S21+CM221_19*C21+FB120_19*s.l(3,20)-FB320_19*s.l(1,20)+s.dpt(3,33)*(FM121_19*C21-FM221_19*S21);
  CM220_20 = s.In(5,20)+s.m(20)*s.l(1,20)*s.l(1,20)+s.m(20)*s.l(3,20)*s.l(3,20)+s.dpt(3,33)*(C21*(FB121_20+FM122_20*C22+FM126_20*C26+FM322_20*S22...
 +FM326_20*S26)-S21*(FB221_20+FM222_20+FM226_20))+C21*(CM222_20+CM226_20+s.In(5,21)*C21+FB121_20*s.l(3,21)-FB321_20*s.l(1,21)+s.dpt(1,37)*(FM122_20*...
 S22-FM322_20*C22)+s.dpt(1,38)*(FM126_20*S26-FM326_20*C26)+s.dpt(3,37)*(FM122_20*C22+FM322_20*S22)+s.dpt(3,38)*(FM126_20*C26+FM326_20*S26))+S21*(...
 s.In(1,21)*S21+CM122_20*C22+CM126_20*C26+CM322_20*S22+CM326_20*S26-FB221_20*s.l(3,21)+FB321_20*s.l(2,21)-FM222_20*s.dpt(3,37)-FM226_20*s.dpt(3,38)-...
 s.dpt(2,37)*(FM122_20*S22-FM322_20*C22)-s.dpt(2,38)*(FM126_20*S26-FM326_20*C26));
 ...
 FB220_19*s.l(3,20)+FB320_19*s.l(2,20)-s.dpt(3,33)*(FM121_19*S21+FM221_19*C21))+S20*(CM321_19+s.In(3,20)*C20+s.In(9,20)*S20-FB120_19*s.l(2,20)+...
 FB220_19*s.l(1,20));
...
% Backward Dynamics 
 ...
 s.In(6,6)*OM26+s.In(9,6)*OM36)+OM36*(s.In(5,6)*OM26+s.In(6,6)*OM36)+s.dpt(2,1)*(FF17*S7-FF37*C7)+s.dpt(2,2)*(FF113*S13-FF313*C13)+s.dpt(3,3)*(FF219*...
 C19-FF319*S19));
  CF26 = -(s.trq(2,6)-CF213-CF27-s.In(5,6)*OpF26-s.In(6,6)*OpF35-CF219*C19+CF319*S19-FA16*s.l(3,6)+FA36*s.l(1,6)-FF119*s.dpt(3,3)+OM16*(s.In(3,6)...
 *OM16+s.In(6,6)*OM26+s.In(9,6)*OM36)-OM36*(s.In(1,6)*OM16+s.In(3,6)*OM36)+s.dpt(1,3)*(FF219*S19+FF319*C19));
 ...
 s.l(1,6)-OM16*(s.In(5,6)*OM26+s.In(6,6)*OM36)+OM26*(s.In(1,6)*OM16+s.In(3,6)*OM36)-s.dpt(1,3)*(FF219*C19-FF319*S19)+s.dpt(2,1)*(FF17*C7+FF37*S7)+...
 ...
 s.l(1,6)-s.dpt(2,1)*(FM17_3*C7+FM37_3*S7)-s.dpt(2,2)*(FM113_3*C13+FM313_3*S13);
  ...
  CM16_4 = CM119_4+s.In(1,6)*OpM16_4+s.In(3,6)*S5+CM113_4*C13+CM17_4*C7+CM313_4*S13+CM37_4*S7-FB26_4*s.l(3,6)+FB36_4*s.l(2,6)-s.dpt(2,1)*(FM17_4*...
 S7-FM37_4*C7)-s.dpt(2,2)*(FM113_4*S13-FM313_4*C13)-s.dpt(3,3)*(FM219_4*C19-FM319_4*S19);
  CM26_4 = CM213_4+CM27_4+s.In(5,6)*OpM26_4+s.In(6,6)*S5+CM219_4*C19-CM319_4*S19+FB16_4*s.l(3,6)-FB36_4*s.l(1,6)-s.dpt(1,3)*(FM219_4*S19+FM319_4*...
 C19)+s.dpt(3,3)*(FB119_4+FM120_4*C20+FM320_4*S20);
 ...
 *(FB320_6+FB321_6-FM122_6*S22-FM126_6*S26+FM322_6*C22+FM326_6*C26)-S20*(FB120_6+FM121_6*C21-FM221_6*S21)))-s.dpt(2,1)*(C7*(FB17_6+FM18_6)+S7*(FB37_6+...
 FM28_6*S8+FM38_6*C8))-s.dpt(2,2)*(C13*(FB113_6+FM114_6)+S13*(FB313_6+FM214_6*S14+FM314_6*C14))+C13*(s.In(9,13)*C13+CM214_6*S14+CM314_6*C14-FB113_6*...
 s.l(2,13)+FB213_6*s.l(1,13)-FM114_6*s.dpt(2,18))-S13*(CM114_6-s.In(1,13)*S13-FB213_6*s.l(3,13)+FB313_6*s.l(2,13)+s.dpt(2,18)*(FM214_6*S14+FM314_6*C14...
 ...
 *s.l(3,19)-FB319_6*s.l(1,19))+C7*(s.In(9,7)*C7+CM28_6*S8+CM38_6*C8-FB17_6*s.l(2,7)+FB27_6*s.l(1,7)-FM18_6*s.dpt(2,6))-S7*(CM18_6-s.In(1,7)*S7-FB27_6*...
 s.l(3,7)+FB37_6*s.l(2,7)+s.dpt(2,6)*(FM28_6*S8+FM38_6*C8));
  ...
  CM55_26 = C6*(CM213_5+CM27_5+s.In(5,6)*C6+CM219_5*C19-CM319_5*S19+FB16_5*s.l(3,6)-FB36_5*s.l(1,6)-s.dpt(1,3)*(FM219_5*S19+FM319_5*C19)+...
 s.dpt(3,3)*(FB119_5+FM120_5*C20+FM320_5*S20))+S6*(CM119_5+s.In(1,6)*S6+CM113_5*C13+CM17_5*C7+CM313_5*S13+CM37_5*S7-FB26_5*s.l(3,6)+FB36_5*s.l(2,6)-...
