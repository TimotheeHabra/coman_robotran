 ...
 *S23+Fq323*C23));
 ...
 s->l[2][18]-OM218*(s->In[3][18]*OM118+s->In[9][18]*OM318)+OM318*(s->In[2][18]*OM118+s->In[5][18]*OM218));
  Cq218 = -(s->trq[2][18]-s->In[2][18]*OMp118-s->In[5][18]*OMp218-Fs118*s->l[3][18]+Fs318*s->l[1][18]+OM118*(
 s->In[3][18]*OM118+s->In[9][18]*OM318)-OM318*(s->In[1][18]*OM118+s->In[2][18]*OM218+s->In[3][18]*OM318));
  Cq318 = -(s->trq[3][18]-s->In[3][18]*OMp118-s->In[9][18]*OMp318+Fs118*s->l[2][18]-Fs218*s->l[1][18]-OM118*(
 ...
 *S14+Fq314*C14));
 ...
 s->l[3][12]*(OM112*OM112+OM212*OM212)));
  Cq112 = -(s->trq[1][12]-s->In[1][12]*OMp112-s->In[3][12]*OMp312+Fs212*s->l[3][12]-Fs312*s->l[2][12]-OM212*(
 s->In[3][12]*OM112+s->In[6][12]*OM212+s->In[9][12]*OM312)+OM312*(s->In[5][12]*OM212+s->In[6][12]*OM312));
  Cq212 = -(s->trq[2][12]-s->In[5][12]*OMp212-s->In[6][12]*OMp312-Fs112*s->l[3][12]+Fs312*s->l[1][12]+OM112*(
