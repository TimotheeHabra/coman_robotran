 ...
 *s.dpt(1,36));
  ...
  ALPHA125 = C25*(ALPHA124+BETA224*s.dpt(2,44)+BS124*s.dpt(1,44))+S25*(ALPHA224+BETA424*s.dpt(1,44)+BS524*s.dpt(2,44));
  ALPHA225 = C25*(ALPHA224+BETA424*s.dpt(1,44)+BS524*s.dpt(2,44))-S25*(ALPHA124+BETA224*s.dpt(2,44)+BS124*s.dpt(1,44));
 ...
 *s.dpt(1,37));
  ...
  ALPHA132 = C32*(ALPHA131+BETA231*s.dpt(2,55)+BS131*s.dpt(1,55))+S32*(ALPHA231+BETA431*s.dpt(1,55)+BS531*s.dpt(2,55));
  ALPHA232 = C32*(ALPHA231+BETA431*s.dpt(1,55)+BS531*s.dpt(2,55))-S32*(ALPHA131+BETA231*s.dpt(2,55)+BS131*s.dpt(1,55));
...
% Backward Dynamics 
  ...
  Fq333 = Fq334+Fs333;
  Cq133 = -(s.trq(1,33)-s.In(1,33)*OMp133-Cq134*C34+Cq234*S34-Fq334*s.dpt(2,58)-Fs333*s.l(2,33)+OM233*OM333*(s.In(5,33)-s.In(9,33)));
  Cq233 = -(s.trq(2,33)-s.In(5,33)*OMp233-Cq134*S34-Cq234*C34-OM133*OM333*(s.In(1,33)-s.In(9,33)));
  Cq333 = -(s.trq(3,33)-Cq334-s.In(9,33)*OMp333+Fs133*s.l(2,33)+OM133*OM233*(s.In(1,33)-s.In(5,33))+s.dpt(2,58)*(Fq134*C34-Fq234*S34));
  ...
  Cq132 = -(s.trq(1,32)-s.In(1,32)*OMp132-Cq133*C33-Cq333*S33-Fs332*s.l(2,32)+OM232*OM332*(s.In(5,32)-s.In(9,32)));
  Cq232 = -(s.trq(2,32)-Cq233-s.In(5,32)*OMp232-OM132*OM332*(s.In(1,32)-s.In(9,32))-s.dpt(1,57)*(Fq133*S33-Fq333*C33));
  Cq332 = -(s.trq(3,32)-s.In(9,32)*OMp332+Cq133*S33-Cq333*C33-Fq233*s.dpt(1,57)+Fs132*s.l(2,32)+OM132*OM232*(s.In(1,32)-s.In(5,32)));
  ...
  Fq331 = Fq332+Fs331;
  Cq131 = -(s.trq(1,31)-s.In(1,31)*OMp131-Cq132*C32+Cq232*S32-Fq332*s.dpt(2,55)+Fs231*s.l(3,31)-Fs331*s.l(2,31)+OM231*OM331*(s.In(5,31)-...
 s.In(9,31)));
  Cq231 = -(s.trq(2,31)-s.In(5,31)*OMp231-Cq132*S32-Cq232*C32+Fq332*s.dpt(1,55)-Fs131*s.l(3,31)+Fs331*s.l(1,31)-OM131*OM331*(s.In(1,31)-...
 s.In(9,31)));
  Cq331 = -(s.trq(3,31)-Cq332-s.In(9,31)*OMp331+Fs131*s.l(2,31)-Fs231*s.l(1,31)+OM131*OM231*(s.In(1,31)-s.In(5,31))-s.dpt(1,55)*(Fq132*S32+Fq232*...
 C32)+s.dpt(2,55)*(Fq132*C32-Fq232*S32));
  ...
  Cq130 = -(s.trq(1,30)-s.In(1,30)*OMp130-Cq131*C31-Cq331*S31+Fs230*s.l(3,30)-Fs330*s.l(2,30)+OM230*OM330*(s.In(5,30)-s.In(9,30))+s.dpt(2,53)*(...
 Fq131*S31-Fq331*C31));
  Cq230 = -(s.trq(2,30)-Cq231-s.In(5,30)*OMp230-Fs130*s.l(3,30)+Fs330*s.l(1,30)-OM130*OM330*(s.In(1,30)-s.In(9,30)));
  Cq330 = -(s.trq(3,30)-s.In(9,30)*OMp330+Cq131*S31-Cq331*C31+Fs130*s.l(2,30)-Fs230*s.l(1,30)+OM130*OM230*(s.In(1,30)-s.In(5,30))+s.dpt(2,53)*(...
 Fq131*C31+Fq331*S31));
  ...
  Cq129 = -(s.trq(1,29)-Cq130-s.In(1,29)*OMp129+Fs229*s.l(3,29)-Fs329*s.l(2,29)+OM229*OM329*(s.In(5,29)-s.In(9,29))-s.dpt(2,51)*(Fq230*S30+Fq330*...
 C30));
  Cq229 = -(s.trq(2,29)-s.In(5,29)*OMp229-Cq230*C30+Cq330*S30-Fs129*s.l(3,29)+Fs329*s.l(1,29)-OM129*OM329*(s.In(1,29)-s.In(9,29)));
  Cq329 = -(s.trq(3,29)-s.In(9,29)*OMp329-Cq230*S30-Cq330*C30+Fq130*s.dpt(2,51)+Fs129*s.l(2,29)-Fs229*s.l(1,29)+OM129*OM229*(s.In(1,29)-...
 s.In(5,29)));
  ...
  Fq326 = Fq327+Fs326;
  Cq126 = -(s.trq(1,26)-s.In(1,26)*OMp126-Cq127*C27+Cq227*S27-Fq327*s.dpt(2,47)-Fs326*s.l(2,26)+OM226*OM326*(s.In(5,26)-s.In(9,26)));
  Cq226 = -(s.trq(2,26)-s.In(5,26)*OMp226-Cq127*S27-Cq227*C27-OM126*OM326*(s.In(1,26)-s.In(9,26)));
  Cq326 = -(s.trq(3,26)-Cq327-s.In(9,26)*OMp326+Fs126*s.l(2,26)+OM126*OM226*(s.In(1,26)-s.In(5,26))+s.dpt(2,47)*(Fq127*C27-Fq227*S27));
  ...
  Cq125 = -(s.trq(1,25)-s.In(1,25)*OMp125-Cq126*C26-Cq326*S26+Fs225*s.l(3,25)-Fs325*s.l(2,25)+OM225*OM325*(s.In(5,25)-s.In(9,25)));
  Cq225 = -(s.trq(2,25)-Cq226-s.In(5,25)*OMp225-Fs125*s.l(3,25)+Fs325*s.l(1,25)-OM125*OM325*(s.In(1,25)-s.In(9,25))-s.dpt(1,46)*(Fq126*S26-Fq326*...
 C26));
  Cq325 = -(s.trq(3,25)-s.In(9,25)*OMp325+Cq126*S26-Cq326*C26-Fq226*s.dpt(1,46)+Fs125*s.l(2,25)-Fs225*s.l(1,25)+OM125*OM225*(s.In(1,25)-...
 s.In(5,25)));
  ...
  Fs324 = -(s.frc(3,24)-s.m(24)*(ALPHA324+BETA724*s.l(1,24)+BETA824*s.l(2,24)-s.l(3,24)*(OM124*OM124+OM224*OM224)));
  Fq124 = Fs124+Fq125*C25-Fq225*S25;
  Fq324 = Fq325+Fs324;
  Cq124 = -(s.trq(1,24)-s.In(1,24)*OMp124-Cq125*C25+Cq225*S25-Fq325*s.dpt(2,44)+Fs224*s.l(3,24)-Fs324*s.l(2,24)+OM224*OM324*(s.In(5,24)-...
 s.In(9,24)));
  Cq224 = -(s.trq(2,24)-s.In(5,24)*OMp224-Cq125*S25-Cq225*C25+Fq325*s.dpt(1,44)-Fs124*s.l(3,24)+Fs324*s.l(1,24)-OM124*OM324*(s.In(1,24)-...
 s.In(9,24)));
  Cq324 = -(s.trq(3,24)-Cq325-s.In(9,24)*OMp324+Fs124*s.l(2,24)-Fs224*s.l(1,24)+OM124*OM224*(s.In(1,24)-s.In(5,24))-s.dpt(1,44)*(Fq125*S25+Fq225*...
 C25)+s.dpt(2,44)*(Fq125*C25-Fq225*S25));
  ...
  Cq123 = -(s.trq(1,23)-s.In(1,23)*OMp123-Cq124*C24-Cq324*S24-Fs323*s.l(2,23)+OM223*OM323*(s.In(5,23)-s.In(9,23))+s.dpt(2,42)*(Fq124*S24-Fq324*...
 C24));
  Cq223 = -(s.trq(2,23)-Cq224-s.In(5,23)*OMp223+Fs323*s.l(1,23)-OM123*OM323*(s.In(1,23)-s.In(9,23)));
  Cq323 = -(s.trq(3,23)-s.In(9,23)*OMp323+Cq124*S24-Cq324*C24+Fs123*s.l(2,23)-Fs223*s.l(1,23)+OM123*OM223*(s.In(1,23)-s.In(5,23))+s.dpt(2,42)*(...
 Fq124*C24+Fq324*S24));
  ...
  Cq122 = -(s.trq(1,22)-Cq123-s.In(1,22)*OMp122+Fs222*s.l(3,22)-Fs322*s.l(2,22)+OM222*OM322*(s.In(5,22)-s.In(9,22))-s.dpt(2,40)*(Fq223*S23+Fq323*...
 C23));
  Cq222 = -(s.trq(2,22)-s.In(5,22)*OMp222-Cq223*C23+Cq323*S23-Fs122*s.l(3,22)+Fs322*s.l(1,22)-OM122*OM322*(s.In(1,22)-s.In(9,22)));
  Cq322 = -(s.trq(3,22)-s.In(9,22)*OMp322-Cq223*S23-Cq323*C23+Fq123*s.dpt(2,40)+Fs122*s.l(2,22)-Fs222*s.l(1,22)+OM122*OM222*(s.In(1,22)-...
 s.In(5,22)));
 ...
 s.In(3,20)*OM120+s.In(6,20)*OM220+s.In(9,20)*OM320)+OM320*(s.In(2,20)*OM120+s.In(5,20)*OM220+s.In(6,20)*OM320)+s.dpt(3,32)*(Fq121*S21+Fq221*C21));
 ...
 s.In(3,20)*OM120+s.In(6,20)*OM220+s.In(9,20)*OM320)-OM320*(s.In(1,20)*OM120+s.In(2,20)*OM220+s.In(3,20)*OM320)-s.dpt(3,32)*(Fq121*C21-Fq221*S21));
 ...
 s.In(6,16)*OM216+s.In(9,16)*OM316)+OM316*(s.In(2,16)*OM116+s.In(5,16)*OM216+s.In(6,16)*OM316)+s.dpt(3,24)*(Fq217*C17-Fq317*S17));
  Cq216 = -(s.trq(2,16)-s.In(2,16)*OMp116-s.In(5,16)*OMp216-s.In(6,16)*OMp316-Cq217*C17+Cq317*S17-Fq117*s.dpt(3,24)-Fs116*s.l(3,16)+Fs316*...
 ...
 s.In(2,16)*OM116+s.In(5,16)*OM216+s.In(6,16)*OM316)+OM216*(s.In(1,16)*OM116+s.In(2,16)*OM216+s.In(3,16)*OM316));
  ...
  Fq215 = Fq216+Fs215;
  Cq115 = -(s.trq(1,15)-s.In(1,15)*OMp115-s.In(2,15)*OMp215-s.In(3,15)*OMp315-Cq116*C16-Cq316*S16+Fq216*s.dpt(3,22)+Fs215*s.l(3,15)-Fs315*...
 ...
 s.In(6,15)*OM215+s.In(9,15)*OM315)-OM315*(s.In(1,15)*OM115+s.In(2,15)*OM215+s.In(3,15)*OM315)-s.dpt(3,22)*(Fq116*C16+Fq316*S16));
 ...
 s.In(3,14)*OM114+s.In(6,14)*OM214+s.In(9,14)*OM314)+OM314*(s.In(2,14)*OM114+s.In(5,14)*OM214+s.In(6,14)*OM314)+s.dpt(3,20)*(Fq115*S15+Fq215*C15));
 ...
 s.In(3,14)*OM114+s.In(6,14)*OM214+s.In(9,14)*OM314)-OM314*(s.In(1,14)*OM114+s.In(2,14)*OM214+s.In(3,14)*OM314)-s.dpt(3,20)*(Fq115*C15-Fq215*S15));
 ...
 s.In(6,13)*OM213+s.In(9,13)*OM313)+OM313*(s.In(2,13)*OM113+s.In(5,13)*OM213+s.In(6,13)*OM313)-s.dpt(2,18)*(Fq214*S14+Fq314*C14));
 ...
 s.In(3,13)*OM113+s.In(6,13)*OM213+s.In(9,13)*OM313)-OM313*(s.In(1,13)*OM113+s.In(2,13)*OM213+s.In(3,13)*OM313));
  Cq313 = -(s.trq(3,13)-s.In(3,13)*OMp113-s.In(6,13)*OMp213-s.In(9,13)*OMp313-Cq214*S14-Cq314*C14+Fq114*s.dpt(2,18)+Fs113*s.l(2,13)-Fs213*...
