...
//
//	==> Generation Date : Mon Jul 14 11:56:56 2014
//
...
// Sensor Kinematics 
 ...
 OMcp20_119*ROcp20_519-OMcp20_219*ROcp20_419);
    RLcp20_121 = ROcp20_720*s->dpt[3][32];
    RLcp20_221 = ROcp20_820*s->dpt[3][32];
    RLcp20_321 = ROcp20_920*s->dpt[3][32];
...
// Sensor Kinematics 
 ...
 OMcp21_119*ROcp21_519-OMcp21_219*ROcp21_419);
    RLcp21_121 = ROcp21_720*s->dpt[3][32];
    RLcp21_221 = ROcp21_820*s->dpt[3][32];
    RLcp21_321 = ROcp21_920*s->dpt[3][32];
...
// Sensor Kinematics 
 ...
 OMcp22_119*ROcp22_519-OMcp22_219*ROcp22_419);
    RLcp22_121 = ROcp22_720*s->dpt[3][32];
    RLcp22_221 = ROcp22_820*s->dpt[3][32];
    RLcp22_321 = ROcp22_920*s->dpt[3][32];
...
// Sensor Kinematics 
 ...
 OMcp23_119*ROcp23_519-OMcp23_219*ROcp23_419);
    RLcp23_121 = ROcp23_720*s->dpt[3][32];
    RLcp23_221 = ROcp23_820*s->dpt[3][32];
    RLcp23_321 = ROcp23_920*s->dpt[3][32];
...
// Sensor Kinematics 
    ...
    RLcp23_124 = ROcp23_423*s->dpt[2][42];
    RLcp23_224 = ROcp23_523*s->dpt[2][42];
    RLcp23_324 = ROcp23_623*s->dpt[2][42];
...
// Sensor Kinematics 
 ...
 OMcp24_119*ROcp24_519-OMcp24_219*ROcp24_419);
    RLcp24_121 = ROcp24_720*s->dpt[3][32];
    RLcp24_221 = ROcp24_820*s->dpt[3][32];
    RLcp24_321 = ROcp24_920*s->dpt[3][32];
...
// Sensor Kinematics 
    ...
    RLcp24_124 = ROcp24_423*s->dpt[2][42];
    RLcp24_224 = ROcp24_523*s->dpt[2][42];
    RLcp24_324 = ROcp24_623*s->dpt[2][42];
    ...
    RLcp24_125 = ROcp24_124*s->dpt[1][44]+ROcp24_423*s->dpt[2][44];
    RLcp24_225 = ROcp24_224*s->dpt[1][44]+ROcp24_523*s->dpt[2][44];
    RLcp24_325 = ROcp24_324*s->dpt[1][44]+ROcp24_623*s->dpt[2][44];
...
// Sensor Kinematics 
 ...
 OMcp25_119*ROcp25_519-OMcp25_219*ROcp25_419);
    RLcp25_121 = ROcp25_720*s->dpt[3][32];
    RLcp25_221 = ROcp25_820*s->dpt[3][32];
    RLcp25_321 = ROcp25_920*s->dpt[3][32];
...
// Sensor Kinematics 
    ...
    RLcp25_123 = ROcp25_421*s->dpt[2][40];
    RLcp25_223 = ROcp25_521*s->dpt[2][40];
    RLcp25_323 = ROcp25_621*s->dpt[2][40];
    ...
    RLcp25_124 = ROcp25_423*s->dpt[2][42];
    RLcp25_224 = ROcp25_523*s->dpt[2][42];
    RLcp25_324 = ROcp25_623*s->dpt[2][42];
    ...
    RLcp25_125 = ROcp25_124*s->dpt[1][44]+ROcp25_423*s->dpt[2][44];
    RLcp25_225 = ROcp25_224*s->dpt[1][44]+ROcp25_523*s->dpt[2][44];
    RLcp25_325 = ROcp25_324*s->dpt[1][44]+ROcp25_623*s->dpt[2][44];
    ...
    RLcp25_126 = ROcp25_125*s->dpt[1][46];
    RLcp25_226 = ROcp25_225*s->dpt[1][46];
    RLcp25_326 = ROcp25_325*s->dpt[1][46];
...
// Sensor Kinematics 
 ...
 OMcp26_119*ROcp26_519-OMcp26_219*ROcp26_419);
    RLcp26_121 = ROcp26_720*s->dpt[3][32];
    RLcp26_221 = ROcp26_820*s->dpt[3][32];
    RLcp26_321 = ROcp26_920*s->dpt[3][32];
...
// Sensor Kinematics 
    ...
    RLcp26_123 = ROcp26_421*s->dpt[2][40];
    RLcp26_223 = ROcp26_521*s->dpt[2][40];
    RLcp26_323 = ROcp26_621*s->dpt[2][40];
    ...
    RLcp26_124 = ROcp26_423*s->dpt[2][42];
    RLcp26_224 = ROcp26_523*s->dpt[2][42];
    RLcp26_324 = ROcp26_623*s->dpt[2][42];
    ...
    RLcp26_125 = ROcp26_124*s->dpt[1][44]+ROcp26_423*s->dpt[2][44];
    RLcp26_225 = ROcp26_224*s->dpt[1][44]+ROcp26_523*s->dpt[2][44];
    RLcp26_325 = ROcp26_324*s->dpt[1][44]+ROcp26_623*s->dpt[2][44];
    ...
    RLcp26_126 = ROcp26_125*s->dpt[1][46];
    RLcp26_226 = ROcp26_225*s->dpt[1][46];
    RLcp26_326 = ROcp26_325*s->dpt[1][46];
    ...
    RLcp26_127 = ROcp26_425*s->dpt[2][47];
    RLcp26_227 = ROcp26_525*s->dpt[2][47];
    RLcp26_327 = ROcp26_625*s->dpt[2][47];
...
// Sensor Kinematics 
 ...
 OMcp27_119*ROcp27_519-OMcp27_219*ROcp27_419);
    RLcp27_121 = ROcp27_720*s->dpt[3][32];
    RLcp27_221 = ROcp27_820*s->dpt[3][32];
    RLcp27_321 = ROcp27_920*s->dpt[3][32];
...
// Sensor Kinematics 
    ...
    RLcp27_123 = ROcp27_421*s->dpt[2][40];
    RLcp27_223 = ROcp27_521*s->dpt[2][40];
    RLcp27_323 = ROcp27_621*s->dpt[2][40];
    ...
    RLcp27_124 = ROcp27_423*s->dpt[2][42];
    RLcp27_224 = ROcp27_523*s->dpt[2][42];
    RLcp27_324 = ROcp27_623*s->dpt[2][42];
    ...
    RLcp27_125 = ROcp27_124*s->dpt[1][44]+ROcp27_423*s->dpt[2][44];
    RLcp27_225 = ROcp27_224*s->dpt[1][44]+ROcp27_523*s->dpt[2][44];
    RLcp27_325 = ROcp27_324*s->dpt[1][44]+ROcp27_623*s->dpt[2][44];
    ...
    RLcp27_126 = ROcp27_125*s->dpt[1][46];
    RLcp27_226 = ROcp27_225*s->dpt[1][46];
    RLcp27_326 = ROcp27_325*s->dpt[1][46];
    ...
    RLcp27_127 = ROcp27_425*s->dpt[2][47];
    RLcp27_227 = ROcp27_525*s->dpt[2][47];
    RLcp27_327 = ROcp27_625*s->dpt[2][47];
...
// Sensor Kinematics 
 ...
 OMcp28_119*ROcp28_519-OMcp28_219*ROcp28_419);
    RLcp28_121 = ROcp28_720*s->dpt[3][32];
    RLcp28_221 = ROcp28_820*s->dpt[3][32];
    RLcp28_321 = ROcp28_920*s->dpt[3][32];
...
// Sensor Kinematics 
 ...
 OMcp29_119*ROcp29_519-OMcp29_219*ROcp29_419);
    RLcp29_121 = ROcp29_720*s->dpt[3][32];
    RLcp29_221 = ROcp29_820*s->dpt[3][32];
    RLcp29_321 = ROcp29_920*s->dpt[3][32];
...
// Sensor Kinematics 
    ...
    RLcp29_130 = ROcp29_421*s->dpt[2][51];
    RLcp29_230 = ROcp29_521*s->dpt[2][51];
    RLcp29_330 = ROcp29_621*s->dpt[2][51];
...
// Sensor Kinematics 
 ...
 OMcp30_119*ROcp30_519-OMcp30_219*ROcp30_419);
    RLcp30_121 = ROcp30_720*s->dpt[3][32];
    RLcp30_221 = ROcp30_820*s->dpt[3][32];
    RLcp30_321 = ROcp30_920*s->dpt[3][32];
...
// Sensor Kinematics 
    ...
    RLcp30_130 = ROcp30_421*s->dpt[2][51];
    RLcp30_230 = ROcp30_521*s->dpt[2][51];
    RLcp30_330 = ROcp30_621*s->dpt[2][51];
    ...
    RLcp30_131 = ROcp30_430*s->dpt[2][53];
    RLcp30_231 = ROcp30_530*s->dpt[2][53];
    RLcp30_331 = ROcp30_630*s->dpt[2][53];
...
// Sensor Kinematics 
    ...
    RLcp31_130 = ROcp31_421*s->dpt[2][51];
    RLcp31_230 = ROcp31_521*s->dpt[2][51];
    RLcp31_330 = ROcp31_621*s->dpt[2][51];
    ...
    RLcp31_131 = ROcp31_430*s->dpt[2][53];
    RLcp31_231 = ROcp31_530*s->dpt[2][53];
    RLcp31_331 = ROcp31_630*s->dpt[2][53];
    ...
    RLcp31_132 = ROcp31_131*s->dpt[1][55]+ROcp31_430*s->dpt[2][55];
    RLcp31_232 = ROcp31_231*s->dpt[1][55]+ROcp31_530*s->dpt[2][55];
    RLcp31_332 = ROcp31_331*s->dpt[1][55]+ROcp31_630*s->dpt[2][55];
...
// Sensor Kinematics 
    ...
    RLcp32_130 = ROcp32_421*s->dpt[2][51];
    RLcp32_230 = ROcp32_521*s->dpt[2][51];
    RLcp32_330 = ROcp32_621*s->dpt[2][51];
    ...
    RLcp32_131 = ROcp32_430*s->dpt[2][53];
    RLcp32_231 = ROcp32_530*s->dpt[2][53];
    RLcp32_331 = ROcp32_630*s->dpt[2][53];
    ...
    RLcp32_132 = ROcp32_131*s->dpt[1][55]+ROcp32_430*s->dpt[2][55];
    RLcp32_232 = ROcp32_231*s->dpt[1][55]+ROcp32_530*s->dpt[2][55];
    RLcp32_332 = ROcp32_331*s->dpt[1][55]+ROcp32_630*s->dpt[2][55];
    ...
    RLcp32_133 = ROcp32_132*s->dpt[1][57];
    RLcp32_233 = ROcp32_232*s->dpt[1][57];
    RLcp32_333 = ROcp32_332*s->dpt[1][57];
...
// Sensor Kinematics 
    ...
    RLcp33_130 = ROcp33_421*s->dpt[2][51];
    RLcp33_230 = ROcp33_521*s->dpt[2][51];
    RLcp33_330 = ROcp33_621*s->dpt[2][51];
    ...
    RLcp33_131 = ROcp33_430*s->dpt[2][53];
    RLcp33_231 = ROcp33_530*s->dpt[2][53];
    RLcp33_331 = ROcp33_630*s->dpt[2][53];
    ...
    RLcp33_132 = ROcp33_131*s->dpt[1][55]+ROcp33_430*s->dpt[2][55];
    RLcp33_232 = ROcp33_231*s->dpt[1][55]+ROcp33_530*s->dpt[2][55];
    RLcp33_332 = ROcp33_331*s->dpt[1][55]+ROcp33_630*s->dpt[2][55];
    ...
    RLcp33_133 = ROcp33_132*s->dpt[1][57];
    RLcp33_233 = ROcp33_232*s->dpt[1][57];
    RLcp33_333 = ROcp33_332*s->dpt[1][57];
    ...
    RLcp33_134 = ROcp33_432*s->dpt[2][58];
    RLcp33_234 = ROcp33_532*s->dpt[2][58];
    RLcp33_334 = ROcp33_632*s->dpt[2][58];
...
// Sensor Kinematics 
    ...
    RLcp34_130 = ROcp34_421*s->dpt[2][51];
    RLcp34_230 = ROcp34_521*s->dpt[2][51];
    RLcp34_330 = ROcp34_621*s->dpt[2][51];
    ...
    RLcp34_131 = ROcp34_430*s->dpt[2][53];
    RLcp34_231 = ROcp34_530*s->dpt[2][53];
    RLcp34_331 = ROcp34_630*s->dpt[2][53];
    ...
    RLcp34_132 = ROcp34_131*s->dpt[1][55]+ROcp34_430*s->dpt[2][55];
    RLcp34_232 = ROcp34_231*s->dpt[1][55]+ROcp34_530*s->dpt[2][55];
    RLcp34_332 = ROcp34_331*s->dpt[1][55]+ROcp34_630*s->dpt[2][55];
    ...
    RLcp34_133 = ROcp34_132*s->dpt[1][57];
    RLcp34_233 = ROcp34_232*s->dpt[1][57];
    RLcp34_333 = ROcp34_332*s->dpt[1][57];
    ...
    RLcp34_134 = ROcp34_432*s->dpt[2][58];
    RLcp34_234 = ROcp34_532*s->dpt[2][58];
    RLcp34_334 = ROcp34_632*s->dpt[2][58];
