...
// Forward Kinematics 
  ...
  ALPHA121 = C21*(ALPHA120+BETA320*s->dpt[3][32])+S21*(ALPHA219+BETA620*s->dpt[3][32]);
  ALPHA221 = C21*(ALPHA219+BETA620*s->dpt[3][32])-S21*(ALPHA120+BETA320*s->dpt[3][32]);
  ALPHA321 = ALPHA320+BS920*s->dpt[3][32];
  ...
  ALPHA122 = C22*(ALPHA121+BETA221*s->dpt[2][36]+BETA321*s->dpt[3][36]+BS121*s->dpt[1][36])-S22*(ALPHA321+BETA721*
 s->dpt[1][36]+BETA821*s->dpt[2][36]+BS921*s->dpt[3][36]);
  ALPHA222 = ALPHA221+BETA421*s->dpt[1][36]+BETA621*s->dpt[3][36]+BS521*s->dpt[2][36];
  ALPHA322 = C22*(ALPHA321+BETA721*s->dpt[1][36]+BETA821*s->dpt[2][36]+BS921*s->dpt[3][36])+S22*(ALPHA121+BETA221*
 s->dpt[2][36]+BETA321*s->dpt[3][36]+BS121*s->dpt[1][36]);
  OM123 = qd[23]+OM122;
  ...
  ALPHA124 = C24*(ALPHA123+BETA223*s->dpt[2][42])-S24*(ALPHA323+BETA823*s->dpt[2][42]);
  ALPHA224 = ALPHA223+BS523*s->dpt[2][42];
  ALPHA324 = C24*(ALPHA323+BETA823*s->dpt[2][42])+S24*(ALPHA123+BETA223*s->dpt[2][42]);
  ...
  ALPHA125 = C25*(ALPHA124+BETA224*s->dpt[2][44]+BS124*s->dpt[1][44])+S25*(ALPHA224+BETA424*s->dpt[1][44]+BS524*
 s->dpt[2][44]);
  ALPHA225 = C25*(ALPHA224+BETA424*s->dpt[1][44]+BS524*s->dpt[2][44])-S25*(ALPHA124+BETA224*s->dpt[2][44]+BS124*
 s->dpt[1][44]);
  ALPHA325 = ALPHA324+BETA724*s->dpt[1][44]+BETA824*s->dpt[2][44];
  ...
  ALPHA126 = C26*(ALPHA125+BS125*s->dpt[1][46])-S26*(ALPHA325+BETA725*s->dpt[1][46]);
  ALPHA226 = ALPHA225+BETA425*s->dpt[1][46];
  ALPHA326 = C26*(ALPHA325+BETA725*s->dpt[1][46])+S26*(ALPHA125+BS125*s->dpt[1][46]);
  ...
  ALPHA127 = C27*(ALPHA126+BETA226*s->dpt[2][47])+S27*(ALPHA226+BS526*s->dpt[2][47]);
  ALPHA227 = C27*(ALPHA226+BS526*s->dpt[2][47])-S27*(ALPHA126+BETA226*s->dpt[2][47]);
  ALPHA327 = ALPHA326+BETA826*s->dpt[2][47];
  OM128 = qd[28]+OM127;
  ...
  ALPHA129 = C29*(ALPHA121+BETA221*s->dpt[2][37]+BETA321*s->dpt[3][37]+BS121*s->dpt[1][37])-S29*(ALPHA321+BETA721*
 s->dpt[1][37]+BETA821*s->dpt[2][37]+BS921*s->dpt[3][37]);
  ALPHA229 = ALPHA221+BETA421*s->dpt[1][37]+BETA621*s->dpt[3][37]+BS521*s->dpt[2][37];
  ALPHA329 = C29*(ALPHA321+BETA721*s->dpt[1][37]+BETA821*s->dpt[2][37]+BS921*s->dpt[3][37])+S29*(ALPHA121+BETA221*
 s->dpt[2][37]+BETA321*s->dpt[3][37]+BS121*s->dpt[1][37]);
  ...
  ALPHA130 = ALPHA129+BETA229*s->dpt[2][51];
  ALPHA230 = C30*(ALPHA229+BS529*s->dpt[2][51])+S30*(ALPHA329+BETA829*s->dpt[2][51]);
  ALPHA330 = C30*(ALPHA329+BETA829*s->dpt[2][51])-S30*(ALPHA229+BS529*s->dpt[2][51]);
  ...
  ALPHA131 = C31*(ALPHA130+BETA230*s->dpt[2][53])-S31*(ALPHA330+BETA830*s->dpt[2][53]);
  ALPHA231 = ALPHA230+BS530*s->dpt[2][53];
  ALPHA331 = C31*(ALPHA330+BETA830*s->dpt[2][53])+S31*(ALPHA130+BETA230*s->dpt[2][53]);
  ...
  ALPHA132 = C32*(ALPHA131+BETA231*s->dpt[2][55]+BS131*s->dpt[1][55])+S32*(ALPHA231+BETA431*s->dpt[1][55]+BS531*
 s->dpt[2][55]);
  ALPHA232 = C32*(ALPHA231+BETA431*s->dpt[1][55]+BS531*s->dpt[2][55])-S32*(ALPHA131+BETA231*s->dpt[2][55]+BS131*
 s->dpt[1][55]);
  ALPHA332 = ALPHA331+BETA731*s->dpt[1][55]+BETA831*s->dpt[2][55];
  ...
  ALPHA133 = C33*(ALPHA132+BS132*s->dpt[1][57])-S33*(ALPHA332+BETA732*s->dpt[1][57]);
  ALPHA233 = ALPHA232+s->dpt[1][57]*(BS232+OMp332);
  ALPHA333 = C33*(ALPHA332+BETA732*s->dpt[1][57])+S33*(ALPHA132+BS132*s->dpt[1][57]);
  ...
  ALPHA134 = C34*(ALPHA133+BETA233*s->dpt[2][58])+S34*(ALPHA233+BS533*s->dpt[2][58]);
  ALPHA234 = C34*(ALPHA233+BS533*s->dpt[2][58])-S34*(ALPHA133+BETA233*s->dpt[2][58]);
  ALPHA334 = ALPHA333+BETA833*s->dpt[2][58];
  OM135 = qd[35]+OM134;
...
// Backward Dynamics 
 ...
 s->In[5][35]));
  ...
  Fq333 = Fq334+Fs333;
  Cq133 = -(s->trq[1][33]-s->In[1][33]*OMp133-Cq134*C34+Cq234*S34-Fq334*s->dpt[2][58]-Fs333*s->l[2][33]+OM233*OM333*(
 s->In[5][33]-s->In[9][33]));
 ...
 s->dpt[2][58]*(Fq134*C34-Fq234*S34));
  ...
  Cq132 = -(s->trq[1][32]-s->In[1][32]*OMp132-Cq133*C33-Cq333*S33-Fs332*s->l[2][32]+OM232*OM332*(s->In[5][32]-
 s->In[9][32]));
  Cq232 = -(s->trq[2][32]-Cq233-s->In[5][32]*OMp232-OM132*OM332*(s->In[1][32]-s->In[9][32])-s->dpt[1][57]*(Fq133*S33-
 Fq333*C33));
  Cq332 = -(s->trq[3][32]-s->In[9][32]*OMp332+Cq133*S33-Cq333*C33-Fq233*s->dpt[1][57]+Fs132*s->l[2][32]+OM132*OM232*(
 s->In[1][32]-s->In[5][32]));
 ...
 OM231)));
  ...
  Fq331 = Fq332+Fs331;
  Cq131 = -(s->trq[1][31]-s->In[1][31]*OMp131-Cq132*C32+Cq232*S32-Fq332*s->dpt[2][55]+Fs231*s->l[3][31]-Fs331*
 s->l[2][31]+OM231*OM331*(s->In[5][31]-s->In[9][31]));
  Cq231 = -(s->trq[2][31]-s->In[5][31]*OMp231-Cq132*S32-Cq232*C32+Fq332*s->dpt[1][55]-Fs131*s->l[3][31]+Fs331*
 s->l[1][31]-OM131*OM331*(s->In[1][31]-s->In[9][31]));
  Cq331 = -(s->trq[3][31]-Cq332-s->In[9][31]*OMp331+Fs131*s->l[2][31]-Fs231*s->l[1][31]+OM131*OM231*(s->In[1][31]-
 s->In[5][31])-s->dpt[1][55]*(Fq132*S32+Fq232*C32)+s->dpt[2][55]*(Fq132*C32-Fq232*S32));
 ...
 OM230*OM230)));
  ...
  Cq130 = -(s->trq[1][30]-s->In[1][30]*OMp130-Cq131*C31-Cq331*S31+Fs230*s->l[3][30]-Fs330*s->l[2][30]+OM230*OM330*(
 s->In[5][30]-s->In[9][30])+s->dpt[2][53]*(Fq131*S31-Fq331*C31));
  Cq230 = -(s->trq[2][30]-Cq231-s->In[5][30]*OMp230-Fs130*s->l[3][30]+Fs330*s->l[1][30]-OM130*OM330*(s->In[1][30]-
 s->In[9][30]));
  Cq330 = -(s->trq[3][30]-s->In[9][30]*OMp330+Cq131*S31-Cq331*C31+Fs130*s->l[2][30]-Fs230*s->l[1][30]+OM130*OM230*(
 s->In[1][30]-s->In[5][30])+s->dpt[2][53]*(Fq131*C31+Fq331*S31));
 ...
 OM229*OM229)));
  ...
  Cq129 = -(s->trq[1][29]-Cq130-s->In[1][29]*OMp129+Fs229*s->l[3][29]-Fs329*s->l[2][29]+OM229*OM329*(s->In[5][29]-
 s->In[9][29])-s->dpt[2][51]*(Fq230*S30+Fq330*C30));
  Cq229 = -(s->trq[2][29]-s->In[5][29]*OMp229-Cq230*C30+Cq330*S30-Fs129*s->l[3][29]+Fs329*s->l[1][29]-OM129*OM329*(
 s->In[1][29]-s->In[9][29]));
  Cq329 = -(s->trq[3][29]-s->In[9][29]*OMp329-Cq230*S30-Cq330*C30+Fq130*s->dpt[2][51]+Fs129*s->l[2][29]-Fs229*
 s->l[1][29]+OM129*OM229*(s->In[1][29]-s->In[5][29]));
 ...
 s->In[5][28]));
  ...
  Fq326 = Fq327+Fs326;
  Cq126 = -(s->trq[1][26]-s->In[1][26]*OMp126-Cq127*C27+Cq227*S27-Fq327*s->dpt[2][47]-Fs326*s->l[2][26]+OM226*OM326*(
 s->In[5][26]-s->In[9][26]));
 ...
 s->dpt[2][47]*(Fq127*C27-Fq227*S27));
 ...
 OM225*OM225)));
  ...
  Cq125 = -(s->trq[1][25]-s->In[1][25]*OMp125-Cq126*C26-Cq326*S26+Fs225*s->l[3][25]-Fs325*s->l[2][25]+OM225*OM325*(
 s->In[5][25]-s->In[9][25]));
  Cq225 = -(s->trq[2][25]-Cq226-s->In[5][25]*OMp225-Fs125*s->l[3][25]+Fs325*s->l[1][25]-OM125*OM325*(s->In[1][25]-
 s->In[9][25])-s->dpt[1][46]*(Fq126*S26-Fq326*C26));
  Cq325 = -(s->trq[3][25]-s->In[9][25]*OMp325+Cq126*S26-Cq326*C26-Fq226*s->dpt[1][46]+Fs125*s->l[2][25]-Fs225*
 s->l[1][25]+OM125*OM225*(s->In[1][25]-s->In[5][25]));
  Fs124 = -(s->frc[1][24]-s->m[24]*(ALPHA124+BETA224*s->l[2][24]+BS124*s->l[1][24]+s->l[3][24]*(BS324+OMp224)));
  Fs224 = -(s->frc[2][24]-s->m[24]*(ALPHA224+BETA424*s->l[1][24]+BS524*s->l[2][24]+s->l[3][24]*(BS624-OMp124)));
  Fs324 = -(s->frc[3][24]-s->m[24]*(ALPHA324+BETA724*s->l[1][24]+BETA824*s->l[2][24]-s->l[3][24]*(OM124*OM124+OM224*
 OM224)));
  Fq124 = Fs124+Fq125*C25-Fq225*S25;
  Fq324 = Fq325+Fs324;
  Cq124 = -(s->trq[1][24]-s->In[1][24]*OMp124-Cq125*C25+Cq225*S25-Fq325*s->dpt[2][44]+Fs224*s->l[3][24]-Fs324*
 s->l[2][24]+OM224*OM324*(s->In[5][24]-s->In[9][24]));
  Cq224 = -(s->trq[2][24]-s->In[5][24]*OMp224-Cq125*S25-Cq225*C25+Fq325*s->dpt[1][44]-Fs124*s->l[3][24]+Fs324*
 s->l[1][24]-OM124*OM324*(s->In[1][24]-s->In[9][24]));
  Cq324 = -(s->trq[3][24]-Cq325-s->In[9][24]*OMp324+Fs124*s->l[2][24]-Fs224*s->l[1][24]+OM124*OM224*(s->In[1][24]-
 s->In[5][24])-s->dpt[1][44]*(Fq125*S25+Fq225*C25)+s->dpt[2][44]*(Fq125*C25-Fq225*S25));
  ...
  Cq123 = -(s->trq[1][23]-s->In[1][23]*OMp123-Cq124*C24-Cq324*S24-Fs323*s->l[2][23]+OM223*OM323*(s->In[5][23]-
 s->In[9][23])+s->dpt[2][42]*(Fq124*S24-Fq324*C24));
  Cq223 = -(s->trq[2][23]-Cq224-s->In[5][23]*OMp223+Fs323*s->l[1][23]-OM123*OM323*(s->In[1][23]-s->In[9][23]));
  Cq323 = -(s->trq[3][23]-s->In[9][23]*OMp323+Cq124*S24-Cq324*C24+Fs123*s->l[2][23]-Fs223*s->l[1][23]+OM123*OM223*(
 s->In[1][23]-s->In[5][23])+s->dpt[2][42]*(Fq124*C24+Fq324*S24));
 ...
 OM222*OM222)));
  ...
  Cq122 = -(s->trq[1][22]-Cq123-s->In[1][22]*OMp122+Fs222*s->l[3][22]-Fs322*s->l[2][22]+OM222*OM322*(s->In[5][22]-
 s->In[9][22])-s->dpt[2][40]*(Fq223*S23+Fq323*C23));
  Cq222 = -(s->trq[2][22]-s->In[5][22]*OMp222-Cq223*C23+Cq323*S23-Fs122*s->l[3][22]+Fs322*s->l[1][22]-OM122*OM322*(
 s->In[1][22]-s->In[9][22]));
  Cq322 = -(s->trq[3][22]-s->In[9][22]*OMp322-Cq223*S23-Cq323*C23+Fq123*s->dpt[2][40]+Fs122*s->l[2][22]-Fs222*
 s->l[1][22]+OM122*OM222*(s->In[1][22]-s->In[5][22]));
 ...
 Cq329*S29+Fq222*s->dpt[3][36]+Fq229*s->dpt[3][37]+Fs221*s->l[3][21]-Fs321*s->l[2][21]-OM221*(s->In[3][21]*OM121+s->In[6][21]
 *OM221+s->In[9][21]*OM321)+OM321*(s->In[2][21]*OM121+s->In[5][21]*OM221+s->In[6][21]*OM321)+s->dpt[2][36]*(Fq122*S22-Fq322*
 C22)+s->dpt[2][37]*(Fq129*S29-Fq329*C29));
 ...
 OM221+s->In[3][21]*OM321)-s->dpt[1][36]*(Fq122*S22-Fq322*C22)-s->dpt[1][37]*(Fq129*S29-Fq329*C29)-s->dpt[3][36]*(Fq122*C22+
 Fq322*S22)-s->dpt[3][37]*(Fq129*C29+Fq329*S29));
  Cq321 = -(s->trq[3][21]-s->In[3][21]*OMp121-s->In[6][21]*OMp221-s->In[9][21]*OMp321+Cq122*S22+Cq129*S29-Cq322*C22-
 Cq329*C29-Fq222*s->dpt[1][36]-Fq229*s->dpt[1][37]+Fs121*s->l[2][21]-Fs221*s->l[1][21]-OM121*(s->In[2][21]*OM121+s->In[5][21]
 *OM221+s->In[6][21]*OM321)+OM221*(s->In[1][21]*OM121+s->In[2][21]*OM221+s->In[3][21]*OM321)+s->dpt[2][36]*(Fq122*C22+Fq322*
 S22)+s->dpt[2][37]*(Fq129*C29+Fq329*S29));
 ...
 s->In[5][20]*OM220+s->In[6][20]*OM320)+s->dpt[3][32]*(Fq121*S21+Fq221*C21));
 ...
 s->In[2][20]*OM220+s->In[3][20]*OM320)-s->dpt[3][32]*(Fq121*C21-Fq221*S21));
 ...
 s->In[6][16]*OM316)+s->dpt[3][24]*(Fq217*C17-Fq317*S17));
  Cq216 = -(s->trq[2][16]-s->In[2][16]*OMp116-s->In[5][16]*OMp216-s->In[6][16]*OMp316-Cq217*C17+Cq317*S17-Fq117*
 s->dpt[3][24]-Fs116*s->l[3][16]+Fs316*s->l[1][16]+OM116*(s->In[3][16]*OM116+s->In[6][16]*OM216+s->In[9][16]*OM316)-OM316*(
 ...
 s->dpt[3][22]+Fs215*s->l[3][15]-Fs315*s->l[2][15]-OM215*(s->In[3][15]*OM115+s->In[6][15]*OM215+s->In[9][15]*OM315)+OM315*(
 ...
 s->In[3][15]*OM315)-s->dpt[3][22]*(Fq116*C16+Fq316*S16));
 ...
 s->In[5][14]*OM214+s->In[6][14]*OM314)+s->dpt[3][20]*(Fq115*S15+Fq215*C15));
 ...
 s->In[2][14]*OM214+s->In[3][14]*OM314)-s->dpt[3][20]*(Fq115*C15-Fq215*S15));
 ...
 s->In[6][13]*OM313)-s->dpt[2][18]*(Fq214*S14+Fq314*C14));
 ...
 s->dpt[2][18]+Fs113*s->l[2][13]-Fs213*s->l[1][13]-OM113*(s->In[2][13]*OM113+s->In[5][13]*OM213+s->In[6][13]*OM313)+OM213*(
