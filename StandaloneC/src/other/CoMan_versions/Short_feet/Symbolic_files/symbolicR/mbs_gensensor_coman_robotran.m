...
%
%	==> Generation Date : Sun Jul  6 20:46:12 2014
%
...
% Sensor Kinematics 
    ...
    RLcp13_114 = ROcp13_46*s.dpt(2,18);
    RLcp13_214 = ROcp13_56*s.dpt(2,18);
    RLcp13_314 = ROcp13_66*s.dpt(2,18);
...
% Sensor Kinematics 
    ...
    RLcp14_114 = ROcp14_46*s.dpt(2,18);
    RLcp14_214 = ROcp14_56*s.dpt(2,18);
    RLcp14_314 = ROcp14_66*s.dpt(2,18);
    ...
    RLcp14_115 = ROcp14_714*s.dpt(3,20);
    RLcp14_215 = ROcp14_814*s.dpt(3,20);
    RLcp14_315 = ROcp14_914*s.dpt(3,20);
...
% Sensor Kinematics 
    ...
    RLcp15_114 = ROcp15_46*s.dpt(2,18);
    RLcp15_214 = ROcp15_56*s.dpt(2,18);
    RLcp15_314 = ROcp15_66*s.dpt(2,18);
    ...
    RLcp15_115 = ROcp15_714*s.dpt(3,20);
    RLcp15_215 = ROcp15_814*s.dpt(3,20);
    RLcp15_315 = ROcp15_914*s.dpt(3,20);
    ...
    RLcp15_116 = ROcp15_714*s.dpt(3,22);
    RLcp15_216 = ROcp15_814*s.dpt(3,22);
    RLcp15_316 = ROcp15_914*s.dpt(3,22);
...
% Sensor Kinematics 
    ...
    RLcp16_114 = ROcp16_46*s.dpt(2,18);
    RLcp16_214 = ROcp16_56*s.dpt(2,18);
    RLcp16_314 = ROcp16_66*s.dpt(2,18);
    ...
    RLcp16_115 = ROcp16_714*s.dpt(3,20);
    RLcp16_215 = ROcp16_814*s.dpt(3,20);
    RLcp16_315 = ROcp16_914*s.dpt(3,20);
    ...
    RLcp16_116 = ROcp16_714*s.dpt(3,22);
    RLcp16_216 = ROcp16_814*s.dpt(3,22);
    RLcp16_316 = ROcp16_914*s.dpt(3,22);
    ...
    RLcp16_117 = ROcp16_716*s.dpt(3,24);
    RLcp16_217 = ROcp16_816*s.dpt(3,24);
    RLcp16_317 = ROcp16_916*s.dpt(3,24);
...
% Sensor Kinematics 
    ...
    RLcp17_114 = ROcp17_46*s.dpt(2,18);
    RLcp17_214 = ROcp17_56*s.dpt(2,18);
    RLcp17_314 = ROcp17_66*s.dpt(2,18);
    ...
    RLcp17_115 = ROcp17_714*s.dpt(3,20);
    RLcp17_215 = ROcp17_814*s.dpt(3,20);
    RLcp17_315 = ROcp17_914*s.dpt(3,20);
    ...
    RLcp17_116 = ROcp17_714*s.dpt(3,22);
    RLcp17_216 = ROcp17_814*s.dpt(3,22);
    RLcp17_316 = ROcp17_914*s.dpt(3,22);
    ...
    RLcp17_117 = ROcp17_716*s.dpt(3,24);
    RLcp17_217 = ROcp17_816*s.dpt(3,24);
    RLcp17_317 = ROcp17_916*s.dpt(3,24);
...
% Sensor Kinematics 
 ...
 OMcp20_219*ROcp20_419);
    RLcp20_121 = ROcp20_720*s.dpt(3,33);
    RLcp20_221 = ROcp20_820*s.dpt(3,33);
    RLcp20_321 = ROcp20_920*s.dpt(3,33);
...
% Sensor Kinematics 
 ...
 OMcp21_219*ROcp21_419);
    RLcp21_121 = ROcp21_720*s.dpt(3,33);
    RLcp21_221 = ROcp21_820*s.dpt(3,33);
    RLcp21_321 = ROcp21_920*s.dpt(3,33);
...
% Sensor Kinematics 
    ...
    RLcp21_122 = ROcp21_121*s.dpt(1,37)+ROcp21_421*s.dpt(2,37)+ROcp21_720*s.dpt(3,37);
    RLcp21_222 = ROcp21_221*s.dpt(1,37)+ROcp21_521*s.dpt(2,37)+ROcp21_820*s.dpt(3,37);
    RLcp21_322 = ROcp21_321*s.dpt(1,37)+ROcp21_621*s.dpt(2,37)+ROcp21_920*s.dpt(3,37);
...
% Sensor Kinematics 
 ...
 OMcp22_219*ROcp22_419);
    RLcp22_121 = ROcp22_720*s.dpt(3,33);
    RLcp22_221 = ROcp22_820*s.dpt(3,33);
    RLcp22_321 = ROcp22_920*s.dpt(3,33);
...
% Sensor Kinematics 
    ...
    RLcp22_122 = ROcp22_121*s.dpt(1,37)+ROcp22_421*s.dpt(2,37)+ROcp22_720*s.dpt(3,37);
    RLcp22_222 = ROcp22_221*s.dpt(1,37)+ROcp22_521*s.dpt(2,37)+ROcp22_820*s.dpt(3,37);
    RLcp22_322 = ROcp22_321*s.dpt(1,37)+ROcp22_621*s.dpt(2,37)+ROcp22_920*s.dpt(3,37);
    ...
    RLcp22_123 = ROcp22_421*s.dpt(2,40);
    RLcp22_223 = ROcp22_521*s.dpt(2,40);
    RLcp22_323 = ROcp22_621*s.dpt(2,40);
...
% Sensor Kinematics 
 ...
 OMcp23_219*ROcp23_419);
    RLcp23_121 = ROcp23_720*s.dpt(3,33);
    RLcp23_221 = ROcp23_820*s.dpt(3,33);
    RLcp23_321 = ROcp23_920*s.dpt(3,33);
...
% Sensor Kinematics 
    ...
    RLcp23_122 = ROcp23_121*s.dpt(1,37)+ROcp23_421*s.dpt(2,37)+ROcp23_720*s.dpt(3,37);
    RLcp23_222 = ROcp23_221*s.dpt(1,37)+ROcp23_521*s.dpt(2,37)+ROcp23_820*s.dpt(3,37);
    RLcp23_322 = ROcp23_321*s.dpt(1,37)+ROcp23_621*s.dpt(2,37)+ROcp23_920*s.dpt(3,37);
    ...
    RLcp23_123 = ROcp23_421*s.dpt(2,40);
    RLcp23_223 = ROcp23_521*s.dpt(2,40);
    RLcp23_323 = ROcp23_621*s.dpt(2,40);
    ...
    RLcp23_124 = ROcp23_723*s.dpt(3,42);
    RLcp23_224 = ROcp23_823*s.dpt(3,42);
    RLcp23_324 = ROcp23_923*s.dpt(3,42);
...
% Sensor Kinematics 
 ...
 OMcp24_219*ROcp24_419);
    RLcp24_121 = ROcp24_720*s.dpt(3,33);
    RLcp24_221 = ROcp24_820*s.dpt(3,33);
    RLcp24_321 = ROcp24_920*s.dpt(3,33);
...
% Sensor Kinematics 
    ...
    RLcp24_122 = ROcp24_121*s.dpt(1,37)+ROcp24_421*s.dpt(2,37)+ROcp24_720*s.dpt(3,37);
    RLcp24_222 = ROcp24_221*s.dpt(1,37)+ROcp24_521*s.dpt(2,37)+ROcp24_820*s.dpt(3,37);
    RLcp24_322 = ROcp24_321*s.dpt(1,37)+ROcp24_621*s.dpt(2,37)+ROcp24_920*s.dpt(3,37);
    ...
    RLcp24_123 = ROcp24_421*s.dpt(2,40);
    RLcp24_223 = ROcp24_521*s.dpt(2,40);
    RLcp24_323 = ROcp24_621*s.dpt(2,40);
    ...
    RLcp24_124 = ROcp24_723*s.dpt(3,42);
    RLcp24_224 = ROcp24_823*s.dpt(3,42);
    RLcp24_324 = ROcp24_923*s.dpt(3,42);
    ...
    RLcp24_125 = ROcp24_723*s.dpt(3,44);
    RLcp24_225 = ROcp24_823*s.dpt(3,44);
    RLcp24_325 = ROcp24_923*s.dpt(3,44);
...
% Sensor Kinematics 
 ...
 OMcp25_219*ROcp25_419);
    RLcp25_121 = ROcp25_720*s.dpt(3,33);
    RLcp25_221 = ROcp25_820*s.dpt(3,33);
    RLcp25_321 = ROcp25_920*s.dpt(3,33);
...
% Sensor Kinematics 
    ...
    RLcp25_126 = ROcp25_121*s.dpt(1,38)+ROcp25_421*s.dpt(2,38)+ROcp25_720*s.dpt(3,38);
    RLcp25_226 = ROcp25_221*s.dpt(1,38)+ROcp25_521*s.dpt(2,38)+ROcp25_820*s.dpt(3,38);
    RLcp25_326 = ROcp25_321*s.dpt(1,38)+ROcp25_621*s.dpt(2,38)+ROcp25_920*s.dpt(3,38);
...
% Sensor Kinematics 
 ...
 OMcp26_219*ROcp26_419);
    RLcp26_121 = ROcp26_720*s.dpt(3,33);
    RLcp26_221 = ROcp26_820*s.dpt(3,33);
    RLcp26_321 = ROcp26_920*s.dpt(3,33);
...
% Sensor Kinematics 
    ...
    RLcp26_126 = ROcp26_121*s.dpt(1,38)+ROcp26_421*s.dpt(2,38)+ROcp26_720*s.dpt(3,38);
    RLcp26_226 = ROcp26_221*s.dpt(1,38)+ROcp26_521*s.dpt(2,38)+ROcp26_820*s.dpt(3,38);
    RLcp26_326 = ROcp26_321*s.dpt(1,38)+ROcp26_621*s.dpt(2,38)+ROcp26_920*s.dpt(3,38);
    ...
    RLcp26_127 = ROcp26_421*s.dpt(2,48);
    RLcp26_227 = ROcp26_521*s.dpt(2,48);
    RLcp26_327 = ROcp26_621*s.dpt(2,48);
...
% Sensor Kinematics 
 ...
 OMcp27_219*ROcp27_419);
    RLcp27_121 = ROcp27_720*s.dpt(3,33);
    RLcp27_221 = ROcp27_820*s.dpt(3,33);
    RLcp27_321 = ROcp27_920*s.dpt(3,33);
...
% Sensor Kinematics 
    ...
    RLcp27_126 = ROcp27_121*s.dpt(1,38)+ROcp27_421*s.dpt(2,38)+ROcp27_720*s.dpt(3,38);
    RLcp27_226 = ROcp27_221*s.dpt(1,38)+ROcp27_521*s.dpt(2,38)+ROcp27_820*s.dpt(3,38);
    RLcp27_326 = ROcp27_321*s.dpt(1,38)+ROcp27_621*s.dpt(2,38)+ROcp27_920*s.dpt(3,38);
    ...
    RLcp27_127 = ROcp27_421*s.dpt(2,48);
    RLcp27_227 = ROcp27_521*s.dpt(2,48);
    RLcp27_327 = ROcp27_621*s.dpt(2,48);
    ...
    RLcp27_128 = ROcp27_727*s.dpt(3,50);
    RLcp27_228 = ROcp27_827*s.dpt(3,50);
    RLcp27_328 = ROcp27_927*s.dpt(3,50);
...
% Sensor Kinematics 
 ...
 OMcp28_219*ROcp28_419);
    RLcp28_121 = ROcp28_720*s.dpt(3,33);
    RLcp28_221 = ROcp28_820*s.dpt(3,33);
    RLcp28_321 = ROcp28_920*s.dpt(3,33);
...
% Sensor Kinematics 
    ...
    RLcp28_126 = ROcp28_121*s.dpt(1,38)+ROcp28_421*s.dpt(2,38)+ROcp28_720*s.dpt(3,38);
    RLcp28_226 = ROcp28_221*s.dpt(1,38)+ROcp28_521*s.dpt(2,38)+ROcp28_820*s.dpt(3,38);
    RLcp28_326 = ROcp28_321*s.dpt(1,38)+ROcp28_621*s.dpt(2,38)+ROcp28_920*s.dpt(3,38);
    ...
    RLcp28_127 = ROcp28_421*s.dpt(2,48);
    RLcp28_227 = ROcp28_521*s.dpt(2,48);
    RLcp28_327 = ROcp28_621*s.dpt(2,48);
    ...
    RLcp28_128 = ROcp28_727*s.dpt(3,50);
    RLcp28_228 = ROcp28_827*s.dpt(3,50);
    RLcp28_328 = ROcp28_927*s.dpt(3,50);
    ...
    RLcp28_129 = ROcp28_727*s.dpt(3,52);
    RLcp28_229 = ROcp28_827*s.dpt(3,52);
    RLcp28_329 = ROcp28_927*s.dpt(3,52);
