...
//
//	==> Generation Date : Sun Jul  6 20:46:11 2014
//
...
//
//	==> Generation Time :  0.320 seconds
//	==> Post-Processing :  0.410 seconds
//
//-------------------------------------------------------------
//
...
// Backward Dynamics 
 ...
 OM212)));
  ...
  FB112_10 = s->m[12]*(s->dpt[3][12]*C12+s->l[3][12]*C11);
  FB212_10 = -s->m[12]*(OpM112_10*s->l[3][12]-OpM312_10*s->l[1][12]);
  FB312_10 = s->m[12]*(s->dpt[3][12]*S12-s->l[1][12]*C11);
...
// Backward Dynamics 
 ...
 OM218)));
  ...
  FB118_16 = s->m[18]*(s->dpt[3][24]*C18+s->l[3][18]*C17);
  FB218_16 = -s->m[18]*(OpM118_16*s->l[3][18]-OpM318_16*s->l[1][18]);
  FB318_16 = s->m[18]*(s->dpt[3][24]*S18-s->l[1][18]*C17);
