...
%
%	==> Generation Date : Sun Jul  6 20:46:09 2014
%
...
% Backward Dynamics 
  ...
  FA112 = -(s.frc(1,12)-s.m(12)*(AlF111*C12-AlF311*S12-s.l(1,12)*(OM212*OM212+OM312*OM312)+s.l(3,12)*(BS312+OpF211)));
  FA212 = -(s.frc(2,12)-s.m(12)*(AlF211+s.l(1,12)*(OpF312+OM112*OM212)-s.l(3,12)*(OpF112-OM212*OM312)));
  FA312 = -(s.frc(3,12)-s.m(12)*(AlF111*S12+AlF311*C12+s.l(1,12)*(BS312-OpF211)-s.l(3,12)*(OM112*OM112+OM212*OM212)));
 ...
 *(s.In(1,11)*OM111+s.In(2,11)*OM211+s.In(3,11)*OM311));
 ...
 s.In(5,11)*OM211)+OM211*(s.In(1,11)*OM111+s.In(2,11)*OM211+s.In(3,11)*OM311));
  ...
  CM111_11 = s.In(1,11)+s.m(11)*s.l(2,11)*s.l(2,11)+s.m(11)*s.l(3,11)*s.l(3,11)+C12*(s.In(1,12)*C12-FB212_11*s.l(3,12))+S12*(s.In(9,12)*S12+...
 FB212_11*s.l(1,12));
...
% Backward Dynamics 
  ...
  FA118 = -(s.frc(1,18)-s.m(18)*(AlF117*C18-AlF317*S18-s.l(1,18)*(OM218*OM218+OM318*OM318)+s.l(3,18)*(BS318+OpF217)));
  FA218 = -(s.frc(2,18)-s.m(18)*(AlF217+s.l(1,18)*(OpF318+OM118*OM218)-s.l(3,18)*(OpF118-OM218*OM318)));
  FA318 = -(s.frc(3,18)-s.m(18)*(AlF117*S18+AlF317*C18+s.l(1,18)*(BS318-OpF217)-s.l(3,18)*(OM118*OM118+OM218*OM218)));
 ...
 s.In(5,17)*OM217+s.In(6,17)*OM317)+OM217*(s.In(1,17)*OM117+s.In(3,17)*OM317));
  ...
  CM117_17 = s.In(1,17)+s.m(17)*s.l(2,17)*s.l(2,17)+s.m(17)*s.l(3,17)*s.l(3,17)+C18*(s.In(1,18)*C18-FB218_17*s.l(3,18))+S18*(s.In(9,18)*S18+...
 FB218_17*s.l(1,18));
