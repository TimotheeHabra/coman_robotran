...
#include "mbs_invdyna_coman_robotran.h" 
#define q s->q 
#define qd s->qd 
#define qdd s->qdd 
...
// Forward Kinematics 
  ...
  ALPHA114 = ALPHA113+BETA213*s->dpt[2][18];
  ...
  ALPHA115 = C15*(ALPHA114+BETA314*s->dpt[3][20])+S15*(ALPHA214+BETA614*s->dpt[3][20]);
  ALPHA215 = C15*(ALPHA214+BETA614*s->dpt[3][20])-S15*(ALPHA114+BETA314*s->dpt[3][20]);
  ALPHA315 = ALPHA314+BS914*s->dpt[3][20];
  ...
  ALPHA116 = C16*(ALPHA115+BETA315*s->dpt[3][22])-S16*(ALPHA315+BS915*s->dpt[3][22]);
  ALPHA216 = ALPHA215+BETA615*s->dpt[3][22];
  ALPHA316 = C16*(ALPHA315+BS915*s->dpt[3][22])+S16*(ALPHA115+BETA315*s->dpt[3][22]);
  OM117 = qd[17]+OM116;
  ...
  BS317 = OM117*OM317;
  BS617 = OM217*OM317;
  ALPHA117 = ALPHA116+BETA316*s->dpt[3][24];
  ALPHA217 = C17*(ALPHA216+BETA616*s->dpt[3][24])+S17*(ALPHA316+BS916*s->dpt[3][24]);
  ALPHA317 = C17*(ALPHA316+BS916*s->dpt[3][24])-S17*(ALPHA216+BETA616*s->dpt[3][24]);
  ...
  ALPHA121 = C21*(ALPHA120+BETA320*s->dpt[3][33])+S21*(ALPHA219+BETA620*s->dpt[3][33]);
  ALPHA221 = C21*(ALPHA219+BETA620*s->dpt[3][33])-S21*(ALPHA120+BETA320*s->dpt[3][33]);
  ALPHA321 = ALPHA320+BS920*s->dpt[3][33];
  ...
  ALPHA122 = C22*(ALPHA121+BETA221*s->dpt[2][37]+BETA321*s->dpt[3][37]+BS121*s->dpt[1][37])-S22*(ALPHA321+BETA721*
 s->dpt[1][37]+BETA821*s->dpt[2][37]+BS921*s->dpt[3][37]);
  ALPHA222 = ALPHA221+BETA421*s->dpt[1][37]+BETA621*s->dpt[3][37]+BS521*s->dpt[2][37];
  ALPHA322 = C22*(ALPHA321+BETA721*s->dpt[1][37]+BETA821*s->dpt[2][37]+BS921*s->dpt[3][37])+S22*(ALPHA121+BETA221*
 s->dpt[2][37]+BETA321*s->dpt[3][37]+BS121*s->dpt[1][37]);
  OM123 = qd[23]+OM122;
  ...
  ALPHA123 = ALPHA122+BETA222*s->dpt[2][40];
  ALPHA223 = C23*(ALPHA222+BS522*s->dpt[2][40])+S23*(ALPHA322+BETA822*s->dpt[2][40]);
  ALPHA323 = C23*(ALPHA322+BETA822*s->dpt[2][40])-S23*(ALPHA222+BS522*s->dpt[2][40]);
  ...
  ALPHA124 = C24*(ALPHA123+BETA323*s->dpt[3][42])+S24*(ALPHA223+BETA623*s->dpt[3][42]);
  ALPHA224 = C24*(ALPHA223+BETA623*s->dpt[3][42])-S24*(ALPHA123+BETA323*s->dpt[3][42]);
  ALPHA324 = ALPHA323+BS923*s->dpt[3][42];
  ...
  ALPHA126 = C26*(ALPHA121+BETA221*s->dpt[2][38]+BETA321*s->dpt[3][38]+BS121*s->dpt[1][38])-S26*(ALPHA321+BETA721*
 s->dpt[1][38]+BETA821*s->dpt[2][38]+BS921*s->dpt[3][38]);
  ALPHA226 = ALPHA221+BETA421*s->dpt[1][38]+BETA621*s->dpt[3][38]+BS521*s->dpt[2][38];
  ALPHA326 = C26*(ALPHA321+BETA721*s->dpt[1][38]+BETA821*s->dpt[2][38]+BS921*s->dpt[3][38])+S26*(ALPHA121+BETA221*
 s->dpt[2][38]+BETA321*s->dpt[3][38]+BS121*s->dpt[1][38]);
  OM127 = qd[27]+OM126;
  ...
  ALPHA127 = ALPHA126+BETA226*s->dpt[2][48];
  ALPHA227 = C27*(ALPHA226+BS526*s->dpt[2][48])+S27*(ALPHA326+BETA826*s->dpt[2][48]);
  ALPHA327 = C27*(ALPHA326+BETA826*s->dpt[2][48])-S27*(ALPHA226+BS526*s->dpt[2][48]);
  ...
  ALPHA128 = C28*(ALPHA127+BETA327*s->dpt[3][50])+S28*(ALPHA227+BETA627*s->dpt[3][50]);
  ALPHA228 = C28*(ALPHA227+BETA627*s->dpt[3][50])-S28*(ALPHA127+BETA327*s->dpt[3][50]);
  ALPHA328 = ALPHA327+BS927*s->dpt[3][50];
...
// Backward Dynamics 
  ...
  Fs129 = -(s->frc[1][29]+s->m[29]*(s->l[1][29]*(OM229*OM229+OM329*OM329)-s->l[2][29]*(BS229-OMp329)-s->l[3][29]*(BS329+
 OMp229)-C29*(ALPHA128+BETA328*s->dpt[3][52])+S29*(ALPHA328+BS928*s->dpt[3][52])));
  Fs229 = -(s->frc[2][29]-s->m[29]*(ALPHA228+BETA628*s->dpt[3][52]+s->l[1][29]*(BS229+OMp329)-s->l[2][29]*(OM129*OM129+
 OM329*OM329)+s->l[3][29]*(BS629-OMp129)));
  Fs329 = -(s->frc[3][29]-s->m[29]*(s->l[1][29]*(BS329-OMp229)+s->l[2][29]*(BS629+OMp129)-s->l[3][29]*(OM129*OM129+OM229
 *OM229)+C29*(ALPHA328+BS928*s->dpt[3][52])+S29*(ALPHA128+BETA328*s->dpt[3][52])));
  Cq129 = -(s->trq[1][29]-s->In[1][29]*OMp129-s->In[2][29]*OMp229+Fs229*s->l[3][29]-Fs329*s->l[2][29]-OM229*(
 s->In[6][29]*OM229+s->In[9][29]*OM329)+OM329*(s->In[2][29]*OM129+s->In[5][29]*OM229+s->In[6][29]*OM329));
  Cq229 = -(s->trq[2][29]-s->In[2][29]*OMp129-s->In[5][29]*OMp229-s->In[6][29]*OMp329-Fs129*s->l[3][29]+Fs329*
 s->l[1][29]+OM129*(s->In[6][29]*OM229+s->In[9][29]*OM329)-OM329*(s->In[1][29]*OM129+s->In[2][29]*OM229));
  Cq329 = -(s->trq[3][29]-s->In[6][29]*OMp229-s->In[9][29]*OMp329+Fs129*s->l[2][29]-Fs229*s->l[1][29]-OM129*(
 s->In[2][29]*OM129+s->In[5][29]*OM229+s->In[6][29]*OM329)+OM229*(s->In[1][29]*OM129+s->In[2][29]*OM229));
  Fs128 = -(s->frc[1][28]-s->m[28]*(ALPHA128+BETA328*s->l[3][28]-s->l[1][28]*(OM228*OM228+OM328*OM328)+s->l[2][28]*(
 BS228-OMp328)));
  Fs228 = -(s->frc[2][28]-s->m[28]*(ALPHA228+BETA628*s->l[3][28]+s->l[1][28]*(BS228+OMp328)-s->l[2][28]*(OM128*OM128+
 OM328*OM328)));
  ...
  Fq228 = Fs228+Fs229;
  Cq128 = -(s->trq[1][28]-s->In[1][28]*OMp128-s->In[3][28]*OMp328-Cq129*C29-Cq329*S29+Fs228*s->l[3][28]+Fs229*
 s->dpt[3][52]-Fs328*s->l[2][28]-OM228*(s->In[3][28]*OM128+s->In[6][28]*OM228+s->In[9][28]*OM328)+OM328*(s->In[5][28]*OM228+
 s->In[6][28]*OM328));
  Cq228 = -(s->trq[2][28]-Cq229-s->In[5][28]*OMp228-s->In[6][28]*OMp328-Fs128*s->l[3][28]+Fs328*s->l[1][28]+OM128*(
 s->In[3][28]*OM128+s->In[6][28]*OM228+s->In[9][28]*OM328)-OM328*(s->In[1][28]*OM128+s->In[3][28]*OM328)-s->dpt[3][52]*(Fs129
 *C29+Fs329*S29));
  Cq328 = -(s->trq[3][28]-s->In[3][28]*OMp128-s->In[6][28]*OMp228-s->In[9][28]*OMp328+Cq129*S29-Cq329*C29+Fs128*
 s->l[2][28]-Fs228*s->l[1][28]-OM128*(s->In[5][28]*OM228+s->In[6][28]*OM328)+OM228*(s->In[1][28]*OM128+s->In[3][28]*OM328));
  Fs127 = -(s->frc[1][27]-s->m[27]*(ALPHA127+BETA327*s->l[3][27]-s->l[1][27]*(OM227*OM227+OM327*OM327)+s->l[2][27]*(
 BS227-OMp327)));
  Fs227 = -(s->frc[2][27]-s->m[27]*(ALPHA227+BETA627*s->l[3][27]+s->l[1][27]*(BS227+OMp327)-s->l[2][27]*(OM127*OM127+
 OM327*OM327)));
  ...
  Cq127 = -(s->trq[1][27]-s->In[1][27]*OMp127-s->In[2][27]*OMp227-s->In[3][27]*OMp327-Cq128*C28+Cq228*S28+Fs227*
 s->l[3][27]-Fs327*s->l[2][27]-OM227*(s->In[3][27]*OM127+s->In[6][27]*OM227+s->In[9][27]*OM327)+OM327*(s->In[2][27]*OM127+
 s->In[5][27]*OM227+s->In[6][27]*OM327)+s->dpt[3][50]*(Fq128*S28+Fq228*C28));
  Cq227 = -(s->trq[2][27]-s->In[2][27]*OMp127-s->In[5][27]*OMp227-s->In[6][27]*OMp327-Cq128*S28-Cq228*C28-Fs127*
 s->l[3][27]+Fs327*s->l[1][27]+OM127*(s->In[3][27]*OM127+s->In[6][27]*OM227+s->In[9][27]*OM327)-OM327*(s->In[1][27]*OM127+
 s->In[2][27]*OM227+s->In[3][27]*OM327)-s->dpt[3][50]*(Fq128*C28-Fq228*S28));
  Cq327 = -(s->trq[3][27]-Cq328-s->In[3][27]*OMp127-s->In[6][27]*OMp227-s->In[9][27]*OMp327+Fs127*s->l[2][27]-Fs227*
 s->l[1][27]-OM127*(s->In[2][27]*OM127+s->In[5][27]*OM227+s->In[6][27]*OM327)+OM227*(s->In[1][27]*OM127+s->In[2][27]*OM227+
 s->In[3][27]*OM327));
  Fs126 = -(s->frc[1][26]-s->m[26]*(ALPHA126+BETA226*s->l[2][26]-s->l[1][26]*(OM226*OM226+OM326*OM326)+s->l[3][26]*(
 BS326+OMp226)));
  Fs226 = -(s->frc[2][26]-s->m[26]*(ALPHA226+BS526*s->l[2][26]+s->l[1][26]*(BS226+OMp326)+s->l[3][26]*(BS626-OMp126)));
  Fs326 = -(s->frc[3][26]-s->m[26]*(ALPHA326+BETA826*s->l[2][26]+s->l[1][26]*(BS326-OMp226)-s->l[3][26]*(OM126*OM126+
 OM226*OM226)));
  Fq126 = Fq127+Fs126;
  Fq226 = Fs226+Fq227*C27-Fq327*S27;
  Fq326 = Fs326+Fq227*S27+Fq327*C27;
  Cq126 = -(s->trq[1][26]-Cq127-s->In[1][26]*OMp126+Fs226*s->l[3][26]-Fs326*s->l[2][26]+OM226*OM326*(s->In[5][26]-
 s->In[9][26])-s->dpt[2][48]*(Fq227*S27+Fq327*C27));
  Cq226 = -(s->trq[2][26]-s->In[5][26]*OMp226-Cq227*C27+Cq327*S27-Fs126*s->l[3][26]+Fs326*s->l[1][26]-OM126*OM326*(
 s->In[1][26]-s->In[9][26]));
  Cq326 = -(s->trq[3][26]-s->In[9][26]*OMp326-Cq227*S27-Cq327*C27+Fq127*s->dpt[2][48]+Fs126*s->l[2][26]-Fs226*
 s->l[1][26]+OM126*OM226*(s->In[1][26]-s->In[5][26]));
  Fs125 = -(s->frc[1][25]+s->m[25]*(s->l[1][25]*(OM225*OM225+OM325*OM325)-s->l[2][25]*(BS225-OMp325)-s->l[3][25]*(BS325+
 OMp225)-C25*(ALPHA124+BETA324*s->dpt[3][44])+S25*(ALPHA324+BS924*s->dpt[3][44])));
  Fs225 = -(s->frc[2][25]-s->m[25]*(ALPHA224+BETA624*s->dpt[3][44]+s->l[1][25]*(BS225+OMp325)-s->l[2][25]*(OM125*OM125+
 OM325*OM325)+s->l[3][25]*(BS625-OMp125)));
  Fs325 = -(s->frc[3][25]-s->m[25]*(s->l[1][25]*(BS325-OMp225)+s->l[2][25]*(BS625+OMp125)-s->l[3][25]*(OM125*OM125+OM225
 *OM225)+C25*(ALPHA324+BS924*s->dpt[3][44])+S25*(ALPHA124+BETA324*s->dpt[3][44])));
  ...
  Fs124 = -(s->frc[1][24]-s->m[24]*(ALPHA124+BETA324*s->l[3][24]-s->l[1][24]*(OM224*OM224+OM324*OM324)+s->l[2][24]*(
 BS224-OMp324)));
  Fs224 = -(s->frc[2][24]-s->m[24]*(ALPHA224+BETA624*s->l[3][24]+s->l[1][24]*(BS224+OMp324)-s->l[2][24]*(OM124*OM124+
 OM324*OM324)));
  ...
  Fq224 = Fs224+Fs225;
  Cq124 = -(s->trq[1][24]-s->In[1][24]*OMp124-s->In[2][24]*OMp224-s->In[3][24]*OMp324-Cq125*C25-Cq325*S25+Fs224*
 s->l[3][24]+Fs225*s->dpt[3][44]-Fs324*s->l[2][24]-OM224*(s->In[3][24]*OM124+s->In[9][24]*OM324)+OM324*(s->In[2][24]*OM124+
 s->In[5][24]*OM224));
  Cq224 = -(s->trq[2][24]-Cq225-s->In[2][24]*OMp124-s->In[5][24]*OMp224-Fs124*s->l[3][24]+Fs324*s->l[1][24]+OM124*(
 s->In[3][24]*OM124+s->In[9][24]*OM324)-OM324*(s->In[1][24]*OM124+s->In[2][24]*OM224+s->In[3][24]*OM324)-s->dpt[3][44]*(Fs125
 *C25+Fs325*S25));
  Cq324 = -(s->trq[3][24]-s->In[3][24]*OMp124-s->In[9][24]*OMp324+Cq125*S25-Cq325*C25+Fs124*s->l[2][24]-Fs224*
 s->l[1][24]-OM124*(s->In[2][24]*OM124+s->In[5][24]*OM224)+OM224*(s->In[1][24]*OM124+s->In[2][24]*OM224+s->In[3][24]*OM324));
  Fs123 = -(s->frc[1][23]-s->m[23]*(ALPHA123+BETA323*s->l[3][23]-s->l[1][23]*(OM223*OM223+OM323*OM323)+s->l[2][23]*(
 BS223-OMp323)));
  Fs223 = -(s->frc[2][23]-s->m[23]*(ALPHA223+BETA623*s->l[3][23]+s->l[1][23]*(BS223+OMp323)-s->l[2][23]*(OM123*OM123+
 OM323*OM323)));
  ...
  Cq123 = -(s->trq[1][23]-s->In[1][23]*OMp123-s->In[3][23]*OMp323-Cq124*C24+Cq224*S24+Fs223*s->l[3][23]-Fs323*
 s->l[2][23]-OM223*(s->In[3][23]*OM123-s->In[5][23]*OM323+s->In[9][23]*OM323)+s->dpt[3][42]*(Fq124*S24+Fq224*C24));
  Cq223 = -(s->trq[2][23]-s->In[5][23]*OMp223-Cq124*S24-Cq224*C24-Fs123*s->l[3][23]+Fs323*s->l[1][23]+OM123*(
 s->In[3][23]*OM123+s->In[9][23]*OM323)-OM323*(s->In[1][23]*OM123+s->In[3][23]*OM323)-s->dpt[3][42]*(Fq124*C24-Fq224*S24));
  Cq323 = -(s->trq[3][23]-Cq324-s->In[3][23]*OMp123-s->In[9][23]*OMp323+Fs123*s->l[2][23]-Fs223*s->l[1][23]+OM223*(
 ...
 OM222*OM222)));
  ...
  Cq122 = -(s->trq[1][22]-Cq123-s->In[1][22]*OMp122-s->In[2][22]*OMp222+Fs222*s->l[3][22]-Fs322*s->l[2][22]-OM222*(
 s->In[6][22]*OM222+s->In[9][22]*OM322)+OM322*(s->In[2][22]*OM122+s->In[5][22]*OM222+s->In[6][22]*OM322)-s->dpt[2][40]*(Fq223
 *S23+Fq323*C23));
  Cq222 = -(s->trq[2][22]-s->In[2][22]*OMp122-s->In[5][22]*OMp222-s->In[6][22]*OMp322-Cq223*C23+Cq323*S23-Fs122*
 s->l[3][22]+Fs322*s->l[1][22]+OM122*(s->In[6][22]*OM222+s->In[9][22]*OM322)-OM322*(s->In[1][22]*OM122+s->In[2][22]*OM222));
  Cq322 = -(s->trq[3][22]-s->In[6][22]*OMp222-s->In[9][22]*OMp322-Cq223*S23-Cq323*C23+Fq123*s->dpt[2][40]+Fs122*
 s->l[2][22]-Fs222*s->l[1][22]-OM122*(s->In[2][22]*OM122+s->In[5][22]*OM222+s->In[6][22]*OM322)+OM222*(s->In[1][22]*OM122+
 s->In[2][22]*OM222));
  ...
  Cq121 = -(s->trq[1][21]-s->In[1][21]*OMp121-Cq122*C22-Cq126*C26-Cq322*S22-Cq326*S26+Fq222*s->dpt[3][37]+Fq226*
 s->dpt[3][38]+Fs221*s->l[3][21]-Fs321*s->l[2][21]-OM221*(s->In[6][21]*OM221+s->In[9][21]*OM321)+OM321*(s->In[5][21]*OM221+
 s->In[6][21]*OM321)+s->dpt[2][37]*(Fq122*S22-Fq322*C22)+s->dpt[2][38]*(Fq126*S26-Fq326*C26));
  Cq221 = -(s->trq[2][21]-Cq222-Cq226-s->In[5][21]*OMp221-s->In[6][21]*OMp321-Fs121*s->l[3][21]+Fs321*s->l[1][21]-OM121*
 (s->In[1][21]*OM321-s->In[6][21]*OM221-s->In[9][21]*OM321)-s->dpt[1][37]*(Fq122*S22-Fq322*C22)-s->dpt[1][38]*(Fq126*S26-
 Fq326*C26)-s->dpt[3][37]*(Fq122*C22+Fq322*S22)-s->dpt[3][38]*(Fq126*C26+Fq326*S26));
  Cq321 = -(s->trq[3][21]-s->In[6][21]*OMp221-s->In[9][21]*OMp321+Cq122*S22+Cq126*S26-Cq322*C22-Cq326*C26-Fq222*
 s->dpt[1][37]-Fq226*s->dpt[1][38]+Fs121*s->l[2][21]-Fs221*s->l[1][21]+OM121*(s->In[1][21]*OM221-s->In[5][21]*OM221-
 s->In[6][21]*OM321)+s->dpt[2][37]*(Fq122*C22+Fq322*S22)+s->dpt[2][38]*(Fq126*C26+Fq326*S26));
 ...
 OM320*OM320)));
  ...
  Cq120 = -(s->trq[1][20]-s->In[1][20]*OMp120-s->In[3][20]*OMp320-Cq121*C21+Cq221*S21+Fs220*s->l[3][20]-Fs320*
 s->l[2][20]-OM220*(s->In[3][20]*OM120-s->In[5][20]*OM320+s->In[9][20]*OM320)+s->dpt[3][33]*(Fq121*S21+Fq221*C21));
  Cq220 = -(s->trq[2][20]-s->In[5][20]*OMp220-Cq121*S21-Cq221*C21-Fs120*s->l[3][20]+Fs320*s->l[1][20]+OM120*(
 s->In[3][20]*OM120+s->In[9][20]*OM320)-OM320*(s->In[1][20]*OM120+s->In[3][20]*OM320)-s->dpt[3][33]*(Fq121*C21-Fq221*S21));
  Cq320 = -(s->trq[3][20]-Cq321-s->In[3][20]*OMp120-s->In[9][20]*OMp320+Fs120*s->l[2][20]-Fs220*s->l[1][20]+OM220*(
 ...
 OM119+OM219*OM219)));
  ...
  Cq119 = -(s->trq[1][19]-s->In[1][19]*OMp119-Cq120*C20-Cq320*S20+Fs219*s->l[3][19]-Fs319*s->l[2][19]-OM219*(
 s->In[6][19]*OM219+s->In[9][19]*OM319)+OM319*(s->In[5][19]*OM219+s->In[6][19]*OM319));
  Cq219 = -(s->trq[2][19]-Cq220-s->In[5][19]*OMp219-s->In[6][19]*OMp319-Fs119*s->l[3][19]+Fs319*s->l[1][19]-OM119*(
 s->In[1][19]*OM319-s->In[6][19]*OM219-s->In[9][19]*OM319));
  Cq319 = -(s->trq[3][19]-s->In[6][19]*OMp219-s->In[9][19]*OMp319+Cq120*S20-Cq320*C20+Fs119*s->l[2][19]-Fs219*
 s->l[1][19]+OM119*(s->In[1][19]*OM219-s->In[5][19]*OM219-s->In[6][19]*OM319));
  Fs118 = -(s->frc[1][18]-s->m[18]*(ALPHA117*C18-ALPHA317*S18-s->l[1][18]*(OM218*OM218+OM318*OM318)+s->l[3][18]*(BS318+
 OMp218)));
  Fs218 = -(s->frc[2][18]-s->m[18]*(ALPHA217+s->l[1][18]*(OMp318+OM118*OM218)-s->l[3][18]*(OMp118-OM218*OM318)));
  Fs318 = -(s->frc[3][18]-s->m[18]*(ALPHA117*S18+ALPHA317*C18+s->l[1][18]*(BS318-OMp218)-s->l[3][18]*(OM118*OM118+OM218*
 OM218)));
  Cq118 = -(s->trq[1][18]-s->In[1][18]*OMp118+Fs218*s->l[3][18]+OM218*OM318*(s->In[5][18]-s->In[9][18]));
  Cq218 = -(s->trq[2][18]-s->In[5][18]*OMp218-Fs118*s->l[3][18]+Fs318*s->l[1][18]-OM118*OM318*(s->In[1][18]-s->In[9][18]
 ));
  Cq318 = -(s->trq[3][18]-s->In[9][18]*OMp318-Fs218*s->l[1][18]+OM118*OM218*(s->In[1][18]-s->In[5][18]));
 ...
 OM117+OM217*OM217)));
  ...
  Cq117 = -(s->trq[1][17]-s->In[1][17]*OMp117-s->In[3][17]*OMp317-Cq118*C18-Cq318*S18+Fs217*s->l[3][17]-Fs317*
 s->l[2][17]-OM217*(s->In[3][17]*OM117+s->In[6][17]*OM217+s->In[9][17]*OM317)+OM317*(s->In[5][17]*OM217+s->In[6][17]*OM317));
  Cq217 = -(s->trq[2][17]-Cq218-s->In[5][17]*OMp217-s->In[6][17]*OMp317-Fs117*s->l[3][17]+Fs317*s->l[1][17]+OM117*(
 ...
 s->l[2][17]-Fs217*s->l[1][17]-OM117*(s->In[5][17]*OM217+s->In[6][17]*OM317)+OM217*(s->In[1][17]*OM117+s->In[3][17]*OM317));
 ...
 OM316*OM316)));
  ...
  Cq116 = -(s->trq[1][16]-Cq117-s->In[1][16]*OMp116-s->In[3][16]*OMp316+Fs216*s->l[3][16]-Fs316*s->l[2][16]-OM216*(
 s->In[3][16]*OM116-s->In[5][16]*OM316+s->In[9][16]*OM316)+s->dpt[3][24]*(Fq217*C17-Fq317*S17));
  Cq216 = -(s->trq[2][16]-s->In[5][16]*OMp216-Cq217*C17+Cq317*S17-Fq117*s->dpt[3][24]-Fs116*s->l[3][16]+Fs316*
 s->l[1][16]+OM116*(s->In[3][16]*OM116+s->In[9][16]*OM316)-OM316*(s->In[1][16]*OM116+s->In[3][16]*OM316));
  Cq316 = -(s->trq[3][16]-s->In[3][16]*OMp116-s->In[9][16]*OMp316-Cq217*S17-Cq317*C17+Fs116*s->l[2][16]-Fs216*
 ...
 OM315*OM315)));
  ...
  Fq215 = Fq216+Fs215;
  Cq115 = -(s->trq[1][15]-s->In[1][15]*OMp115-s->In[3][15]*OMp315-Cq116*C16-Cq316*S16+Fq216*s->dpt[3][22]+Fs215*
 s->l[3][15]-Fs315*s->l[2][15]-OM215*(s->In[3][15]*OM115-s->In[5][15]*OM315+s->In[9][15]*OM315));
  Cq215 = -(s->trq[2][15]-Cq216-s->In[5][15]*OMp215-Fs115*s->l[3][15]+Fs315*s->l[1][15]+OM115*(s->In[3][15]*OM115+
 s->In[9][15]*OM315)-OM315*(s->In[1][15]*OM115+s->In[3][15]*OM315)-s->dpt[3][22]*(Fq116*C16+Fq316*S16));
  Cq315 = -(s->trq[3][15]-s->In[3][15]*OMp115-s->In[9][15]*OMp315+Cq116*S16-Cq316*C16+Fs115*s->l[2][15]-Fs215*
 ...
 OM314*OM314)));
  ...
  Cq114 = -(s->trq[1][14]-s->In[1][14]*OMp114-s->In[2][14]*OMp214-Cq115*C15+Cq215*S15+Fs214*s->l[3][14]-Fs314*
 s->l[2][14]+OM314*(s->In[2][14]*OM114+s->In[5][14]*OM214-s->In[9][14]*OM214)+s->dpt[3][20]*(Fq115*S15+Fq215*C15));
  Cq214 = -(s->trq[2][14]-s->In[2][14]*OMp114-s->In[5][14]*OMp214-Cq115*S15-Cq215*C15-Fs114*s->l[3][14]+Fs314*
 s->l[1][14]-OM314*(s->In[1][14]*OM114+s->In[2][14]*OM214-s->In[9][14]*OM114)-s->dpt[3][20]*(Fq115*C15-Fq215*S15));
  Cq314 = -(s->trq[3][14]-Cq315-s->In[9][14]*OMp314+Fs114*s->l[2][14]-Fs214*s->l[1][14]-OM114*(s->In[2][14]*OM114+
 ...
 OM213*OM213)));
  ...
  Cq113 = -(s->trq[1][13]-Cq114-s->In[1][13]*OMp113-s->In[2][13]*OMp213+Fs213*s->l[3][13]-Fs313*s->l[2][13]-OM213*(
 s->In[6][13]*OM213+s->In[9][13]*OM313)+OM313*(s->In[2][13]*OM113+s->In[5][13]*OM213+s->In[6][13]*OM313)-s->dpt[2][18]*(Fq214
 *S14+Fq314*C14));
  Cq213 = -(s->trq[2][13]-s->In[2][13]*OMp113-s->In[5][13]*OMp213-s->In[6][13]*OMp313-Cq214*C14+Cq314*S14-Fs113*
 s->l[3][13]+Fs313*s->l[1][13]+OM113*(s->In[6][13]*OM213+s->In[9][13]*OM313)-OM313*(s->In[1][13]*OM113+s->In[2][13]*OM213));
  Cq313 = -(s->trq[3][13]-s->In[6][13]*OMp213-s->In[9][13]*OMp313-Cq214*S14-Cq314*C14+Fq114*s->dpt[2][18]+Fs113*
 s->l[2][13]-Fs213*s->l[1][13]-OM113*(s->In[2][13]*OM113+s->In[5][13]*OM213+s->In[6][13]*OM313)+OM213*(s->In[1][13]*OM113+
 s->In[2][13]*OM213));
  Fs112 = -(s->frc[1][12]-s->m[12]*(ALPHA111*C12-ALPHA311*S12-s->l[1][12]*(OM212*OM212+OM312*OM312)+s->l[3][12]*(BS312+
 OMp212)));
  Fs212 = -(s->frc[2][12]-s->m[12]*(ALPHA211+s->l[1][12]*(OMp312+OM112*OM212)-s->l[3][12]*(OMp112-OM212*OM312)));
  Fs312 = -(s->frc[3][12]-s->m[12]*(ALPHA111*S12+ALPHA311*C12+s->l[1][12]*(BS312-OMp212)-s->l[3][12]*(OM112*OM112+OM212*
 OM212)));
  Cq112 = -(s->trq[1][12]-s->In[1][12]*OMp112+Fs212*s->l[3][12]+OM212*OM312*(s->In[5][12]-s->In[9][12]));
  Cq212 = -(s->trq[2][12]-s->In[5][12]*OMp212-Fs112*s->l[3][12]+Fs312*s->l[1][12]-OM112*OM312*(s->In[1][12]-s->In[9][12]
 ));
  Cq312 = -(s->trq[3][12]-s->In[9][12]*OMp312-Fs212*s->l[1][12]+OM112*OM212*(s->In[1][12]-s->In[5][12]));
 ...
 *(s->In[3][9]*OM19+s->In[6][9]*OM29+s->In[9][9]*OM39)-OM39*(s->In[1][9]*OM19+s->In[2][9]*OM29+s->In[3][9]*OM39)-
 ...
 s->In[1][7]-s->In[5][7]));
  ...
  Cq16 = -(s->trq[1][6]-Cq119-s->In[1][6]*OMp16-s->In[3][6]*OMp36-Cq113*C13-Cq17*C7-Cq313*S13-Cq37*S7+Fs26*s->l[3][6]-
 Fs36*s->l[2][6]-OM26*(s->In[3][6]*OM16+s->In[6][6]*OM26+s->In[9][6]*OM36)+OM36*(s->In[5][6]*OM26+s->In[6][6]*OM36)+
 s->dpt[2][1]*(Fq17*S7-Fq37*C7)+s->dpt[2][2]*(Fq113*S13-Fq313*C13)+s->dpt[3][3]*(Fq219*C19-Fq319*S19));
  Cq26 = -(s->trq[2][6]-Cq213-Cq27-s->In[5][6]*OMp26-s->In[6][6]*OMp36-Cq219*C19+Cq319*S19-Fq119*s->dpt[3][3]-Fs16*
 s->l[3][6]+Fs36*s->l[1][6]+OM16*(s->In[3][6]*OM16+s->In[6][6]*OM26+s->In[9][6]*OM36)-OM36*(s->In[1][6]*OM16+s->In[3][6]*OM36
 )+s->dpt[1][3]*(Fq219*S19+Fq319*C19));
  Cq36 = -(s->trq[3][6]-s->In[3][6]*OMp16-s->In[6][6]*OMp26-s->In[9][6]*OMp36+Cq113*S13+Cq17*S7-Cq219*S19-Cq313*C13-
 Cq319*C19-Cq37*C7+Fs16*s->l[2][6]-Fs26*s->l[1][6]-OM16*(s->In[5][6]*OM26+s->In[6][6]*OM36)+OM26*(s->In[1][6]*OM16+
