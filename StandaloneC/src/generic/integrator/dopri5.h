...
typedef void (*FcnEqDiff)(unsigned n, double x, double *y, double *f, Loop_arguments *loop_arguments);
...
extern int dopri5
 (unsigned n,      /* dimension of the system <= UINT_MAX-1*/
  ...
  Loop_arguments *loop_arguments // modif: 'loop_arguments' added
 );
...
// added prototype
extern double get_nstep_dopri5 (void);
