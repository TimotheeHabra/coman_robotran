...
* All the sources (except the symbolic files) are located in the __StandaloneC/src__ folder:
	...
	* __project folder__: files dependent on the project. Normally, the user only modifies these files.
		* __controller_files__, __simulation_files__ and __user_files__: same folders as the ones explained in the [Simulink instructions](workR/Simulink/README.md).
...
* __user_files__, __simulation_files__ and __controller_files__ folders: no change with regard to Simulink.
